...
# ADD LINK32 kernel32.lib user32.lib /nologo /dll /machine:I386 /out:"..\..\bin\icudt24l.dll" /implib:"..\..\lib\icudata.lib"
...
# ADD LINK32 kernel32.lib user32.lib /nologo /dll /machine:IX86 /out:"..\..\bin\icudt24l.dll" /implib:"..\..\lib\icudata.lib" /machine:IA64
# Begin Special Build Tool
ProjDir=.
SOURCE="$(InputPath)"
PreLink_Cmds=echo "File with stubdata build time, used as a dependency to trigger fresh data build, since stubdata dll will overwrite the real one." > $(ProjDir)\stubdatabuilt.txt
...
# ADD LINK32 kernel32.lib user32.lib /nologo /dll /incremental:no /machine:IX86 /out:"..\..\bin\icudt24l.dll" /implib:"..\..\lib\icudata.lib" /pdbtype:sept /machine:IA64
# Begin Special Build Tool
ProjDir=.
SOURCE="$(InputPath)"
PreLink_Cmds=echo "File with stubdata build time, used as a dependency to trigger fresh data build, since stubdata dll will overwrite the real one." > $(ProjDir)\stubdatabuilt.txt
