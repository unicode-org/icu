...
REGION_SYNTHETIC_ALIAS = az_AZ.txt en_RH.txt ha_GH.txt ha_NE.txt\
...
REGION_SOURCE = af.txt agq.txt ak.txt am.txt\
 ...
 ebu.txt ee.txt el.txt en.txt en_ZW.txt\
 eo.txt es.txt es_CL.txt et.txt eu.txt\
 ewo.txt fa.txt fa_AF.txt ff.txt fi.txt\
 fil.txt fil_PH.txt fo.txt fr.txt ga.txt\
 ...
 sr_Latn.txt sr_Latn_BA.txt sr_Latn_RS.txt sv.txt sw.txt\
