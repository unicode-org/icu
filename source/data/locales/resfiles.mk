...
GENRB_SOURCE = af.txt af_NA.txt af_ZA.txt agq.txt\
 ...
 en_150.txt en_AG.txt en_AI.txt en_AS.txt en_AU.txt\
 ...
 it.txt it_CH.txt it_IT.txt it_SM.txt ja.txt\
 ...
 kk_KZ.txt kkj.txt kkj_CM.txt kl.txt kl_GL.txt\
 kln.txt kln_KE.txt km.txt km_KH.txt kn.txt\
 kn_IN.txt ko.txt ko_KP.txt ko_KR.txt kok.txt\
 kok_IN.txt ks.txt ks_IN.txt ksb.txt ksb_TZ.txt\
 ksf.txt ksf_CM.txt ksh.txt ksh_DE.txt kw.txt\
 kw_GB.txt ky.txt ky_KG.txt lag.txt lag_TZ.txt\
 ...
 mua.txt mua_CM.txt my.txt my_MM.txt naq.txt\
 naq_NA.txt nb.txt nb_NO.txt nb_SJ.txt nd.txt\
 ...
 nn_NO.txt nnh.txt nnh_CM.txt nus.txt nus_SD.txt\
 ...
 qu_BO.txt qu_EC.txt qu_PE.txt rm.txt rm_CH.txt\
 ...
 rw_RW.txt rwk.txt rwk_TZ.txt sah.txt sah_RU.txt\
 saq.txt saq_KE.txt sbp.txt sbp_TZ.txt se.txt\
 ...
 teo.txt teo_KE.txt teo_UG.txt th.txt th_TH.txt\
 ti.txt ti_ER.txt ti_ET.txt to.txt to_TO.txt\
 tr.txt tr_CY.txt tr_TR.txt twq.txt twq_NE.txt\
 tzm.txt tzm_MA.txt ug.txt ug_CN.txt uk.txt\
