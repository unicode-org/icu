...
GENRB_SYNTHETIC_ALIAS = az_AZ.txt en_RH.txt ha_GH.txt ha_NE.txt\
 ...
 sr_RS.txt sr_YU.txt th_TH_TRADITIONAL.txt tl.txt tl_PH.txt\
 tzm_MA.txt uz_AF.txt uz_UZ.txt vai_LR.txt zh_CN.txt\
