...
GENRB_SOURCE = af.txt af_NA.txt af_ZA.txt am.txt\
 ...
 gsw.txt gsw_CH.txt gu.txt gu_IN.txt gv.txt\
 ...
 id_ID.txt ii.txt ii_CN.txt is.txt is_IS.txt\
 it.txt it_CH.txt it_IT.txt ja.txt ja_JP.txt\
 ka.txt ka_GE.txt kk.txt kk_Cyrl.txt kk_Cyrl_KZ.txt\
 kl.txt kl_GL.txt km.txt km_KH.txt kn.txt\
 ...
 mt.txt mt_MT.txt nb.txt nb_NO.txt ne.txt\
 ...
 ro_MD.txt ro_RO.txt ru.txt ru_RU.txt ru_UA.txt\
