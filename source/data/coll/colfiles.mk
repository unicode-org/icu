...
COLLATION_EMPTY_SOURCE = af_NA.txt af_ZA.txt ar_AE.txt ar_BH.txt\
 ...
 fi_FI.txt fil_PH.txt fo_FO.txt fr_BE.txt fr_BF.txt\
 fr_BI.txt fr_BJ.txt fr_BL.txt fr_CA.txt fr_CD.txt\
 fr_CF.txt fr_CG.txt fr_CH.txt fr_CI.txt fr_CM.txt\
 fr_DJ.txt fr_FR.txt fr_GA.txt fr_GN.txt fr_GP.txt\
 fr_GQ.txt fr_KM.txt fr_LU.txt fr_MC.txt fr_MF.txt\
 fr_MG.txt fr_ML.txt fr_MQ.txt fr_NE.txt fr_RE.txt\
 fr_RW.txt fr_SN.txt fr_TD.txt fr_TG.txt ga.txt\
 ga_IE.txt gu_IN.txt ha_Latn.txt ha_Latn_GH.txt ha_Latn_NE.txt\
 ha_Latn_NG.txt he_IL.txt hi_IN.txt hr_HR.txt hu_HU.txt\
 hy_AM.txt id.txt id_ID.txt ig_NG.txt is_IS.txt\
 it.txt it_CH.txt it_IT.txt ja_JP.txt ka.txt\
 ka_GE.txt kk_KZ.txt kl_GL.txt kn_IN.txt ko_KR.txt\
 kok_IN.txt lt_LT.txt lv_LV.txt mk_MK.txt ml_IN.txt\
...
COLLATION_SOURCE = $(COLLATION_EMPTY_SOURCE) af.txt ar.txt as.txt az.txt\
 ...
 fi.txt fil.txt fo.txt fr.txt gu.txt\
