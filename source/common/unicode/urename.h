...
#define decimfmtAffixPatternValueComparator U_ICU_ENTRY_POINT_RENAME(decimfmtAffixPatternValueComparator)
#define decimfmtAffixValueComparator U_ICU_ENTRY_POINT_RENAME(decimfmtAffixValueComparator)
...
#define u_growBufferFromStatic U_ICU_ENTRY_POINT_RENAME(u_growBufferFromStatic)
...
#define ubidi_closeProps U_ICU_ENTRY_POINT_RENAME(ubidi_closeProps)
...
#define ucase_close U_ICU_ENTRY_POINT_RENAME(ucase_close)
...
#define uhash_deleteUVector U_ICU_ENTRY_POINT_RENAME(uhash_deleteUVector)
...
#define unorm_addPropertyStarts U_ICU_ENTRY_POINT_RENAME(unorm_addPropertyStarts)
...
#define unorm_getCanonicalDecomposition U_ICU_ENTRY_POINT_RENAME(unorm_getCanonicalDecomposition)
#define unorm_getDecomposition U_ICU_ENTRY_POINT_RENAME(unorm_getDecomposition)
#define unorm_getFCD16FromCodePoint U_ICU_ENTRY_POINT_RENAME(unorm_getFCD16FromCodePoint)
...
#define unorm_internalIsFullCompositionExclusion U_ICU_ENTRY_POINT_RENAME(unorm_internalIsFullCompositionExclusion)
#define unorm_internalNormalize U_ICU_ENTRY_POINT_RENAME(unorm_internalNormalize)
#define unorm_internalNormalizeWithNX U_ICU_ENTRY_POINT_RENAME(unorm_internalNormalizeWithNX)
#define unorm_internalQuickCheck U_ICU_ENTRY_POINT_RENAME(unorm_internalQuickCheck)
