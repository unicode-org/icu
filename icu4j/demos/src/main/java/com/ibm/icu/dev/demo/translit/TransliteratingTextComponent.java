...
/**
 * A subclass of {@link DumbTextComponent} that passes key events through a {@link
...
public class TransliteratingTextComponent extends DumbTextComponent {
    ...
    /**
     * {@link DumbTextComponent} API. Framework method that is called when a <code>KeyEvent</code>
     * is received. This implementation runs the new character through the current <code>
     * Transliterator</code>, if one is set, and inserts the transliterated text into the buffer.
     */
    ...
    /**
     * Set the {@link com.ibm.icu.text.Transliterator} and direction to use to process incoming
