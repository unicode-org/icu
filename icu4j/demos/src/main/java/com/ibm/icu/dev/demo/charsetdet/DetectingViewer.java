...
/**
 * This simple application demonstrates how to use the CharsetDetector API. It opens a file or web
 * page, detects the encoding, and then displays it using that encoding.
 */
public class DetectingViewer extends JFrame implements ActionListener {
    ...
    public DetectingViewer() {
        ...
        try {
            ...
            System.err.println(
                    "no file chooser - access control exception. Continuing without file browsing. "
                            + ace.toString());
            fileChooser = null; //
        }
    ...
    private byte[] scriptTag = {
        (byte) 's', (byte) 'c', (byte) 'r', (byte) 'i', (byte) 'p', (byte) 't'
    };
