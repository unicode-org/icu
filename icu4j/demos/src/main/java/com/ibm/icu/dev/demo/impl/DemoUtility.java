...
public class DemoUtility {
    ...
    public static final String copyright1 =
            "Copyright (C) IBM Corp and others. 1997 - "
                    + getCurrentYear()
                    + " All Rights Reserved";

    /**
     * Provides easy way to use basic functions of GridBagLayout, without the complications. After
     * building a panel, and inserting all the subcomponents, call this to lay it out in the desired
     * number of columns.
     */
    ...
    /**
     * Provides easy way to change the spacing around an object in a GridBagLayout. Call AFTER
     * fixGridBag, passing in the container, the component, and the new insets.
     */
    ...
    /**
     * Compares two locals. Return value is negative if they're different, and more positive the
     * more fields that match.
     */
