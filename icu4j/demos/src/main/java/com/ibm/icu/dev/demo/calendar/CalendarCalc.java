...
public class CalendarCalc extends DemoApplet {
    ...
    /**
     * The main function which defines the behavior of the MultiCalendarDemo applet when an applet
     * is started.
     */
 ...
 * CalendarCalcFrame class defines the window layout of MultiCalendarDemo.
 */
class CalendarCalcFrame extends Frame implements ActionListener {
    ...
    /**
     * Called to start the applet. You never need to call this method directly, it is called when
     * the applet's document is visited.
     */
    public void start() {
        // do nothing
    }
    ...
    public void buildGUI() {
        ...
        for (int i = 0; i < calendars.length; i++) {
            ...
            final int j = i;
            calendars[i].text.addActionListener(
                    new ActionListener() {
        ...
        addWithFont(
                copyrightPanel,
                new Label(DemoUtility.copyright1, Label.LEFT),
    ...
    /**
     * This function is called when it is necessary to parse the time string in one of the formatted
     * date fields
     */
     ...
     * parent of this component. The default event handler calls some helper methods to make life
    ...
    protected void processWindowEvent(WindowEvent evt) {
        ...
        if (evt.getID() == WindowEvent.WINDOW_CLOSING && evt.getSource() == this) {
            this.hide();
            this.dispose();
    ...
    */
    ...
    class CalendarRec {
        public CalendarRec(String nameStr, Calendar cal) {
            ...
            format = DateFormat.getDateInstance(cal, DateFormat.FULL, Locale.getDefault());
        ...
        public void setLocale(Locale loc) {
            ...
            format = DateFormat.getDateInstance(calendar, DateFormat.FULL, loc);
