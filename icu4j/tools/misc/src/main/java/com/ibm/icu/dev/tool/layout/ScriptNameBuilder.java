...
public class ScriptNameBuilder {
    ...
    public static void main(String[] args) {
        ...
        ScriptIDModuleWriter scriptIDModuleWriter =
                new ScriptIDModuleWriter(scriptData, languageData);
        ...
        ScriptTagModuleWriter scriptTagModuleWriter =
                new ScriptTagModuleWriter(scriptData, languageData);
