...
public class ScriptIDModuleWriter extends ScriptModuleWriter {
    ...
    public void writeScriptHeader(String fileName) {
        ...
        for (int script = minScript; script <= previousTotalScripts; ) {
            ...
            numberOfScripts =
                    Integer.parseInt(checkICUVersion.substring(checkICUVersion.indexOf("=") + 1));
    ...
    public void writeLanguageHeader(String fileName) {
        ...
        if (newLanguage) {
            ...
            for (int language = previousTotalLanguages + 1;
        ...
        if (totalScript > previousTotalScripts) {
            updateFile.println(
                    "         ICU_"
                            ...
                            + VersionInfo.ICU_VERSION.getMinor()
                            + "="
                            + (totalScript - previousTotalScripts));
        }
        updateFile.println("        }");
        ...
        if (totalLanguage > previousTotalLanguages) {
            updateFile.println(
                    "           ICU_"
                            ...
                            + VersionInfo.ICU_VERSION.getMinor()
                            + "="
                            + (totalLanguage - previousTotalLanguages));
        }
        updateFile.println("          }");
