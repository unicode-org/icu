...
public /*abstract*/ class Lookup {
    ...
    // Lookup flags
    public static final int LF_ReservedBit = 0x0001;
    public static final int LF_IgnoreBaseGlyphs = 0x0002;
    public static final int LF_IgnoreLigatures = 0x0004;
    public static final int LF_IgnoreMarks = 0x0008;
    public static final int LF_ReservedMask = 0x00F0;
    public static final int LF_MarkAttachTypeMask = 0xFF00;
