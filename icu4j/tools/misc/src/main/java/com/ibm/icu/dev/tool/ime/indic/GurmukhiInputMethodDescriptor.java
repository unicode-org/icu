...
public class GurmukhiInputMethodDescriptor extends IndicIMDescriptor {
    ...
    protected IndicInputMethodImpl getImpl() {
        if (keyboardMap == null) {
            ...
            substitutionTable = new char[][] {RA_SUB};
            ...
            joinWithNukta = new char[] {LETTER_KHA, LETTER_GA, LETTER_JA, LETTER_DDA, LETTER_PHA};

            nuktaForm = new char[] {LETTER_KHHA, LETTER_GHHA, LETTER_ZA, LETTER_RRA, LETTER_FA};
        }
