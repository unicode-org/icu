...
/**
 * ****************************************************************************** Copyright (C)
 * 2004-2013, International Business Machines Corporation and * others. All Rights Reserved. *
 * ******************************************************************************
 */

/**
 * Compare two API files (generated by GatherAPIData) and generate a report on the differences.
 *
 * <p>Sample invocation: java -old: icu4j28.api.zip -new: icu4j30.api -html -out:
 * icu4j_compare_28_30.html
 *
 * <p>TODO: - make 'changed apis' smarter - detect method parameter or return type change for this,
 * the sequential search through methods ordered by signature won't do. We need to gather all added
 * and removed overloads for a method, and then compare all added against all removed in order to
 * identify this kind of change.
 */
...
public class ReportAPI {
    ...
    */
    ...
    private static void printResults(
            Collection<? extends APIInfo> c, PrintWriter pw, boolean html, boolean isChangedAPIs) {
