...
/**
 * Parses a log that represents the standard output of a maven run with erroprone enabled and
...
public class Main {
    ...
    private static final String SRC_BASE_URL_DEFAULT =
            "https://github.com/unicode-org/icu/blob/main/";
    String srcBaseUrl;

    private static final String LOG_FILE_NAME = "logFile";
    private static final String LOG_FILE_NAME_DESC =
            "The name of the errorprone log file.\n"
            ...
            new Options()
                    ...
                    .addOption(
                            Option.builder()
                                    ...
                                    .desc(
                                            descWithDefault(
                                                    LOG_FILE_NAME_DESC, LOG_FILE_NAME_DEFAULT))
                                    .build())
                    .addOption(
                            Option.builder()
                                    .longOpt(ICU_DIR)
    ...
    private static void makeOutputFolder(String dirName) {
        ...
        if (!fileOutDir.exists()) {
            ...
            System.out.println("Error: " + dirName + " already exists, but it is not a directory");
            System.exit(2);
        }
    }
