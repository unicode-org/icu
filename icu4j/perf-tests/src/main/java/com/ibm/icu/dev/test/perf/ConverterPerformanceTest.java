...
public class ConverterPerformanceTest extends PerfTest {
    ...
    protected void setup(String[] args) {
        try {
            ...
            for (int i = 0; i < encBuffer.length; i++) encBuffer[i] = target.get(i);
            ...
            public void call() {
                try {
                    ByteArrayOutputStream out =
                            new ByteArrayOutputStream(unicodeBuffer.length * 10);
            ...
            public void call() {
                try {
                    ByteArrayInputStream is =
                            new ByteArrayInputStream(encBuffer, 0, encBuffer.length);
