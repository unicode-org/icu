...
/**
 * Demo code for MessagePattern class. Pretty-prints the list of MessagePattern Parts and uses the
 * MiniMessageFormatter with a few patterns.
 *
...
public final class MessagePatternDemo {
    ...
    private static final void printFormatWithNamedArgs(String s, Object... args) {
        ...
        if (msg != null) {
            System.out.println(
                    new MiniMessageFormatter(msg)
                            .format(
                                    new StringBuilder(),
                                    MiniMessageFormatter.mapFromNameValuePairs(args)));
        }
    }
    ...
    public static void main(String[] argv) {
        ...
        String msg =
                "++{0, select, female{{1} calls you her friend}"
        ...
        msg =
                "_'__{gender, select, female{Her n'ame is {person_name}.}"
