...
public class CollatorTest extends TestFmwk {
            ...
            if (TestUtil.isICUExtendedLocale(loc)) {
                ...
                if (isIcuImpl) {
                    if (!coll.equals(collIcu)) {
                        errln(
                                "FAIL: getInstance returned ICU Collator for locale "
                                        + loc
    ...
    public void TestICUEquivalent() {
        Locale[] TEST_LOCALES = {
            new Locale("en", "US"), new Locale("de", "DE"), new Locale("ja", "JP"),
        };
    ...
    private void checkCollation(
        ...
        for (String text1 : data) {
            for (String text2 : data) {
                ...
                if (jdkRes != icuRes) {
                    errln(
                            "FAIL: Different results for [text1="
                                    + text1
                                    + ",text2="
                                    + text2
                                    + ") for locale "
                ...
                if (jdkKeyRes != icuKeyRes) {
                    errln(
                            "FAIL: Different collationKey comparison results for [text1="
                                    + text1
                                    + ",text2="
                                    + text2
                                    + ") for locale "
