...
/**
 * CollatorICU is an adapter class which wraps ICU4J Collator and implements java.text.Collator
 * APIs.
 */
public class CollatorICU extends java.text.Collator {
    ...
    public Object clone() {
        ...
        try {
            ...
            throw new UnsupportedOperationException(
                    "clone() is not supported by this ICU Collator.");
        }
        return other;
    }
    ...
    public int getDecomposition() {
        ...
        //        }
        //        else {
        //            throw new IllegalStateException("Unknown decomposition mode is used by the ICU
        // Collator.");
        //        }
