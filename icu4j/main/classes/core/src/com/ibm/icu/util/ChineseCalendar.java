...
public class ChineseCalendar extends Calendar {
    ...
    private void computeChineseFields(int days, int gyear, int gmonth,
        ...
        internalSet(ORDINAL_MONTH, ordinalMonth); // Convert from 1-based to 0-based
    ...
    protected int internalGetMonth(int defaultValue) {
        ...
        temp.set(MONTH, 0);
        temp.set(IS_LEAP_MONTH, 0);
        temp.set(DATE, 1);
        temp.roll(MONTH, internalGet(ORDINAL_MONTH));
        internalSet(IS_LEAP_MONTH, temp.get(IS_LEAP_MONTH));
        int month = temp.get(MONTH);
