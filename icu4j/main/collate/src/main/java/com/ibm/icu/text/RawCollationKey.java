 ...
 *
 * <p>Please refer to the documentation on CollationKey for a detail description on the internal
 * byte representation. Note the internal byte representation is always null-terminated. <code>
 * Example of use:<br>
 * String str[] = {.....};
 ...
 * </code>
 *
 * <p><strong>Note:</strong> Comparison between RawCollationKeys created by different Collators
 * might return incorrect results. See class documentation for Collator.
 *
 * @stable ICU 2.8
...
public final class RawCollationKey extends ByteArrayWrapper {
    ...
    /**
     * RawCollationKey created with an empty internal byte array of length capacity. Size of the
     * internal byte array will be set to 0.
     *
    ...
    /**
     * RawCollationKey created, adopting bytes as the internal byte array. Size of the internal byte
    ...
    /**
     * Compare this RawCollationKey to another, which must not be null. This overrides the inherited
     * implementation to ensure the returned values are -1, 0, or 1.
     *
     * @param rhs the RawCollationKey to compare to.
     * @return -1, 0, or 1 as this compares less than, equal to, or greater than rhs.
