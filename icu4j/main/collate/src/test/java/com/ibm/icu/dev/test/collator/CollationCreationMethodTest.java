...
/**
 * CollationCreationMethodTest checks to ensure that the collators act the same whether they are
 * created by choosing a locale and loading the data from file, or by using rules.
 *
...
public class CollationCreationMethodTest extends TestFmwk {
    ...
    public void TestRuleVsLocaleCreationMonkey() {
        ...
        for (z = 0; z < 60; z++) {
            ...
            try {
                // this is making the assumption that the only type of collator that will be made is
                // RBC
                ...
                warnln(
                        "ERROR: in creation of collator of locale "
