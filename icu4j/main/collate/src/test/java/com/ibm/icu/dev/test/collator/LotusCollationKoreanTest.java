...
/**
 * Port From: ICU4C v2.1 : Collate/LotusCollationKoreanTest Source File:
 * $ICU4CRoot/source/test/intltest/lcukocol.cpp
 */
...
public class LotusCollationKoreanTest extends TestFmwk {
    private static char[][] testSourceCases = {{0xac00}};

    private static char[][] testTargetCases = {{0xac01}};
