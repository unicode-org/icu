...
/**
 * Port From: ICU4C v2.1 : Collate/CollationEnglishTest Source File:
 * $ICU4CRoot/source/test/intltest/encoll.cpp
 */
...
public class CollationEnglishTest extends TestFmwk {
    ...
    private static char[][] testBugs = {
        {0x61}, {0x41}, {0x65}, {0x45}, {0x00e9}, {0x00e8}, {0x00ea}, {0x00eb}, {0x65, 0x61}, {0x78}
    };
