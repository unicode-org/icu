...
/**
 * Port From: ICU4C v2.1 : Collate/CollationKanaTest Source File:
 * $ICU4CRoot/source/test/intltest/jacoll.cpp
 */
...
public class CollationKanaTest extends TestFmwk {
    ...
    private static int[] results = {
        -1, 0, // Collator::LESS, /* Katakanas and Hiraganas are equal on tertiary level(ICU 2.0)*/
        -1, 1, // Collator::LESS, /* Prolonged sound mark sorts BEFORE equivalent vowel (ICU 2.0)*/
        -1,
        -1, // Collator::GREATER /* Prolonged sound mark sorts BEFORE equivalent vowel (ICU 2.0)*//*
        //  6 */
    };
    ...
    private static char[][] testChooonKigooCases = {
        ...
        }, /* Prolonged sound mark sorts BEFORE equivalent vowel (ICU 2.0)*/
        /*7*/ {
    ...
    public void TestCommonCharacters() {
        ...
        if (result != 0 || !key1.equals(key2)) {
            errln(
                    "Failed Hiragana and Katakana common characters test. Expected results to be equal.");
        }
    }
