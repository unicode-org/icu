...
/**
 * CollationMonkeyTest is a third level test class. This tests the random substrings of the default
 * test strings to verify if the compare and sort key algorithm works correctly. For example, any
 * string is always less than the string itself appended with any character.
 */
