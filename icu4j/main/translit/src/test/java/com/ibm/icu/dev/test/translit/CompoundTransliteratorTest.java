...
public class CompoundTransliteratorTest extends TestFmwk {
    ...
    public void TestConstruction() {
        ...
        for (int i = 0; i < 4; i++) {
            try {
                ...
                errln(
                        "FAIL: construction using CompoundTransliterator(String ID) failed for "
                                + IDs[i]);
                throw ex1;
            }
            ...
            try {
                ...
                errln(
                        "FAIL: construction using CompoundTransliterator(String ID, int direction=FORWARD) failed for "
                                + IDs[i]);
                throw ex2;
            }
            ...
            try {
                ...
                errln(
                        "FAIL: construction using CompoundTransliterator(String ID, int direction=REVERSE) failed for "
                                + IDs[i]);
                throw ex3;
            }
            ...
            // Transliterator.FORWARD, null);
            //                cpdtrans = null;
            //            }catch(IllegalArgumentException ex4) {
            //                errln("FAIL: construction using CompoundTransliterator(String ID, int
            // direction=FORWARD," +
            ...
            //
            //            try{
            //                CompoundTransliterator cpdtrans2=new
            // CompoundTransliterator(transarray[i], null);
            //                cpdtrans2 = null;
            //            }catch(IllegalArgumentException ex5) {
            //                errln("FAIL: Construction using CompoundTransliterator(Transliterator
            // transliterators[]," +
    ...
    public void TestGetTransliterator() {
        ...
        String ID =
                "Latin-Greek;Greek-Latin;Latin-Devanagari;Devanagari-Latin;Latin-Cyrillic;Cyrillic-Latin;Any-Hex;Hex-Any";
    ...
    public void TestTransliterate() {
        ...
        expectAux(
                ct1.getID() + ":ReplaceableString, index(0,0,0,0)",
                s + "->" + rsource2,
        ...
        expectAux(
                ct1.getID() + ":String, index2(1,2,2,3)",
                s + "->" + rsource3,
                result.equals(expectedResult),
                expectedResult);
        ...
        String Data[] = {
            ...
            "Devanagari-Latin;Latin-Devanagari", "\u092D\u0948'\u0930'\u0935",
                    "\u092D\u0948\u0930\u0935", // quotes lost
            "Latin-Cyrillic;Cyrillic-Latin", "a'b'k'd'e'f'g'h'i'j'Shch'shch'zh'h",
                    "a'b'k'd'e'f'g'h'i'j'Shch'shch'zh'h",
    ...
    private void expectAux(String tag, String source, String result, String expectedResult) {
