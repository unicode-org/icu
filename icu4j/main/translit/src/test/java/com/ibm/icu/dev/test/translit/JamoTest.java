...
public class JamoTest extends TestFmwk {
    ...
    /** These are problems turned up by the Hangul-Jamo;Jamo-Latin round trip test. */
    @Test
    ...
    static final String WHAT_IS_UNICODE =
            "\uc720\ub2c8\ucf54\ub4dc\uc5d0 \ub300\ud574 ? "
                    ...
                    + "\uc81c\uacf5\ud569\ub2c8\ub2e4. \uc720\ub2c8\ucf54\ub4dc "
                    + "\ud45c\uc900\uc740 "
                    + // "Apple, HP, IBM, JustSystem, Microsoft, Oracle, SAP, " +
                    // "Sun, Sybase, Unisys " +
                    "\ubc0f \uae30\ud0c0 \uc5ec\ub7ec "
                    + "\ud68c\uc0ac\uc640 \uac19\uc740 \uc5c5\uacc4 "
                    + "\uc120\ub450\uc8fc\uc790\uc5d0 \uc758\ud574 "
    ...
    boolean expectAux(String tag, String summary, boolean pass, String expectedResult) {
        return TransliteratorTest.expectAux(
                tag, jamoToName(summary), pass, jamoToName(expectedResult));
    }
    ...
    /**
     * Convert short names to actual jamo. E.g., "x(LG)y" returns "x\u11B0y". See JAMO_NAMES for
     * table of names.
     */
    ...
    /**
     * Convert jamo to short names. E.g., "x\u11B0y" returns "x(LG)y". See JAMO_NAMES for table of
     * names.
     */
