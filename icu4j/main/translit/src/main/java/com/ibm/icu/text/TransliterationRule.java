...
class TransliterationRule {
     ...
     *     are none
     * @param anchorStart true if the the rule is anchored on the left to the context start
    ...
    void addSourceTargetSet(
        ...
        // Iff some of the characters at ALL of the the positions are matched by the filter, then we
        // add temp to toUnionTo
