...
public class UtilityExtensions {
     ...
     * indicate the context start and limit, and the || indicate the start and limit.
     */
    public static StringBuffer formatInput(
            StringBuffer appendTo, ReplaceableString input, Transliterator.Position pos) {
    ...
    /** Convenience method. */
    public static StringBuffer formatInput(
            StringBuffer appendTo, Replaceable input, Transliterator.Position pos) {
