...
public class FormatHandler {
    ...
    public static class BasicDurationFormatHandler implements SerializableTestUtility.Handler {
        @Override
        public Object[] getTestObjects() {
            DurationFormat formats[] = {DurationFormat.getInstance(new ULocale("en"))};
    ...
    public static class RuleBasedNumberFormatHandler extends NumberFormatHandler {
        ...
        public Object[] getTestObjects() {
            Locale locales[] = SerializableTestUtility.getLocales();
            RuleBasedNumberFormat formats[] =
                    new RuleBasedNumberFormat[types.length * locales.length];
            int i = 0;

            for (int t = 0; t < types.length; t += 1) {
                for (int l = 0; l < locales.length; l += 1) {
                    String cannedRules =
                            (String) cannedData.get(locales[l].toString() + "/" + typeNames[t]);
    ...
    public static class CurrencyPluralInfoHandler implements SerializableTestUtility.Handler {
        ...
        public Object[] getTestObjects() {
            CurrencyPluralInfo currencyPluralInfo[] = {
                ...
                new CurrencyPluralInfo(new ULocale("en_US")),
                CurrencyPluralInfo.getInstance(),
                CurrencyPluralInfo.getInstance(new Locale("en", "US")),
    ...
    public static class RelativeDateTimeFormatterFieldHandler
    ...
    public static class DateFormatHandler implements SerializableTestUtility.Handler {
...

        {
            ...
            cannedPatterns.put(
                    "ja_JP", "yyyy'\u5E74'M'\u6708'd'\u65E5'EEEE H'\u6642'mm'\u5206'ss'\u79D2'z");
            cannedPatterns.put(
                    "ja", "yyyy'\u5E74'M'\u6708'd'\u65E5'EEEE H'\u6642'mm'\u5206'ss'\u79D2'z");
            cannedPatterns.put(
                    "ko_KR",
            ...
            cannedPatterns.put(
                    "zh_Hant_TW",
                    "yyyy'\u5E74'M'\u6708'd'\u65E5'EEEE ahh'\u6642'mm'\u5206'ss'\u79D2' z");
            cannedPatterns.put(
                    "zh_TW",
                    "yyyy'\u5E74'M'\u6708'd'\u65E5'EEEE ahh'\u6642'mm'\u5206'ss'\u79D2' z");
        ...
        public Object[] getTestObjects() {
            ...
            for (int i = 0; i < locales.length; i += 1) {
                ...
                // formats[i] = DateFormat.getDateTimeInstance(DateFormat.FULL, DateFormat.FULL,
                // locales[i]);
                formats[i] =
                        getCannedSimpleDateFormat(
                                (String) cannedPatterns.get(uloc.toString()), uloc);
            }
        ...
        public boolean hasSameBehavior(Object a, Object b) {
            ...
            if (!sfa.equals(sfb)) {
                ...
                DateFormatSymbols tmp =
                        (DateFormatSymbols) ((SimpleDateFormat) dfa).getDateFormatSymbols().clone();

                TimeZoneFormat tmptzf =
                        (TimeZoneFormat) ((SimpleDateFormat) dfb).getTimeZoneFormat().clone();
    ...
    public static class SimpleDateFormatHandler extends DateFormatHandler {
        ...
        public Object[] getTestObjects() {
            ...
            for (int p = 0; p < patterns.length; p += 1) {
                for (int l = 0; l < locales.length; l += 1) {
                    dateFormats[i++] =
                            getCannedSimpleDateFormat(patterns[p], ULocale.forLocale(locales[l]));
                }
            }
    ...
    public static class PatternInfoHandler implements SerializableTestUtility.Handler {
        ...
        public Object[] getTestObjects() {
            DateIntervalInfo.PatternInfo patternInfo[] = {
                new DateIntervalInfo.PatternInfo("yyyy MMM dd - ", "dd", false)
            };
            return patternInfo;
        }
    ...
    public static class ChineseDateFormatHandler extends DateFormatHandler {
        ...
        public Object[] getTestObjects() {
            Locale locales[] = SerializableTestUtility.getLocales();
            ChineseDateFormat dateFormats[] =
                    new ChineseDateFormat[patterns.length * locales.length];
            int i = 0;
    ...
    public static class NumberFormatFieldHandler implements SerializableTestUtility.Handler {
        ...
        public Object[] getTestObjects() {
            NumberFormat.Field fields[] = {
                NumberFormat.Field.CURRENCY, NumberFormat.Field.DECIMAL_SEPARATOR,
                        NumberFormat.Field.EXPONENT,
                NumberFormat.Field.EXPONENT_SIGN, NumberFormat.Field.EXPONENT_SYMBOL,
                        NumberFormat.Field.FRACTION,
                NumberFormat.Field.GROUPING_SEPARATOR, NumberFormat.Field.INTEGER,
    ...
    public static class TimeZoneNamesHandler implements SerializableTestUtility.Handler {
        ...
        public Object[] getTestObjects() {
            return new Object[] {
                TimeZoneNames.getInstance(ULocale.ENGLISH), TimeZoneNames.getInstance(ULocale.JAPAN)
            };
        }
    ...
    public static class TimeZoneGenericNamesHandler implements SerializableTestUtility.Handler {
        ...
        public boolean hasSameBehavior(Object a, Object b) {
            ...
            final String[] TZIDS = {
                "America/Los_Angeles", "America/Argentina/Buenos_Aires", "Etc/GMT"
            };
    ...
    public static class TZDBTimeZoneNamesHandler implements SerializableTestUtility.Handler {
        ...
        public boolean hasSameBehavior(Object a, Object b) {
            ...
            final String[] TZIDS = {
                "America/Los_Angeles", "America/Argentina/Buenos_Aires", "Asia/Shanghai", "Etc/GMT"
            };
            ...
            final NameType[] nTypes = {NameType.SHORT_STANDARD, NameType.SHORT_DAYLIGHT};
