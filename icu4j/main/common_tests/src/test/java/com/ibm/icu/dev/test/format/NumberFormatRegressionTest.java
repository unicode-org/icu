...
/**
 * Port From: ICU4C v1.8.1 : format : NumberFormatRegressionTest Source File:
 * $ICU4CRoot/source/test/intltest/numrgts.cpp
 */
...
public class NumberFormatRegressionTest extends CoreTestFmwk {
    ...
    /** DateFormat should call setIntegerParseOnly(true) on adopted NumberFormat objects. */
    @Test
    ...
    public void TestSerialization() throws IOException {
        ...
        double data = 1234.56;
        String[] expected = {"1,234.56", "$1,234.56", "1.23456E3", "1,234.56"};
        for (int i = 0; i < 4; ++i) {
            ...
            try {
                ...
                assertEquals(
                        "Deserialization new version should read old version", expected[i], result);
            } catch (Exception e) {
                e.printStackTrace();
                warnln("FAIL: " + e);
            }
    ...
    public void TestJB5509() {
        ...
        DecimalFormat df =
                new DecimalFormat("#,##0.###", new DecimalFormatSymbols(new ULocale("en_US")));
    ...
    @Test
    public void TestSurrogatesParsing() { // Test parsing of numbers that use digits from the
        // supplemental planes.
        final String[] data = {
            "1\ud801\udca2,3\ud801\udca45.67", //
            "\ud801\udca1\ud801\udca2,\ud801\udca3\ud801\udca4\ud801\udca5.\ud801\udca6\ud801\udca7\ud801\udca8", //
    ...
    public void TestAffixesNoCurrency() {
        ...
        DecimalFormat nf =
                (DecimalFormat) NumberFormat.getInstance(locale, NumberFormat.PLURALCURRENCYSTYLE);
        assertEquals(
