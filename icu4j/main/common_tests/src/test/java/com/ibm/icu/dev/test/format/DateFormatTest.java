...
/**
 * Port From: ICU4C v1.8.1 : format : DateFormatTest Source File:
 * $ICU4CRoot/source/test/intltest/dtfmttst.cpp
 */
...
public class DateFormatTest extends CoreTestFmwk {
     ...
     * that contain the correct localized patterns.
     */
    @Test
    public void TestPatterns() {
        ...
        final String[][] EXPECTED = {
            ...
            {
                DateFormat.HOUR_MINUTE, "jm", "en", "h:mm\u202Fa"
            }, // (fixed expected result per ticket 6872<-7180)
            {
                DateFormat.HOUR24_MINUTE, "Hm", "en", "HH:mm"
            }, // (fixed expected result per ticket 6872<-6626)
            {DateFormat.SECOND, "s", "en", "s"},
            {
                DateFormat.HOUR_MINUTE_SECOND, "jms", "en", "h:mm:ss\u202Fa"
            }, // (fixed expected result per ticket 6872<-7180)
            {
                DateFormat.HOUR24_MINUTE_SECOND, "Hms", "en", "HH:mm:ss"
            }, // (fixed expected result per ticket 6872<-6626)
            {
                DateFormat.MINUTE_SECOND, "ms", "en", "mm:ss"
            }, // (fixed expected result per ticket 6872<-6626)
            ...
            {
                DateFormat.YEAR_NUM_MONTH_DAY + DateFormat.ABBR_UTC_TZ,
                "yMdZZZZ",
                "en",
                "M/d/y, ZZZZ"
            },
        ...
        for (int i = 0; i < EXPECTED.length; i++) {
            ...
            DateFormat date2 =
                    DateFormat.getPatternInstance(
                            Calendar.getInstance(locale), actualPattern, locale);
            ...
            if (!actualLocalPattern1.equals(expectedLocalPattern)) {
                errln(
                        "FAILURE! Expected local pattern: "
        ...
        assertEquals(
                "All skeletons are tested (and in an iterable list)",
                new HashSet<String>(expectedSkeletons),
                new HashSet<String>(testedSkeletons));
        assertEquals(
                "All skeletons are tested (and in an iterable list), and in the right order.",
                expectedSkeletons,
                testedSkeletons);
    }
    ...
    public void TestEquals() {
        ...
        if (!fmtA.equals(fmtB)) errln("FAIL");
    }
    ...
    public void TestTwoDigitYearDSTParse() {
        ...
        SimpleDateFormat fmt =
                new SimpleDateFormat("dd-MMM-yy h:mm:ss 'o''clock' a z", Locale.ENGLISH);
    ...
    public void TestFieldPosition() {
        ...
        assertTrue(
                "DATEFORMAT_FIELD_NAMES", DATEFORMAT_FIELD_NAMES.length == DateFormat.FIELD_COUNT);
        if (DateFormat.FIELD_COUNT
                != PATTERN_CHARS.length() + 1) { // +1 for missing TIME_SEPARATOR pattern char
            errln(
                    "Did not get the correct value for DateFormat.FIELD_COUNT. Expected:  "
        ...
        for (j = 0, exp = 0; j < COUNT; ++j) {
            ...
            for (i = 0; i < DateFormat.FIELD_COUNT; ++i, ++exp) {
                ...
                assertEquals(
                        "pattern#" + j + " field #" + i + " " + DATEFORMAT_FIELD_NAMES[i],
                        EXPECTED[exp],
                        field);
            }
            ...
            for (i = 0; i < DTFMT_FIELDS.length; i++) {
                ...
                field = buf.substring(pos.getBeginIndex(), pos.getEndIndex());
                assertEquals(
                        "pattern#" + j + " " + DTFMT_FIELDS[i].toString(),
                        EXPECTED_BY_FIELD[j][i],
                        field);
            }
        }
    }
    ...
    /** A list of the DateFormat.Field. This MUST be kept in sync with PATTERN_CHARS above. */
    ...
    /**
     * A list of the names of all the fields in DateFormat. This MUST be kept in sync with
     * DateFormat.
     */
    ...
    public void TestGeneral() {
        ...
        String DATA[] = {
            ...
            "y/M/d H:mm:ss.S",
            "fp",
            "2004 03 10 16:36:31.567",
            "2004/3/10 16:36:31.5",
            "2004 03 10 16:36:31.500",
            "y/M/d H:mm:ss.SS",
            "fp",
            "2004 03 10 16:36:31.567",
            "2004/3/10 16:36:31.56",
            "2004 03 10 16:36:31.560",
            "y/M/d H:mm:ss.SSS",
            "F",
            "2004 03 10 16:36:31.567",
            "2004/3/10 16:36:31.567",
            "y/M/d H:mm:ss.SSSS",
            "pf",
            "2004/3/10 16:36:31.5679",
            "2004 03 10 16:36:31.567",
            "2004/3/10 16:36:31.5670",
        };
    ...
    public void TestGenericTime() {
        ...
        String ZDATA[] = {
            ...
            "y/M/d H:mm zzzz",
            "F",
            "2004 01 01 01:00 PST",
            "2004/1/1 1:00 Pacific Standard Time",
            "y/M/d H:mm zzz",
            "F",
            "2004 01 01 01:00 PST",
            "2004/1/1 1:00 PST",
            ...
            "pf",
            "2004/1/1 1:00 PDT",
            "2004 01 01 01:00 PDT",
            "2004/1/1 0:00 PST",
            "y/M/d H:mm vvvv",
            "pf",
            "2004/1/1 1:00 PDT",
            "2004 01 01 01:00 PDT",
            "2004/1/1 0:00 Pacific Time",
            "y/M/d H:mm zzz",
            "pf",
            "2004/7/1 1:00 PST",
            "2004 07 01 02:00 PDT",
            "2004/7/1 2:00 PDT",
            "y/M/d H:mm vvvv",
            "pf",
            "2004/7/1 1:00 PST",
            "2004 07 01 02:00 PDT",
            "2004/7/1 2:00 Pacific Time",
            ...
            "2004 10 31 01:30 PST",
            "2004/10/31 1:30",
            // Below is actually an invalid test case.  See the note in #5910.  Disable the case for
            // now.
            // TODO: Revisit after 3.8
            // "y/M/d H:mm vvvv", "pf", "2004/10/31 1:30 Argentina Time", "2004 10 30 21:30 PDT",
            // "2004/10/31 1:30 Argentina Time",
        };
                        ...
                        try {
                            ...
                            if (!d.equals(t)) {
                                errln(
                                        "format "
                                                + k
                                                + " incorrectly parsed output of format "
                                                + j
                                                + " ("
                                                + test
                                                + "), returned "
                            ...
                            errln(
                                    "format "
                                            + k
                                            + " could not parse output of format "
                                            + j
                                            + " ("
                                            + test
                                            + ")");
    ...
    public void TestGenericTimeZoneOrder() {
        ...
        String XDATA[] = {
            ...
            "2004/1/1 PT 1:00",
            "2004 01 01 01:00 PST",
            "2004/1/1 Pacific Time 1:00",
            "vvvv y/M/d H:mm",
            "pf",
            "PT 2004/1/1 1:00",
            "2004 01 01 01:00 PST",
            "Pacific Time 2004/1/1 1:00",
            ...
            "2004/7/1 PT 1:00",
            "2004 07 01 01:00 PDT",
            "2004/7/1 Pacific Time 1:00",
            "vvvv y/M/d H:mm",
            "pf",
            "PT 2004/7/1 1:00",
            "2004 07 01 01:00 PDT",
            "Pacific Time 2004/7/1 1:00",
        };
        Locale en = new Locale("en", "", "");
    ...
    public void TestTimeZoneInLocale() {
        ...
        for (int i = 0; i < TESTS.length; ++i) {
            ...
            assertEquals(
                    ...
                    TESTS[i][1],
                    smptfmt.getTimeZone().getID());
            assertEquals(
                    "Calendar from SimpleDateFormat(\"Z\", Locale loc=\"" + TESTS[i][0] + "\")",
                    TESTS[i][2],
                    smptfmt.getCalendar().getType());

            smptfmt = new SimpleDateFormat("Z", "", ulocale);
            assertEquals(
                    "TimeZone from SimpleDateFormat(\"Z\", \"\", ULocale loc=\""
                            + TESTS[i][0]
                            + "\")",
                    TESTS[i][1],
                    smptfmt.getTimeZone().getID());
            assertEquals(
                    "Calendar from SimpleDateFormat(\"Z\", \"\", ULocale loc=\""
                            + TESTS[i][0]
                            + "\")",
                    TESTS[i][2],
                    smptfmt.getCalendar().getType());
            ...
            assertEquals(
                    "TimeZone from DateFormat.getInstanceForSkeleton(\"Z\", Locale loc=\""
                            + TESTS[i][0]
                            + "\")",
                    TESTS[i][1],
                    dfmt.getTimeZone().getID());
            assertEquals(
                    "Calendar from DateFormat.getInstanceForSkeleton(\"Z\", Locale loc=\""
                            + TESTS[i][0]
                            + "\")",
                    TESTS[i][2],
                    dfmt.getCalendar().getType());

            dfmt = DateFormat.getInstanceForSkeleton("Z", ulocale);
            assertEquals(
                    "TimeZone from DateFormat.getInstanceForSkeleton(\"Z\", ULocale loc=\""
                            + TESTS[i][0]
                            + "\")",
                    TESTS[i][1],
                    dfmt.getTimeZone().getID());
            assertEquals(
                    "Calendar from DateFormat.getInstanceForSkeleton(\"Z\", ULocale loc=\""
                            + TESTS[i][0]
                            + "\")",
                    TESTS[i][2],
                    dfmt.getCalendar().getType());
            ...
            assertEquals(
                    "TimeZone from DateFormat.getPatternInstance(\"Z\", Locale loc=\""
                            + TESTS[i][0]
                            + "\")",
                    TESTS[i][1],
                    dfmt.getTimeZone().getID());
            assertEquals(
                    "Calendar from DateFormat.getPatternInstance(\"Z\", Locale loc=\""
                            + TESTS[i][0]
                            + "\")",
                    TESTS[i][2],
                    dfmt.getCalendar().getType());
            ...
            assertEquals(
                    "TimeZone from DateFormat.getPatternInstance(\"Z\", ULocale loc=\""
                            + TESTS[i][0]
                            + "\")",
                    TESTS[i][1],
                    dfmt.getTimeZone().getID());
            assertEquals(
                    "Calendar from DateFormat.getPatternInstance(\"Z\", ULocale loc=\""
                            + TESTS[i][0]
                            + "\")",
                    TESTS[i][2],
                    dfmt.getCalendar().getType());
    ...
    private static final String[][] fallbackTests = {
        ...
        // zone for the time zone's country.
        {
            "en_MX",
            "America/Chicago",
            "1995-07-15T00:00:00Z",
            "vvvv",
            "Central Time (United States)",
            "America/Chicago"
        },

        // Tests proper handling of time zones that should have empty sets when inherited from the
        // parent.
        // For example, en_GB understands CET as Central European Time, but en_HK, which inherits
        // from en_GB
        // does not
        {
            "en_GB",
    ...
    /**
     * Verify that strings which contain incomplete specifications are parsed correctly. In some
     * instances, this means not being parsed at all, and returning an appropriate error.
     */
    @Test
    ...
    /**
     * Verify the behavior of patterns in which digits for different fields run together without
    ...
    public void TestRunTogetherPattern985() {
        ...
        if (date2 == null) then = "Parse stopped at " + pos.getIndex();
        else then = ((DateFormat) formatter).format(date2);
        logln(then);
        if (date2 == null || !date2.equals(date1)) errln("FAIL");
    }
    ...
    private void _testIt917(SimpleDateFormat fmt, String str, Date expected) {
        ...
        if (o == null || !o.equals(expected)) errln("FAIL: Expected " + expected);
        String formatted = o == null ? "null" : ((DateFormat) fmt).format(o);
        logln("Formatted string: " + formatted);
        if (!formatted.equals(str)) errln("FAIL: Expected " + str);
    }

    /**
     * Verify the handling of Czech June and July, which have the unique attribute that one is a
     * proper prefix substring of the other.
     */
    @Test
    public void TestCzechMonths459() {
        ...
        try {
            ...
            if (month != Calendar.JUNE) errln("FAIL: Month should be June");
            if (yr != 1997) errln("FAIL: Year should be 1997");
            if (day != 15) errln("FAIL: day should be 15");
            ...
            logln("  . parse . " + s + " (month = " + month + ")");
            if (month != Calendar.JULY) errln("FAIL: Month should be July");
        } catch (ParseException e) {
            errln(e.getMessage());
        }
    }
    ...
    public void TestLetterDPattern212() {
        ...
        if (!myDate.equals(expBigD)) errln("FAIL: Expected " + expBigD);
        formatter = new SimpleDateFormat(littleD);
        pos = new ParsePosition(0);
        myDate = formatter.parse(dateString, pos);
        logln("Using " + littleD + " . " + myDate);
        if (!myDate.equals(expLittleD)) errln("FAIL: Expected " + expLittleD);
    }
    ...
    public void tryPattern(SimpleDateFormat sdf, Date d, String pattern, Date expected) {
        ...
        try {
            ...
            if (!d2.equals(expected)) errln("FAIL: Expected " + expected);
            String format2 = ((DateFormat) sdf).format(d2);
            logln(" format -> " + format2);
            if (!formatResult.equals(format2)) errln("FAIL: Round trip drift");
        } catch (Exception e) {
            errln(e.getMessage());
        }
    }
    ...
    public void TestQuotePattern161() {
        SimpleDateFormat formatter =
                new SimpleDateFormat("MM/dd/yyyy 'at' hh:mm:ss a zzz", Locale.US);
        Calendar cal = Calendar.getInstance();
        cal.clear();
        ...
        if (!dateString.substring(0, exp.length()).equals(exp)) errln("FAIL: Expected " + exp);
    }
    ...
    /**
     * Verify the correct behavior when parsing an array of inputs against an array of patterns,
     * with known results. The results are encoded after the input strings in each row.
     */
    @Test
    public void TestBadInput135a() {
        ...
        Date date;
        String[] parseFormats = {
            "MMMM d, yyyy", "MMMM d yyyy", "M/d/yy",
                ...
                try {
                    ...
                    if (parsePosition.getIndex() != 0) {
                        ...
                        if (date == null) {
                            ...
                            else if (!result.equals(expected)) errln("FAIL: Expected " + expected);
                        }
        ...
        try {
            ...
            logln(
                    "Parsing \""
                            ...
                            + "  => "
                            + d);
            if (!d.equals(expected)) errln("FAIL: Expected " + expected);
        } catch (ParseException e) {
            errln(e.getMessage());
        }
    }
    ...
    public void TestDateFormatZone061() {
        ...
        try {
            ...
            if (!tempDate.equals(date)) errln("FAIL: Expected " + date + " Got: " + tempDate);
        } catch (Throwable t) {
    ...
    public void TestDateFormatZone146() {
        ...
        if (testtimezone.equals("GMT")) logln("Test timezone = " + testtimezone);
        else errln("Test timezone should be GMT, not " + testtimezone);
        ...
        String DATA[] = {
            ...
            "long format:    ",
            "April 4, 1997 11:00:00 PM GMT",
            "MMMM d, yyyy h:mm:ss a z",
            "default format: ",
            "04-Apr-97 11:00:00 PM",
            "dd-MMM-yy h:mm:ss a",
            "short format:   ",
            "4/4/97 11:00 PM",
            "M/d/yy h:mm a"
    ...
    public void TestLocaleDateFormat() {
        ...
        DateFormat dfFrench =
                DateFormat.getDateTimeInstance(DateFormat.FULL, DateFormat.FULL, Locale.FRENCH);
        DateFormat dfUS =
                DateFormat.getDateTimeInstance(DateFormat.FULL, DateFormat.FULL, Locale.US);
        // Set TimeZone = PDT
        ...
        dfUS.setTimeZone(tz);
        String expectedFRENCH_JDK12 =
                "lundi 15 septembre 1997 \u00E0 00:00:00 heure d\u2019\u00E9t\u00E9 du Pacifique nord-am\u00E9ricain";
        ...
        */
        ...
        if (!out.equals(expectedUS)) errln("FAIL: Expected " + expectedUS + " Got " + out);
    }
    ...
    public void TestFormattingLocaleTimeSeparator() {
        ...
        DateFormat dfLatn =
                DateFormat.getTimeInstance(DateFormat.SHORT, new ULocale("ar-EG-u-nu-latn"));
    ...
    public void TestDateFormatNone() {
        Date testDate = new Date(874306800000L); // Mon Sep 15 00:00:00 PDT 1997
        DateFormat dfFrench =
                DateFormat.getDateTimeInstance(DateFormat.FULL, DateFormat.NONE, Locale.FRENCH);
        // Set TimeZone = PDT
        TimeZone tz = TimeZone.getTimeZone("PST");
        dfFrench.setTimeZone(tz);
    ...
    public void TestGreekMay() {
        ...
        SimpleDateFormat fmt =
                new SimpleDateFormat("EEEE, dd MMMM yyyy h:mm:ss a", new Locale("el", "", ""));
    ...
    public void TestChineseDateFormatLocalizedPatternChars() {
        ...
        SimpleDateFormat longChineseDateFormat =
                (SimpleDateFormat)
                        chineseCalendar.getDateTimeFormat(
    ...
    public void TestCoverage() {
        ...
        ICUResourceBundle rb =
                (ICUResourceBundle)
                        UResourceBundle.getBundleInstance(ICUData.ICU_BASE_NAME, "de_DE");
        ...
        try {
            ...
            errln(
                    "ChineseDateFormatSymbols(Calender, Locale) was suppose to return a null "
        ...
        try {
            ...
            errln(
                    "ChineseDateFormatSymbols(Calender, ULocale) was suppose to return a null "
                            + "pointer exception for a null paramater.");
        } catch (Exception e) {
        }
...

        {
            ...
            // cover invalid separator after GMT
            {
                ...
                logln(
                        "Parsing of the text stopped at pos: "
                                + pp.getIndex()
                                + " as expected and length is "
                                + text.length());
            }
...

        {
            ...
            if (!datsym1.equals(datsym2)) {
                errln(
                        "FAIL: DateFormatSymbols returned by getInstance()"
            ...
            if (!datsym1.equals(datsym2)) {
                errln(
                        "FAIL: DateFormatSymbols returned by getInstance(Locale.JAPAN)"
    ...
    public void TestStandAloneMonths() {
        String EN_DATA[] = {
            "yyyy MM dd HH:mm:ss",
            "yyyy LLLL dd H:mm:ss",
            "fp",
            "2004 03 10 16:36:31",
            "2004 March 10 16:36:31",
            "2004 03 10 16:36:31",
            "yyyy LLL dd H:mm:ss",
            "fp",
            "2004 03 10 16:36:31",
            "2004 Mar 10 16:36:31",
            "2004 03 10 16:36:31",
            "yyyy LLLL dd H:mm:ss",
            "F",
            "2004 03 10 16:36:31",
        ...
        String CS_DATA[] = {
            ...
            "fp",
            "2004 04 10 16:36:31",
            "2004 duben 10 16:36:31",
            "2004 04 10 16:36:31",
            "yyyy MMMM dd H:mm:ss",
            "fp",
            "2004 04 10 16:36:31",
            "2004 dubna 10 16:36:31",
            "2004 04 10 16:36:31",
            "yyyy LLL dd H:mm:ss",
            "fp",
            "2004 04 10 16:36:31",
            "2004 dub 10 16:36:31",
            "2004 04 10 16:36:31",
            "yyyy LLLL dd H:mm:ss",
            "F",
            "2004 04 10 16:36:31",
    ...
    public void TestNarrowNames() {
        String EN_DATA[] = {
            "yyyy MM dd HH:mm:ss",
            "yyyy MMMMM dd H:mm:ss",
            "2004 03 10 16:36:31",
            "2004 M 10 16:36:31",
            "yyyy LLLLL dd H:mm:ss",
            "2004 03 10 16:36:31",
            "2004 M 10 16:36:31",
            "MMMMM",
            "1970 01 01 0:00:00",
    ...
    /**
     * Test parsing. Input is an array that starts with the following header:
     *
     * <p>[0] = pattern string to parse [i+2] with
     *
     * <p>followed by test cases, each of which is 3 array elements:
     *
     * <p>[i] = pattern, or null to reuse prior pattern [i+1] = input string [i+2] = expected parse
     * result (parsed with pattern [0])
     *
     * <p>If expect parse failure, then [i+2] should be null.
     */
    ...
    /**
     * Test formatting. Input is an array of String that starts with a single 'header' element
     *
     * <p>[0] = reference dateformat pattern string (ref)
     *
     * <p>followed by test cases, each of which is 4 or 5 elements:
     *
     * <p>[i] = test dateformat pattern string (test), or null to reuse prior test pattern [i+1] =
     * data string A [i+2] = data string B
     *
     * <p>Formats a date, checks the result.
     *
     * <p>Examples: "y/M/d H:mm:ss.SSS", "2004 03 10 16:36:31.567", "2004/3/10 16:36:31.567" --
     * ref.parse A, get t0 -- test.format t0, get r0 -- compare r0 to B, fail if not equal
     */
    void expectFormat(String[] data, Locale loc) {
        ...
        while (i < data.length) {
            ...
            assertEquals(
                    "\"" + currentPat + "\".format(" + datestr + ")", string, fmt.format(date));
        }
    }

    /**
     * Test formatting and parsing. Input is an array of String that starts with a single 'header'
     * element
     *
     * <p>[0] = reference dateformat pattern string (ref)
     *
     ...
     *
     * <p>[i] = test dateformat pattern string (test), or null to reuse prior test pattern [i+1] =
     * control string, either "fp", "pf", or "F". [i+2] = data string A [i+3] = data string B [i+4]
     * = data string C (not present for 'F' control string)
     *
     * <p>Note: the number of data strings depends on the control string.
     *
     * <p>fp formats a date, checks the result, then parses the result and checks against a
     * (possibly different) date pf parses a string, checks the result, then formats the result and
     * checks against a (possibly different) string F is a shorthand for fp when the second date is
     * the same as the first P is a shorthand for pf when the second string is the same as the first
     *
     * <p>Examples: (fp) "y/M/d H:mm:ss.SS", "fp", "2004 03 10 16:36:31.567", "2004/3/10
     * 16:36:31.56", "2004 03 10 16:36:31.560", -- ref.parse A, get t0 -- test.format t0, get r0 --
     * compare r0 to B, fail if not equal -- test.parse B, get t1 -- ref.parse C, get t2 -- compare
     * t1 and t2, fail if not equal
     *
     * <p>(F) "y/M/d H:mm:ss.SSS", "F", "2004 03 10 16:36:31.567", "2004/3/10 16:36:31.567" --
     * ref.parse A, get t0 -- test.format t0, get r0 -- compare r0 to B, fail if not equal --
     * test.parse B, get t1 -- compare t1 and t0, fail if not equal
     *
     * <p>(pf) "y/M/d H:mm:ss.SSSS", "pf", "2004/3/10 16:36:31.5679", "2004 03 10 16:36:31.567",
     * "2004/3/10 16:36:31.5670", -- test.parse A, get t0 -- ref.parse B, get t1 -- compare t0 to
     * t1, fail if not equal -- test.format t1, get r0 -- compare r0 and C, fail if not equal
     *
     * <p>(P) "y/M/d H:mm:ss.SSSS", "P", "2004/3/10 16:36:31.5679", "2004 03 10 16:36:31.567"", --
     * test.parse A, get t0 -- ref.parse B, get t1 -- compare t0 to t1, fail if not equal --
     * test.format t1, get r0 -- compare r0 and A, fail if not equal
     */
    ...
    */
    ...
    public void TestFormatToCharacterIterator() {
                ...
                if (map.isEmpty()) {
                    ...
                    while (acit.getIndex() < limit) {
                        if (acit.current() != SEPCHAR) {
                            errln(
                                    "FAIL: Invalid pattern literal at "
                                            + acit.current()
                                            + " in patterns["
                                            + i
                                            + "]");
        ...
        // ChineseDateFormat has pattern letter 'l' for leap month marker in addition to regular
        // DateFormat
        cal.clear();
        ...
        if (keys.contains(ChineseDateFormat.Field.IS_LEAP_MONTH)) {
            errln(
                    "FAIL: separate IS_LEAP_MONTH field should not be present for a Chinese calendar non-leap date"
        ...
        if (keys.contains(ChineseDateFormat.Field.IS_LEAP_MONTH)) {
            errln(
                    "FAIL: separate IS_LEAP_MONTH field should no longer be present for a Chinese calendar leap date"
    ...
    public void TestFormatToCharacterIteratorCoverage() {
        ...
        try {
            ...
            if (acit == null) {
                errln(
                        "FAIL: null AttributedCharacterIterator returned by formatToCharacterIterator(Calendar)");
            }
        ...
        try {
            ...
            if (acit == null) {
                errln(
                        "FAIL: null AttributedCharacterIterator returned by formatToCharacterIterator(Date)");
            }
        } catch (IllegalArgumentException iae) {
        ...
        try {
            ...
            if (acit == null) {
                errln(
                        "FAIL: null AttributedCharacterIterator returned by formatToCharacterIterator(Number)");
            }
        } catch (IllegalArgumentException iae) {
        ...
        try {
            ...
            if (acit == null) {
                errln(
                        "FAIL: null AttributedCharacterIterator returned by formatToCharacterIterator(String)");
            }
        } catch (IllegalArgumentException iae) {
        ...
        if (!isException) {
            errln(
                    "FAIL: IllegalArgumentException must be thrown by ofCalendarField for calendar field value -1");
        }
    ...
    public void TestCalendarType() {
        ...
        for (int i = 0; i < testLocales.length; i++) {
            ...
            DateFormat df =
                    cal.getDateTimeFormat(DateFormat.MEDIUM, DateFormat.MEDIUM, locNoKeywords);
    ...
    public void TestRoundtripWithCalendar() {
        ...
        final DateFormat[] formatters = {
            ...
            //            DateFormat.getPatternInstance(pattern, new
            // ULocale("ar_EG@calendar=islamic")),
            //            DateFormat.getPatternInstance(pattern, new
            // ULocale("ja_JP@calendar=japanese")),
        };
                ...
                if (!refStr.equals(buf.toString())) {
                    errln(
                            "FAIL: Different format result with a different calendar for the same time -"
                                    + "\n Reference calendar type="
                                    + calendars[i].getType()
                                    + "\n Another calendar type="
                                    + calendars[j].getType()
                                    + "\n Expected result="
                                    + refStr
                                    + "\n Actual result="
                ...
                if (calendars[i].getTimeInMillis() != calendars[j].getTimeInMillis()
                    ...
                    errln(
                            "FAIL: Different parse result with a different calendar for the same string -"
                                    ...
                                    + "\n Expected time zone="
                                    + calendars[i].getTimeZone().getID()
                                    + "\n Actual time="
                                    + calendars[j].getTimeInMillis()
                                    + "\n Actual time zone="
                                    + calendars[j].getTimeZone().getID());
                }
            }
        }
    }
    ...
    public void TestRelativeDateFormat() {
        ...
        for (int i = 0; i < dateStylesList.length; i++) {
            ...
            DateFormat fmtRelDateTime =
                    DateFormat.getDateTimeInstance(dateStyle, DateFormat.SHORT, loc);
            ...
            for (int dayOffset = -2; dayOffset <= 2; dayOffset++) {
                ...
                if (dateTimeStr.toString().indexOf(dateStr.toString()) < 0) {
                    errln(
                            "relative date string not found in datetime format with timeStyle SHORT, dateStyle "
                                    + dateStyle
                                    + " for dayOffset "
                                    + dayOffset);
                    errln(
                ...
                if (dateTimeStr.toString().indexOf(timeStr.toString()) < 0) {
                    errln(
                            "short time string not found in datetime format with timeStyle SHORT, dateStyle "
                                    + dateStyle
                                    + " for dayOffset "
                                    + dayOffset);
                    errln(
                ...
                if (fp.getBeginIndex() != minutesStrIndex) {
                    errln(
                            "FieldPosition beginIndex "
                                    + fp.getBeginIndex()
                                    + " instead of "
                                    + minutesStrIndex
                                    + " for datetime format with timeStyle SHORT, dateStyle "
                                    + dateStyle
                                    + " for dayOffset "
                                    + dayOffset);
    ...
    public void TestOfCalendarField() {
        ...
        for (int i = 0; i < cases.length; i++) {
            try {
                ...
                errln(
                        "Field.ofCalendarField(int) is not suppose to "
                                + "return an exception for parameter "
                                + cases[i]);
            }
        }
    }
    ...
    public void TestGetPatternInstance() {
        ...
        try {
            ...
            errln(
                    "DateFormat.getPatternInstance is not suppose to return an exception, got: "
                            + e.toString());
            // e.printStackTrace();
        }
    }
    ...
    public void TestLongContiguousNumericPattern() {
        String DATA[] = {
            ...
            "fp",
            "2010-04-16 12:23:34.456",
            "20100416122334456000",
            "2010-04-16 12:23:34.456",
            "yyyyyyMMddHHHHmmmmssssSSSSSS",
            "fp",
            "2010-04-16 12:23:34.456",
            "0020100416001200230034456000",
            "2010-04-16 12:23:34.456",
        };
        expect(DATA, new Locale("en", "", ""));
    }
    ...
    public void TestOverrideNumberForamt() {
        ...
        for (int i = 0; i < 100; i++) {
            ...
            if (!get_nf.equals(check_nf)) errln("FAIL: getter and setter do not work");
        }
    ...
    public void TestParsePosition() {
        ...
        ParseTestData[] TestData = {
            ...
            new ParseTestData(
                    "'time zone:' VVVV 'date:' yyyy-MM-dd",
                    "xxxx",
                    "time zone: Los Angeles Time date: 2010-02-25",
                    "xxxx"),
        };
    ...
    public void TestChineseDateFormatSymbols() {
        ...
        for (ChineseDateFormatSymbolItem item : items) {
            ...
            if (!cdfSymbols.getLeapMonth(0).contentEquals("")
                    || !cdfSymbols.getLeapMonth(1).contentEquals(item.marker)) {
                errln(
                        "FAIL: isLeapMonth [0],[1] for locale "
                                + item.locale
                                + "; expected \"\", \""
                                + item.marker
                                + "\"; got \""
                                + cdfSymbols.getLeapMonth(0)
                                + "\", \""
                                + cdfSymbols.getLeapMonth(1)
                                + "\"");
            }
        }
    }
    ...
    public void TestMonthPatterns() {
        ...
        class MonthPatternItem {
            ...
            // Simple constructor
            public MonthPatternItem(
                    String loc, int styl, String dateStr0, String dateStr1, String dateStr2) {
                locale = loc;
                style = styl;
        ...
        final MonthPatternItem[] items = {
            new MonthPatternItem(
                    "root@calendar=chinese",
                    DateFormat.LONG,
                    "2012(ren-chen) M04 2",
                    "2012(ren-chen) M04bis 2",
                    "2012(ren-chen) M05 2"),
            new MonthPatternItem(
                    "root@calendar=chinese",
                    DateFormat.SHORT,
            ...
            new MonthPatternItem(
                    "root@calendar=chinese", -2, "78x29-4-2", "78x29-4bis-2", "78x29-5-2"),
            new MonthPatternItem(
                    "root@calendar=chinese", -3, "ren-chen-4-2", "ren-chen-4bis-2", "ren-chen-5-2"),
            new MonthPatternItem(
                    "root@calendar=chinese",
                    -4,
                    "ren-chen M04 2",
                    ...
                    "ren-chen M05 2"),
            new MonthPatternItem(
                    "en@calendar=gregorian", -3, "2012-4-22", "2012-5-22", "2012-6-20"),
            new MonthPatternItem(
                    "en@calendar=chinese",
                    DateFormat.LONG,
                    "Fourth Month 2, 2012(ren-chen)",
                    "Fourth Monthbis 2, 2012(ren-chen)",
                    "Fifth Month 2, 2012(ren-chen)"),
            new MonthPatternItem(
                    "en@calendar=chinese", DateFormat.SHORT, "4/2/2012", "4bis/2/2012", "5/2/2012"),
            new MonthPatternItem(
                    "zh@calendar=chinese",
                    DateFormat.LONG,
                    "2012\u58EC\u8FB0\u5E74\u56DB\u6708\u521D\u4E8C",
            ...
            new MonthPatternItem(
                    ...
                    "2 w\u01D4yu\u00E8 ren-chen"),
            new MonthPatternItem(
                    "fr@calendar=chinese", DateFormat.SHORT, "2/4/29", "2/4bis/29", "2/5/29"),
            new MonthPatternItem(
                    "en@calendar=dangi",
                    DateFormat.LONG,
                    "Third Monthbis 2, 2012(ren-chen)",
                    "Fourth Month 2, 2012(ren-chen)",
                    "Fifth Month 1, 2012(ren-chen)"),
            new MonthPatternItem(
                    "en@calendar=dangi", DateFormat.SHORT, "3bis/2/2012", "4/2/2012", "5/1/2012"),
        ...
        final String[] customPatterns = {
            "y-Ml-d", "G'x'y-Ml-d", "U-M-d", "U MMM d"
        ...
        for (MonthPatternItem item : items) {
            ...
            DateFormat dfmt =
                    (item.style >= 0)
                            ? DateFormat.getDateInstance(item.style, locale)
                            : new SimpleDateFormat(customPatterns[-item.style - 1], locale);
            int idate = 0;
            for (ChineseCalTestDate date : dates) {
                ...
                if (result.toString().compareTo(item.dateString[idate]) != 0) {
                    errln(
                            "FAIL: Chinese calendar format for locale "
                                    + item.locale
                                    + ", style "
                                    + item.style
                                    + ", expected \""
                                    + item.dateString[idate]
                                    + "\", got \""
                                    + result
                                    + "\"");
                } else {
                    ...
                    if (ppos.getIndex() < result.length()
                            || year != date.year
                            || month != date.month
                            || isLeapMonth != date.isLeapMonth
                            || day != date.day) {
                        errln(
                                "FAIL: Chinese calendar parse for locale "
                                        + item.locale
                                        + ", style "
                                        + item.style
                                        + ", string \""
    ...
    public void TestNonGregoFmtParse() {
        ...
        final TestNonGregoItem[] items = {
            ...
            new TestNonGregoItem(
                    "zh@calendar=chinese", DateFormat.NONE, "rU\u5E74MMMd", cafti_zh_chinese_custU),
            new TestNonGregoItem(
                    "zh@calendar=chinese",
                    DateFormat.NONE,
                    "r\u5E74MMMd",
            ...
            new TestNonGregoItem(
                    "en@calendar=islamic", DateFormat.NONE, "d MMM y G, r", cafti_en_islamic_cust),
        };
        for (TestNonGregoItem item : items) {
            ...
            for (CalAndFmtTestItem caftItem : item.caftItems) {
                ...
                if (result.toString().compareTo(caftItem.formattedDate) != 0) {
                    errln(
                            "FAIL: date format for locale "
                                    + item.locale
                                    + ", style "
                                    + item.style
                                    + ", expected \""
                                    + caftItem.formattedDate
                                    + "\", got \""
                                    + result
                                    + "\"");
                } else {
                    ...
                    if (ppos.getIndex() < result.length()
                            || era != caftItem.era
                            || year != caftItem.year
                            || month != caftItem.month
                            || day != caftItem.day) {
                        errln(
                                "FAIL: date parse for locale "
                                        + item.locale
                                        + ", style "
                                        + item.style
                                        + ", string \""
    ...
    public void TestFormatsWithNumberSystems() {
        ...
        long date =
                1451556000000L; // for UTC: grego 31-Dec-2015 10 AM, hebrew 19 tevet 5776, chinese
        // yi-wei 11mo 21day
        ...
        final TestFmtWithNumSysItem[] items = {
            new TestFmtWithNumSysItem(
                    "haw@calendar=gregorian", DateFormat.SHORT, "d/M/yy", "31/xii/15"),
            new TestFmtWithNumSysItem(
                    "he@calendar=hebrew",
                    DateFormat.LONG,
                    "d \u05D1MMMM y",
            ...
            new TestFmtWithNumSysItem(
                    ...
                    DateFormat.LONG,
                    "rU\u5E74MMMd",
                    "2015\u4E59\u672A\u5E74\u5341\u4E00\u6708\u5EFF\u4E00"), // "2015乙未年十一月廿一"
            new TestFmtWithNumSysItem(
                    "zh_Hant@calendar=chinese",
                    DateFormat.LONG,
                    "rU\u5E74MMMd",
                    "2015\u4E59\u672A\u5E74\u51AC\u6708\u5EFF\u4E00"), // "2015乙未年冬月廿一"
            new TestFmtWithNumSysItem(
                    "ja@calendar=chinese",
                    DateFormat.LONG,
                    "U\u5E74MMMd\u65E5",
    ...
    public void TestContext() {
        ...
        final TestContextItem[] items = {
            ...
            new TestContextItem(
                    ...
                    "juillet 2008"),
            new TestContextItem(
                    "fr", "MMMM y", DisplayContext.CAPITALIZATION_FOR_STANDALONE, "Juillet 2008"),
            new TestContextItem(
                    "cs", "LLLL y", DisplayContext.CAPITALIZATION_NONE, "\u010Dervenec 2008"),
            new TestContextItem(
                    "cs",
                    "LLLL y",
                    DisplayContext.CAPITALIZATION_FOR_MIDDLE_OF_SENTENCE,
        ...
        class TestRelativeContextItem {
            ...
            // Simple constructor
            public TestRelativeContextItem(
                    String loc,
                    DisplayContext capCtxt,
                    String expFmtToday,
                    String expFmtYesterday) {
                locale = loc;
                capitalizationContext = capCtxt;
        ...
        final TestRelativeContextItem[] relItems = {
            new TestRelativeContextItem(
                    "en", DisplayContext.CAPITALIZATION_NONE, "today", "yesterday"),
            new TestRelativeContextItem(
                    "en",
                    DisplayContext.CAPITALIZATION_FOR_MIDDLE_OF_SENTENCE,
                    "today",
            ...
            new TestRelativeContextItem(
                    ...
                    "Yesterday"),
            new TestRelativeContextItem(
                    "en", DisplayContext.CAPITALIZATION_FOR_UI_LIST_OR_MENU, "Today", "Yesterday"),
            new TestRelativeContextItem(
                    "en", DisplayContext.CAPITALIZATION_FOR_STANDALONE, "Today", "Yesterday"),
            new TestRelativeContextItem(
                    "nb", DisplayContext.CAPITALIZATION_NONE, "i dag", "i g\u00E5r"),
            new TestRelativeContextItem(
                    "nb",
                    DisplayContext.CAPITALIZATION_FOR_MIDDLE_OF_SENTENCE,
                    "i dag",
            ...
            new TestRelativeContextItem(
                    ...
                    "I g\u00E5r"),
            new TestRelativeContextItem(
                    "nb", DisplayContext.CAPITALIZATION_FOR_UI_LIST_OR_MENU, "i dag", "i g\u00E5r"),
            new TestRelativeContextItem(
                    "nb", DisplayContext.CAPITALIZATION_FOR_STANDALONE, "I dag", "I g\u00E5r"),
        };
        ...
        for (TestContextItem item : items) {
            ...
            DisplayContext capitalizationContext =
                    sdfmt.getContext(DisplayContext.Type.CAPITALIZATION);
            if (capitalizationContext != item.capitalizationContext) {
                errln(
                        "FAIL: getContext for locale "
                                + item.locale
                                + ", capitalizationContext "
                                + item.capitalizationContext
                                + ", but got context "
        ...
        for (TestRelativeContextItem relItem : relItems) {
            ...
            if (result2.toString().compareTo(relItem.expectedFormatToday) != 0) {
                errln(
                        "FAIL: format today for locale "
                                + relItem.locale
                                + ", capitalizationContext "
                                + relItem.capitalizationContext
                                + ", expected \""
                                + relItem.expectedFormatToday
                                + "\", got \""
                                + result2
                                + "\"");
            }
            if (!serializeTestFail) {
                ...
                if (result2.toString().compareTo(relItem.expectedFormatToday) != 0) {
                    errln(
                            "FAIL: use dfmtFromStream to format today for locale "
                                    + relItem.locale
                                    + ", capitalizationContext "
                                    + relItem.capitalizationContext
                                    + ", expected \""
            ...
            if (result2.toString().compareTo(relItem.expectedFormatYesterday) != 0) {
                errln(
                        "FAIL: format yesterday for locale "
                                + relItem.locale
                                + ", capitalizationContext "
                                + relItem.capitalizationContext
                                + ", expected \""
                                + relItem.expectedFormatYesterday
                                + "\", got \""
                                + result2
                                + "\"");
            }
            ...
            DisplayContext capitalizationContext =
                    dfmt.getContext(DisplayContext.Type.CAPITALIZATION);
        ...
        for (ULocale locale : Arrays.asList(ULocale.ENGLISH, ULocale.FRENCH)) {
            ...
            for (int dateStyle = DateFormat.FULL; dateStyle <= DateFormat.SHORT; ++dateStyle) {
                ...
                for (int timeStyle = DateFormat.FULL; timeStyle <= DateFormat.SHORT; ++timeStyle) {
                    ...
                    formattedString =
                            dateFormat.format(TEST_DATE) + "  " + timeFormat.format(TEST_DATE);
                    tests.add(new Object[] {format, formattedString});
                    if (formattedString.contains(
                            "n ")) { // will add "." after the end of text ending in 'n', like Jan.
                        tests.add(
                                new Object[] {format, formattedString.replace("n ", "n. ") + "."});
                    }
                    if (formattedString.contains(
    ...
    private boolean showParse(DateFormat format, String formattedString) {
        ...
        boolean ok =
                TEST_DATE.equals(parsed) && parsePosition.getIndex() == formattedString.length();
        if (ok) {
    ...
    public void TestDateFormatLeniency() {
        ...
        class TestDateFormatLeniencyItem {
            ...
            // Simple constructor
            public TestDateFormatLeniencyItem(
                    ULocale loc, boolean len, String parString, String patt, String expResult) {
                locale = loc;
                leniency = len;
                pattern = patt;
        ...
        final TestDateFormatLeniencyItem[] items = {
            //                             locale               leniency    parse String    pattern
            //            expected result
            new TestDateFormatLeniencyItem(
                    ULocale.ENGLISH, true, "2008-07 02", "yyyy-LLLL dd", "2008-July 02"),
            new TestDateFormatLeniencyItem(
                    ULocale.ENGLISH, false, "2008-07 02", "yyyy-LLLL dd", null),
            new TestDateFormatLeniencyItem(
                    ULocale.ENGLISH, true, "2008-Jan 02", "yyyy-LLL. dd", "2008-Jan. 02"),
            new TestDateFormatLeniencyItem(
                    ULocale.ENGLISH, false, "2008-Jan 02", "yyyy-LLL. dd", null),
            new TestDateFormatLeniencyItem(
                    ULocale.ENGLISH, true, "2008-Jan--02", "yyyy-MMM' -- 'dd", "2008-Jan -- 02"),
            new TestDateFormatLeniencyItem(
                    ULocale.ENGLISH, false, "2008-Jan--02", "yyyy-MMM' -- 'dd", null),
        };
        ...
        for (TestDateFormatLeniencyItem item : items) {
            ...
            sdfmt.setBooleanAttribute(BooleanAttribute.PARSE_ALLOW_WHITESPACE, item.leniency)
                    ...
                    .setBooleanAttribute(
                            BooleanAttribute.PARSE_PARTIAL_LITERAL_MATCH, item.leniency);

            ParsePosition p = new ParsePosition(0);
            Date d = sdfmt.parse(item.parseString, p);
            if (item.expectedResult == null) {
                if (p.getErrorIndex() != -1) continue;
                else
                    errln(
                            "error: unexpected parse success..."
                                    + item.parseString
                                    + " w/ lenient="
                                    + item.leniency
                                    + " should have failed");
            ...
            if (!result.equalsIgnoreCase(item.expectedResult)) {
                errln(
                        "error: unexpected format result. expected - "
                                + item.expectedResult
                                + "  but result was - "
                                + result);
            } else {
    ...
    public void Test10632() {
        ...
        for (int i = 0; i < dateStylesList.length; i++) {
            ...
            DateFormat fmt1 =
                    DateFormat.getDateTimeInstance(fmtCal, dateStylesList[i], DateFormat.DEFAULT);
            ...
            for (int j = 0; j < testDates.length; j++) {
                ...
                if (!s0.equals(s1)) {
                    errln(
                            "FAIL: Different results returned by two equivalent relative formatters: s0="
                                    + s0
                                    + ", s1="
                                    + s1);
                }
    ...
    public void TestParseMultiPatternMatch() {
        ...
        class TestMultiPatternMatchItem {
            ...
            // Simple constructor
            public TestMultiPatternMatchItem(
                    boolean len, String parString, String patt, String expResult) {
                leniency = len;
                pattern = patt;
                parseString = parString;
                expectedResult = expResult;
        ...
        final TestMultiPatternMatchItem[] items = {
            ...
            new TestMultiPatternMatchItem(
                    false, "2013-September 16", "yyyy-MMMM dd", "2013-September 16"),
            ...
            new TestMultiPatternMatchItem(
                    false, "2013-September 20", "yyyy-LLLL dd", "2013-September 20"),
            new TestMultiPatternMatchItem(
                    true, "2013 Sat Sep 21", "yyyy EEE MMM dd", "2013 Sat Sep 21"),
            new TestMultiPatternMatchItem(
                    true, "2013 Sunday Sep 22", "yyyy EEE MMM dd", "2013 Sun Sep 22"),
            new TestMultiPatternMatchItem(false, "2013 Monday Sep 23", "yyyy EEE MMM dd", null),
            new TestMultiPatternMatchItem(
                    false, "2013 Tuesday Sep 24", "yyyy EEEE MMM dd", "2013 Tuesday Sep 24"),
            new TestMultiPatternMatchItem(
                    true, "2013 Wed Sep 25", "yyyy eee MMM dd", "2013 Wed Sep 25"),
            new TestMultiPatternMatchItem(
                    true, "2013 Thu Sep 26", "yyyy eee MMM dd", "2013 Thu Sep 26"),
            new TestMultiPatternMatchItem(false, "2013 Friday Sep 27", "yyyy eee MMM dd", null),
            new TestMultiPatternMatchItem(
                    false, "2013 Saturday Sep 28", "yyyy eeee MMM dd", "2013 Saturday Sep 28"),
            new TestMultiPatternMatchItem(
                    true, "2013 Sun Sep 29", "yyyy ccc MMM dd", "2013 Sun Sep 29"),
            new TestMultiPatternMatchItem(
                    true, "2013 Monday Sep 30", "yyyy ccc MMM dd", "2013 Mon Sep 30"),
            new TestMultiPatternMatchItem(false, "2013 Sunday Oct 13", "yyyy ccc MMM dd", null),
            new TestMultiPatternMatchItem(
                    false, "2013 Monday Oct 14", "yyyy cccc MMM dd", "2013 Monday Oct 14"),
            new TestMultiPatternMatchItem(
                    true, "2013 Oct 15 Q4", "yyyy MMM dd QQQ", "2013 Oct 15 Q4"),
            new TestMultiPatternMatchItem(
                    true, "2013 Oct 16 4th quarter", "yyyy MMM dd QQQ", "2013 Oct 16 Q4"),
            new TestMultiPatternMatchItem(
                    false, "2013 Oct 17 4th quarter", "yyyy MMM dd QQQ", null),
            new TestMultiPatternMatchItem(
                    false, "2013 Oct 18 Q4", "yyyy MMM dd QQQ", "2013 Oct 18 Q4"),
            new TestMultiPatternMatchItem(
                    true, "2013 Oct 19 Q4", "yyyy MMM dd qqqq", "2013 Oct 19 4th quarter"),
            new TestMultiPatternMatchItem(
                    true, "2013 Oct 20 4th quarter", "yyyy MMM dd qqqq", "2013 Oct 20 4th quarter"),
            new TestMultiPatternMatchItem(false, "2013 Oct 21 Q4", "yyyy MMM dd qqqq", null),
            new TestMultiPatternMatchItem(
                    false,
                    "2013 Oct 22 4th quarter",
                    "yyyy MMM dd qqqq",
                    "2013 Oct 22 4th quarter"),
        };
        ...
        for (TestMultiPatternMatchItem item : items) {
            ...
            sdfmt.setBooleanAttribute(
                    BooleanAttribute.PARSE_MULTIPLE_PATTERNS_FOR_MATCH, item.leniency);
            result.setLength(0);
            p.setIndex(0);
            p.setErrorIndex(-1);
    ...
    public void TestParseLeniencyAPIs() {
        ...
        assertTrue(
                "ALLOW_WHITESPACE default",
                fmt.getBooleanAttribute(BooleanAttribute.PARSE_ALLOW_WHITESPACE));
        assertTrue(
                "ALLOW_NUMERIC default",
                fmt.getBooleanAttribute(BooleanAttribute.PARSE_ALLOW_NUMERIC));
        assertTrue(
                "PARTIAL_MATCH default",
                fmt.getBooleanAttribute(BooleanAttribute.PARSE_PARTIAL_LITERAL_MATCH));
        assertTrue(
                "MULTIPLE_PATTERNS default",
                fmt.getBooleanAttribute(BooleanAttribute.PARSE_MULTIPLE_PATTERNS_FOR_MATCH));
        ...
        assertTrue(
                "ALLOW_WHITESPACE after setCalendarLenient(false)",
                fmt.getBooleanAttribute(BooleanAttribute.PARSE_ALLOW_WHITESPACE));
        assertTrue(
                "ALLOW_NUMERIC  after setCalendarLenient(false)",
                fmt.getBooleanAttribute(BooleanAttribute.PARSE_ALLOW_NUMERIC));
        ...
        assertFalse(
                "ALLOW_WHITESPACE after setLenient(false)",
                fmt.getBooleanAttribute(BooleanAttribute.PARSE_ALLOW_WHITESPACE));
        assertFalse(
                "ALLOW_NUMERIC  after setLenient(false)",
                fmt.getBooleanAttribute(BooleanAttribute.PARSE_ALLOW_NUMERIC));
        // These two boolean attributes are NOT affected according to the API specification
        assertTrue(
                "PARTIAL_MATCH after setLenient(false)",
                fmt.getBooleanAttribute(BooleanAttribute.PARSE_PARTIAL_LITERAL_MATCH));
        assertTrue(
                "MULTIPLE_PATTERNS after setLenient(false)",
                fmt.getBooleanAttribute(BooleanAttribute.PARSE_MULTIPLE_PATTERNS_FOR_MATCH));
        ...
        assertTrue(
                "ALLOW_WHITESPACE after ALLOW_WHITESPACE/true",
                fmt.getBooleanAttribute(BooleanAttribute.PARSE_ALLOW_WHITESPACE));
        assertFalse(
                "ALLOW_NUMERIC  after ALLOW_WHITESPACE/true",
                fmt.getBooleanAttribute(BooleanAttribute.PARSE_ALLOW_NUMERIC));
        ...
        assertTrue(
                "ALLOW_WHITESPACE after setLenient(true)",
                fmt.getBooleanAttribute(BooleanAttribute.PARSE_ALLOW_WHITESPACE));
        assertTrue(
                "ALLOW_NUMERIC after setLenient(true)",
                fmt.getBooleanAttribute(BooleanAttribute.PARSE_ALLOW_NUMERIC));
    }
    ...
    public void TestAmPmMidnightNoon() {
        ...
        // Note: "midnight" can be ambiguous as to whether it refers to beginning of day or end of
        // day.
        ...
        //        assertEquals("hh:mm:ss bbbb | 00:00:00", "12:00:00 midnight",
        // sdf.format(k000000));
    ...
    public void TestDayPeriodWithLocales() {
        ...
        // sdf.format(k000000));
        assertEquals(
                "hh:mm:ss BBBB | 00:00:00 | en_US", "12:00:00 in the morning", sdf.format(k000000));
        assertEquals(
                "hh:mm:ss BBBB | 01:00:00 | en_US", "01:00:00 in the morning", sdf.format(k010000));
        ...
        sdf.applyPattern("hh:mm:ss BBBB");
        assertEquals(
                "hh:mm:ss BBBB | 01:00:00 | es_CO", "01:00:00 de la mañana", sdf.format(k010000));
        ...
        sdf.applyPattern("hh:mm:ss BBBB");
        assertEquals(
                "hh:mm:ss BBBB | 01:00:00 | es", "01:00:00 de la madrugada", sdf.format(k010000));
        ...
        sdf.applyPattern("hh:mm:ss BBBB");
        assertEquals(
                "hh:mm:ss BBBB | 01:00:00 | en@calendar=buddhist",
                "01:00:00 in the morning",
                sdf.format(k010000));
    }
    ...
    public void TestMinuteSecondFieldsInOddPlaces() {
        ...
        // Apply pattern through constructor to make sure parsePattern() is called during
        // initialization.
    ...
    public void TestDayPeriodParsing() throws ParseException {
        ...
        assertEquals(
                "yyyy-MM-dd B | 2015-11-13 midnight", k000000, sdf.parse("2015-11-13 midnight"));
        assertEquals("yyyy-MM-dd B | 2015-11-13 noon", k120000, sdf.parse("2015-11-13 noon"));
        assertEquals(
                "yyyy-MM-dd B | 2015-11-13 in the afternoon",
                k150000,
                sdf.parse("2015-11-13 in the afternoon"));
        assertEquals(
                "yyyy-MM-dd B | 2015-11-13 in the evening",
                k193000,
                sdf.parse("2015-11-13 in the evening"));
        assertEquals(
                "yyyy-MM-dd B | 2015-11-13 at night", k223000, sdf.parse("2015-11-13 at night"));

        // If time and day period are consistent with each other then time is parsed accordingly.
        sdf.applyPattern("yyyy-MM-dd hh:mm B");
        assertEquals(
                "yyyy-MM-dd hh:mm B | 2015-11-13 12:00 midnight",
                k000000,
                sdf.parse("2015-11-13 12:00 midnight"));
        assertEquals(
                "yyyy-MM-dd hh:mm B | 2015-11-13 12:00 noon",
                k120000,
                sdf.parse("2015-11-13 12:00 noon"));
        assertEquals(
                "yyyy-MM-dd hh:mm B | 2015-11-13 01:00 in the morning",
                k010000,
                sdf.parse("2015-11-13 01:00 in the morning"));
        assertEquals(
                "yyyy-MM-dd hh:mm B | 2015-11-13 01:00 in the afternoon",
                k130000,
                sdf.parse("2015-11-13 01:00 in the afternoon"));
        assertEquals(
                "yyyy-MM-dd hh:mm B | 2015-11-13 09:00 in the morning",
                k090000,
                sdf.parse("2015-11-13 09:00 in the morning"));
        assertEquals(
                "yyyy-MM-dd hh:mm B | 2015-11-13 09:00 at night",
                k210000,
                sdf.parse("2015-11-13 09:00 at night"));
        ...
        sdf.applyPattern("yyyy-MM-dd HH:mm B");
        assertEquals(
                "yyyy-MM-dd HH:mm B | 2015-11-13 13:37 midnight",
                k133700,
                sdf.parse("2015-11-13 13:37 midnight"));
        assertEquals(
                "yyyy-MM-dd HH:mm B | 2015-11-13 13:37 noon",
                k133700,
                sdf.parse("2015-11-13 13:37 noon"));
        assertEquals(
                "yyyy-MM-dd HH:mm B | 2015-11-13 13:37 at night",
                k133700,
                sdf.parse("2015-11-13 13:37 at night"));
        assertEquals(
                "yyyy-MM-dd HH:mm B | 2015-11-13 13:37 in the afternoon",
                k133700,
                sdf.parse("2015-11-13 13:37 in the afternoon"));
        assertEquals(
                "yyyy-MM-dd HH:mm B | 2015-11-13 13:37 in the morning",
                k133700,
                sdf.parse("2015-11-13 13:37 in the morning"));
        assertEquals(
                "yyyy-MM-dd HH:mm B | 2015-11-13 13:37 at night",
                k133700,
                sdf.parse("2015-11-13 13:37 at night"));
        ...
        sdf.applyPattern("yyyy-MM-dd hh:mm B");
        assertEquals(
                "yyyy-MM-dd hh:mm B | 2015-11-13 00:00 midnight",
                k000000,
                sdf.parse("2015-11-13 00:00 midnight"));
        assertEquals(
                "yyyy-MM-dd hh:mm B | 2015-11-13 00:00 noon",
                k120000,
                sdf.parse("2015-11-13 00:00 noon"));

        // But when parsed with 'H', 0 indicates a 24-hour time, therefore we disregard the day
        // period.
        sdf.applyPattern("yyyy-MM-dd HH:mm B");
        assertEquals(
                "yyyy-MM-dd HH:mm B | 2015-11-13 00:37 midnight",
                k003700,
                sdf.parse("2015-11-13 00:37 midnight"));
        assertEquals(
                "yyyy-MM-dd HH:mm B | 2015-11-13 00:37 noon",
                k003700,
                sdf.parse("2015-11-13 00:37 noon"));
        assertEquals(
                "yyyy-MM-dd HH:mm B | 2015-11-13 00:37 at night",
                k003700,
                sdf.parse("2015-11-13 00:37 at night"));
        assertEquals(
                "yyyy-MM-dd HH:mm B | 2015-11-13 00:37 in the afternoon",
                k003700,
                sdf.parse("2015-11-13 00:37 in the afternoon"));
        assertEquals(
                "yyyy-MM-dd HH:mm B | 2015-11-13 00:37 in the morning",
                k003700,
                sdf.parse("2015-11-13 00:37 in the morning"));
        assertEquals(
                "yyyy-MM-dd HH:mm B | 2015-11-13 00:37 at night",
                k003700,
                sdf.parse("2015-11-13 00:37 at night"));
        ...
        assertEquals(
                "yyyy-MM-dd hh:mm B | 2015-11-13 07:00 in the afternoon",
                k190000,
                sdf.parse("2015-11-13 07:00 in the afternoon"));
        // NIGHT1 is [21, 6), but "8 at night" parses to 20:00.
        assertEquals(
                "yyyy-MM-dd hh:mm B | 2015-11-13 08:00 at night",
                k200000,
                sdf.parse("2015-11-13 08:00 at night"));
        ...
        sdf.applyPattern("yyyy-MM-dd hh:mm b");
        assertEquals(
                "yyyy-MM-dd hh:mm b | 2015-11-13 01:00 AM",
                k010000,
                sdf.parse("2015-11-13 01:00 AM"));
        assertEquals(
                "yyyy-MM-dd hh:mm b | 2015-11-13 01:00 PM",
                k130000,
                sdf.parse("2015-11-13 01:00 PM"));
        ...
        sdf.applyPattern("yyyy-MM-dd hh:mm b");
        assertEquals(
                "yyyy-MM-dd hh:mm b | 2015-11-13 03:00 midnight",
                k030000,
                sdf.parse("2015-11-13 03:00 midnight"));
        assertEquals(
                "yyyy-MM-dd hh:mm b | 2015-11-13 03:00 noon",
                k150000,
                sdf.parse("2015-11-13 03:00 noon"));
    }
    ...
    public void test20741_ABFields() {
        ...
        for (String skeleton : skeletons) {
            for (int i = 0; i < locales.length; i++) {
                ...
                assertFalse(
                        "'Day of week' field was not found",
                        pos_c.getBeginIndex() == 0 && pos_c.getEndIndex() == 0);
                ...
                if (skeleton.equals("EEEEEBBBBB")) {
                    ...
                    assertFalse(
                            "'Flexible day period' field was not found",
                            pos_B.getBeginIndex() == 0 && pos_B.getEndIndex() == 0);
                } else {
                    FieldPosition pos_b = new FieldPosition(DateFormat.Field.AM_PM_MIDNIGHT_NOON);
                    dateFormat.format(calendar, new StringBuffer(""), pos_b);
                    assertFalse(
                            "'AM/PM/Midnight/Noon' field was not found",
                            pos_b.getBeginIndex() == 0 && pos_b.getEndIndex() == 0);
                }
                ...
                assertTrue(
                        "'AM/PM' field was found",
                        pos_a.getBeginIndex() == 0 && pos_a.getEndIndex() == 0);
            }
        }
    }
    ...
    public void TestNumericFieldStrictParse() {
        ...
        class NumericFieldStrictParseItem {
            ...
            public NumericFieldStrictParseItem(
                    String locID, String pat, String txt, int p, int f1, int v1, int f2, int v2) {
                localeID = locID;
                pattern = pat;
                text = txt;
                pos = p;
        ...
        final NumericFieldStrictParseItem[] items = {
            //                              locale   pattern       text        pos field1
            // value1            field2       value2
            // Ticket #22337
            new NumericFieldStrictParseItem(
                    "en_US",
                    "MM/dd/yyyy",
                    "1/1/2023",
                    8,
        ...
        for (NumericFieldStrictParseItem item : items) {
            ...
            if (ppos.getIndex() != item.pos) {
                errln(
                        "error: SimpleDateFormat.parse locale "
                                + item.localeID
                                + " pattern "
                                + item.pattern
                                + ": expected pos "
    ...
    public void TestHourCycle() {
        ...
        final String[][] TEST_CASES =
                new String[][] {
                    ...
                    // test a couple locales for which we don't have specific locale files (we
                    // should still get the correct hour cycle)
    ...
    private static void oneCalendarTest(Locale locale, String expect1, String expect2) {
    ...
    public void TestJdkCalendarFormatting() {
        ...
        // Japanese calendar
        oneCalendarTest(
                new Locale("ja", "JP", "JP"), "令和7年9月25日 19:47", "令和7年9月25日(木) 19:47 GMT-7");
        oneCalendarTest(
