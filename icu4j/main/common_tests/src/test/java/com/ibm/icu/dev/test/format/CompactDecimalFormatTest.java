...
public class CompactDecimalFormatTest extends CoreTestFmwk {
    ...
    //    private void checkCore(Map<String, String[][]> affixes, Map<String, String[]>
    // currencyAffixes, long[] divisors, Object[][] testItems) {
    ...
    public void TestCharacterIterator() {
        ...
        assertEquals(
                ...
                iter.getAttribute(NumberFormat.Field.INTEGER));
    ...
    public void TestArabicLongStyle() {
        ...
        assertEquals(
                "Arabic Long", "\u061C-\u0665\u066B\u0663 \u0623\u0644\u0641", cdf.format(-5300));
    }
    ...
    public void TestEquals() {
        ...
        CompactDecimalFormat equalsCdf =
                CompactDecimalFormat.getInstance(ULocale.forLanguageTag("sw"), CompactStyle.SHORT);
        CompactDecimalFormat notEqualsCdf =
                CompactDecimalFormat.getInstance(ULocale.forLanguageTag("sw"), CompactStyle.LONG);
    ...
    public void TestBig() {
        CompactDecimalFormat cdf =
                CompactDecimalFormat.getInstance(ULocale.ENGLISH, CompactStyle.LONG);
        BigInteger source_int = new BigInteger("31415926535897932384626433");
        cdf.setMaximumFractionDigits(0);
        assertEquals(
                "BigInteger format wrong: ", "31,415,926,535,898 trillion", cdf.format(source_int));
        BigDecimal source_dec = new BigDecimal(source_int);
        assertEquals(
                "BigDecimal format wrong: ", "31,415,926,535,898 trillion", cdf.format(source_dec));
    }
    ...
    private void checkCdf(String title, CompactDecimalFormat cdf, Object[][] testData) {
        for (Object[] row : testData) {
            ...
            assertEquals(title + source, expected, cdf.format(source));
        }
    }
    ...
    public void TestNordic() {
        String result =
                CompactDecimalFormat.getInstance(
                                new ULocale("no_NO"), CompactDecimalFormat.CompactStyle.SHORT)
                        .format(12000);
    ...
    public void TestLongShortFallback() {
        ...
        for (int i = 0; i < locs.length; i++) {
            ...
            CompactDecimalFormat cdfShort =
                    CompactDecimalFormat.getInstance(loc, CompactStyle.SHORT);
    ...
    public void TestLocaleGroupingForLargeNumbers() {
        ULocale[] locs = {
            new ULocale("en"), new ULocale("it"), new ULocale("en_US_POSIX"), new ULocale("en-IN")
        };
    ...
    public void TestBug12422() {
        ...
        cdf =
                CompactDecimalFormat.getInstance(
                        new ULocale("ar", "SA"), CompactDecimalFormat.CompactStyle.LONG);
        ...
        cdf =
                CompactDecimalFormat.getInstance(
                        new ULocale("ar-EG"), CompactDecimalFormat.CompactStyle.SHORT);
        cdf.setMaximumSignificantDigits(3);
        result = cdf.format(1234);
        assertEquals(
                "CDF should correctly format 1234 with 3 significant digits in 'ar-EG'",
                "١٫٢٣ ألف",
                result);
        ...
        assertEquals(
                "CDF should correctly format 43000 with currency in 'ar-EG'", "٤٣ ألف US$", result);
        result = cdf.format(new CurrencyAmount(-43000f, Currency.getInstance("USD")));
        assertEquals(
                "CDF should correctly format -43000 with currency in 'ar-EG'",
                "؜-٤٣ ألف US$",
                result);
        ...
        cdf =
                CompactDecimalFormat.getInstance(
                        new ULocale("fi"), CompactDecimalFormat.CompactStyle.SHORT);
        result = cdf.format(new CurrencyAmount(43000f, Currency.getInstance("USD")));
        assertEquals("CDF should correctly format 43000 with currency in 'fi'", "43 t. $", result);
        result = cdf.format(new CurrencyAmount(-43000f, Currency.getInstance("USD")));
        assertEquals(
                "CDF should correctly format -43000 with currency in 'fi'", "−43 t. $", result);
    }
    ...
    public void TestBug12688() {
        ...
        assertEquals(
                "CDF should correctly format 123000 with currency in 'it'",
                "123.000\u00A0€",
                result);
    }
    ...
    public void TestBug11319() {
        CompactDecimalFormat cdf =
                CompactDecimalFormat.getInstance(new ULocale("yue-HK"), CompactStyle.SHORT);
    ...
    public void TestBug12975() {
        ...
        assertEquals(
                "CompactDecimalFormat should use default pattern when compact pattern is unavailable",
                resultDefault,
                resultCdf);
    }
