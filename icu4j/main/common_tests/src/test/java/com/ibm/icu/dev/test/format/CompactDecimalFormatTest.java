...
public class CompactDecimalFormatTest extends CoreTestFmwk {
    ...
    public void TestBug12688() {
        ...
        assertEquals(
                "CDF should correctly format 123000 with currency in 'it'", "123K\u00A0€", result);
    }
    ...
    public void TestBug12975() {
        ...
        // assertEquals("CompactDecimalFormat should use default pattern when compact pattern is
        // unavailable",
