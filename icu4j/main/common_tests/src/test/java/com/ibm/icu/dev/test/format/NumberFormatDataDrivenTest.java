...
public class NumberFormatDataDrivenTest {
    ...
    /**
     * Standard function for comparing expected and actual parse-currency results. Handles failure
     * cases. Does not currently handle NaN or Infinity because there are no parse-currency cases
     * with NaN or Infinity.
     */
    private static String compareParseCurrencyResult(
            String expected, String expectedCurrency, CurrencyAmount actual, ParsePosition ppos) {
    ...
    private DataDrivenNumberFormatTestUtility.CodeUnderTest ICU4J =
            new DataDrivenNumberFormatTestUtility.CodeUnderTest() {
                ...
                public String toPattern(DataDrivenNumberFormatTestData tuple) {
                    ...
                    if (tuple.toLocalizedPattern != null) {
                        ...
                        if (!expected.equals(actual)) {
                            result.append(
                                    "Expected toLocalizedPattern=" + expected + ", got " + actual);
                        }
                    }
                ...
                public String parseCurrency(DataDrivenNumberFormatTestData tuple) {
                    ...
                    return compareParseCurrencyResult(
                            tuple.output, tuple.outputCurrency, actual, ppos);
                }
                    ...
                    DecimalFormat fmt =
                            new DecimalFormat(
                                    ...
                                    new DecimalFormatSymbols(
                                            tuple.locale == null ? EN : tuple.locale));
                ...
                private void adjustDecimalFormat(
                        DataDrivenNumberFormatTestData tuple, DecimalFormat fmt) {
    ...
    private DataDrivenNumberFormatTestUtility.CodeUnderTest JDK =
            new DataDrivenNumberFormatTestUtility.CodeUnderTest() {
                 ...
                 * @return
                 */
                private java.text.DecimalFormat createDecimalFormat(
    ...
    static void propertiesFromTuple(
            DataDrivenNumberFormatTestData tuple, DecimalFormatProperties properties) {
        if (tuple.minIntegerDigits != null) {
        ...
        if (tuple.localizedPattern != null) {
            ...
            String converted =
                    PatternStringUtils.convertLocalized(tuple.localizedPattern, symbols, false);
     ...
     */
    private DataDrivenNumberFormatTestUtility.CodeUnderTest ICU4J_Properties =
            new DataDrivenNumberFormatTestUtility.CodeUnderTest() {
                ...
                /**
                 * Runs a single formatting test. On success, returns null. On failure, returns the
                ...
                /**
                 * Runs a single toPattern test. On success, returns null. On failure, returns the
                 * error. This implementation just returns null. Subclasses should override.
                 *
                 * @param tuple contains the parameters of the format test.
                 */
                ...
                public String toPattern(DataDrivenNumberFormatTestData tuple) {
                    ...
                    if (tuple.toLocalizedPattern != null) {
                        ...
                        if (!expected.equals(actual)) {
                            return "Expected toLocalizedPattern='"
                                    + expected
                                    + "'; got '"
                                    + actual
                                    + "'";
    ...
    public void TestNoUnknownIDs() {
        DataDrivenNumberFormatTestUtility.checkNoUnknownIDs(
                "numberformattestspecification.txt", "CHJKP");
    }

    @Test
    public void TestDataDrivenICU4J() {
        DataDrivenNumberFormatTestUtility.runFormatSuiteIncludingKnownFailures(
                "numberformattestspecification.txt", ICU4J);
    }
    ...
    public void TestDataDrivenICU4JProperties() {
        DataDrivenNumberFormatTestUtility.runFormatSuiteIncludingKnownFailures(
                "numberformattestspecification.txt", ICU4J_Properties);
    }
}
