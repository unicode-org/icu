 ...
 *
 * <p>It covers the examples in the <a
 * href="https://github.com/unicode-org/message-format-wg/blob/main/spec/syntax.md">spec
...
public class Mf2FeaturesTest extends CoreTestFmwk {
    ...
    public void testArgumentMissing() {
        ...
        String message =
                "Hello {$name}, today is {$today :datetime year=numeric month=long day=numeric weekday=long}.";
    ...
    public void testAllKindOfDates() {
        ...
        TestUtils.runTestCase(
                new TestCase.Builder()
                        .pattern(
                                "Testing date formatting: {$date :date year=numeric month=long day=numeric}.")
                        .locale("ro-RO")
                        .arguments(Args.of("date", TEST_DATE))
        ...
        TestUtils.runTestCase(
                new TestCase.Builder()
                        .pattern(
                                "Testing date formatting: {$date :datetime hour=numeric minute=numeric}.")
                        .locale("ro-RO")
                        .arguments(Args.of("date", TEST_DATE))
        ...
        TestUtils.runTestCase(
                new TestCase.Builder()
                        .pattern(
                                "Testing date formatting: {$date :date year=numeric month=short day=numeric}.")
                        .arguments(Args.of("date", TEST_DATE))
        ...
        TestUtils.runTestCase(
                new TestCase.Builder()
                        .pattern("Testing date formatting: {$date :datetime timeStyle=short}.")
                        .arguments(Args.of("date", TEST_DATE))
                        .expected("Testing date formatting: 7:42\u202FPM.")
                        .build());
    }
    ...
    public void testSpecialPluralWithDecimals() {
        ...
        TestUtils.runTestCase(
                new TestCase.Builder()
                        ...
                        .build());
        message =
                ".local $amount = {$count :number minimumFractionDigits=2}\n"
                        + ".match $amount\n"
