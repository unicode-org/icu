...
public class RbnfTest extends CoreTestFmwk {
    ...
    public void TestOrdinalAbbreviations() {
        RuleBasedNumberFormat formatter =
                new RuleBasedNumberFormat(Locale.US, RuleBasedNumberFormat.ORDINAL);
        String[][] testData = {
            {"1", "1st"},
            {"2", "2nd"},
            {"3", "3rd"},
    ...
    public void TestSpanishSpellout() {
        RuleBasedNumberFormat formatter =
                new RuleBasedNumberFormat(
                        new Locale("es", "es", ""), RuleBasedNumberFormat.SPELLOUT);
        String[][] testData = {
            {"1", "uno"},
            {"6", "seis"},
            {"16", "diecis\u00e9is"},
    ...
    public void TestFrenchSpellout() {
        ...
        String[][] testData = {
            ...
            {
                "2,345,678",
                "deux millions trois cent quarante-cinq mille " + "six cent soixante-dix-huit"
            },
            {"-36", "moins trente-six"},
    ...
    public void TestSwissFrenchSpellout() {
        RuleBasedNumberFormat formatter =
                new RuleBasedNumberFormat(new Locale("fr", "CH"), RuleBasedNumberFormat.SPELLOUT);
        String[][] testData = {
            {"1", "un"},
            {"15", "quinze"},
            {"20", "vingt"},
            ...
            {
                "2,345,678",
                "deux millions trois cent quarante-cinq mille " + "six cent septante-huit"
            },
            {"-36", "moins trente-six"},
            {"234.567", "deux cent trente-quatre virgule cinq six sept"}
        };
    ...
    public void TestItalianSpellout() {
        RuleBasedNumberFormat formatter =
                new RuleBasedNumberFormat(Locale.ITALIAN, RuleBasedNumberFormat.SPELLOUT);
        String[][] testData = {
            {"1", "uno"},
            {"15", "quindici"},
            {"20", "venti"},
    ...
    public void TestGermanSpellout() {
        ...
        String[][] testData = {
            ...
            {
                "4,567",
                "vier\u00ADtausend\u00ADf\u00fcnf\u00ADhundert\u00ADsieben\u00ADund\u00ADsechzig"
            },
            {
                "15,943",
                "f\u00fcnfzehn\u00ADtausend\u00ADneun\u00ADhundert\u00ADdrei\u00ADund\u00ADvierzig"
            },
            {
                "2,345,678",
                "zwei Millionen"
                    + " drei\u00ADhundert\u00ADf\u00fcnf\u00ADund\u00ADvierzig\u00ADtausend\u00AD"
    ...
    public void TestThaiSpellout() {
        RuleBasedNumberFormat formatter =
                new RuleBasedNumberFormat(new Locale("th", "TH"), RuleBasedNumberFormat.SPELLOUT);
        String[][] testData = {
            {"0", "\u0e28\u0e39\u0e19\u0e22\u0e4c"},
            {"1", "\u0e2b\u0e19\u0e36\u0e48\u0e07"},
            {"10", "\u0e2a\u0e34\u0e1a"},
            ...
            {
                "21.45",
                "\u0e22\u0e35\u0e48\u200b\u0e2a\u0e34\u0e1a\u200b\u0e40\u0e2d\u0e47\u0e14\u200b\u0e08\u0e38\u0e14\u200b\u0e2a\u0e35\u0e48\u0e2b\u0e49\u0e32"
            },
            {
                "22.45",
                "\u0e22\u0e35\u0e48\u200b\u0e2a\u0e34\u0e1a\u200b\u0e2a\u0e2d\u0e07\u200b\u0e08\u0e38\u0e14\u200b\u0e2a\u0e35\u0e48\u0e2b\u0e49\u0e32"
            },
            {
                "23.45",
                "\u0e22\u0e35\u0e48\u200b\u0e2a\u0e34\u0e1a\u200b\u0e2a\u0e32\u0e21\u200b\u0e08\u0e38\u0e14\u200b\u0e2a\u0e35\u0e48\u0e2b\u0e49\u0e32"
            },
            {
                "123.45",
                "\u0e2b\u0e19\u0e36\u0e48\u0e07\u200b\u0e23\u0e49\u0e2d\u0e22\u200b\u0e22\u0e35\u0e48\u200b\u0e2a\u0e34\u0e1a\u200b\u0e2a\u0e32\u0e21\u200b\u0e08\u0e38\u0e14\u200b\u0e2a\u0e35\u0e48\u0e2b\u0e49\u0e32"
            },
            {
                "12,345.678",
                "\u0E2B\u0E19\u0E36\u0E48\u0E07\u200b\u0E2B\u0E21\u0E37\u0E48\u0E19\u200b\u0E2A\u0E2D\u0E07\u200b\u0E1E\u0E31\u0E19\u200b\u0E2A\u0E32\u0E21\u200b\u0E23\u0E49\u0E2D\u0E22\u200b\u0E2A\u0E35\u0E48\u200b\u0E2A\u0E34\u0E1A\u200b\u0E2B\u0E49\u0E32\u200b\u0E08\u0E38\u0E14\u200b\u0E2B\u0E01\u0E40\u0E08\u0E47\u0E14\u0E41\u0E1B\u0E14"
            },
        };
        ...
        try {
            ...
            if (1000
                    != (result =
                                    ruFormatter.parse(
                                            ruFormatter.format(
                                                    1000, "%spellout-cardinal-feminine-genitive")))
                            .doubleValue()) {
                errln("RuleBasedNumberFormat did not return the correct value. Got: " + result);
            }
            if (1000
    ...
    public void TestNorwegianSpellout() {
        ...
        RuleBasedNumberFormat noFormatter =
                new RuleBasedNumberFormat(noLocale, RuleBasedNumberFormat.SPELLOUT);
        RuleBasedNumberFormat nbFormatter =
                new RuleBasedNumberFormat(nbLocale, RuleBasedNumberFormat.SPELLOUT);
    ...
    public void TestSwedishSpellout() {
        ...
        String[][] testDataDefault = {
            ...
            {
                "12,345,678",
                "tolv miljoner tre\u00ADhundra\u00ADfyrtio\u00ADfem\u00ADtusen"
                    + " sex\u00ADhundra\u00ADsjuttio\u00AD\u00e5tta"
            },
            {
                "123,456.789",
                "ett\u00ADhundra\u00ADtjugo\u00ADtre\u00ADtusen"
                    + " fyra\u00ADhundra\u00ADfemtio\u00ADsex komma sju \u00e5tta nio"
            },
            {
                "-12,345.678",
                "minus tolv\u00ADtusen tre\u00ADhundra\u00ADfyrtio\u00ADfem komma sex sju \u00e5tta"
            },
        };
    ...
    public void TestSmallValues() {
        String[][] testData = {
            ...
            {
                "0.000000000001",
                "zero point zero zero zero zero zero zero zero zero zero zero zero one"
            },
            {
                "0.0000000000001",
                "zero point zero zero zero zero zero zero zero zero zero zero zero zero one"
            },
            {
                "0.00000000000001",
                "zero point zero zero zero zero zero zero zero zero zero zero zero zero zero one"
            },
            {
                "0.000000000000001",
                "zero point zero zero zero zero zero zero zero zero zero zero zero zero zero zero"
                    + " one"
            },
            ...
            {
                "10,000,000.000000002",
                "ten million point zero zero zero zero zero zero zero zero two"
            },
            {"10,000,000", "ten million"},
            {
                "1,234,567,890.0987654",
                "one billion two hundred thirty-four million five hundred sixty-seven thousand"
                    + " eight hundred ninety point zero nine eight seven six five four"
            },
            {
                "123,456,789.9876543",
                "one hundred twenty-three million four hundred fifty-six thousand seven hundred"
                    + " eighty-nine point nine eight seven six five four three"
            },
            {
                "12,345,678.87654321",
                "twelve million three hundred forty-five thousand six hundred seventy-eight point"
                    + " eight seven six five four three two one"
            },
            {
                "1,234,567.7654321",
                "one million two hundred thirty-four thousand five hundred sixty-seven point seven"
                    + " six five four three two one"
            },
            {
                "123,456.654321",
                "one hundred twenty-three thousand four hundred fifty-six point six five four three"
                    + " two one"
            },
            {
                "12,345.54321",
                "twelve thousand three hundred forty-five point five four three two one"
            },
            ...
            {
                "0.0000000011754944",
                "zero point zero zero zero zero zero zero zero zero one one seven five four nine"
                    + " four four"
            },
            {
                "0.000001175494351",
                "zero point zero zero zero zero zero one one seven five four nine four three five"
                    + " one"
            },
        };
    ...
    public void TestRuleSetDisplayName() {
        ...
        for (int i = 0; i < RSNames_defLoc.length; i++) {
            assertEquals(
                    "getRuleSetDisplayNames in default locale",
                    localizations[1][i + 1],
                    RSNames_defLoc[i]);
        }
        ...
        for (int i = 0; i < RSNames_loc.length; i++) {
            assertEquals(
                    "getRuleSetDisplayNames in English", localizations[1][i + 1], RSNames_loc[i]);
        }

        RSNames_loc = formatter.getRuleSetDisplayNames(ULocale.CHINA);
        for (int i = 0; i < RSNames_loc.length; i++) {
            assertEquals(
                    "getRuleSetDisplayNames in Chinese", localizations[2][i + 1], RSNames_loc[i]);
        }

        RSNames_loc = formatter.getRuleSetDisplayNames(new ULocale("foo_Bar_BAZ"));
        for (int i = 0; i < RSNames_loc.length; i++) {
            assertEquals(
                    "getRuleSetDisplayNames in fake locale",
                    localizations[3][i + 1],
                    RSNames_loc[i]);
        }
    }
    ...
    public void TestEquals() {
        ...
        if (rbnf.equals("dummy")
                ...
                || rbnf.equals(1.0)) {
            errln(
                    "RuleBasedNumberFormat.equals(Object that) was suppose to "
        ...
        if (!rbnf1.equals(rbnf1)) {
            errln(
                    "RuleBasedNumberFormat.equals(Object that) was not suppose to "
                            + "be false for an invalid object.");
        }
    ...
    public void TestGetRuleDisplayNameLocales() {
        ...
        if (rbnf.getRuleSetDisplayNameLocales() != null) {
            errln(
                    "RuleBasedNumberFormat.getRuleDisplayNameLocales() was suppose to "
                            + "return null.");
        }
    }
    ...
    public void TestGetRulesSetDisplayName() {
        ...
        try {
            ...
            errln(
                    "RuleBasedNumberFormat.getRuleSetDisplayName(String ruleSetName, ULocale loc) "
    ...
    public void TestChineseProcess() {
        ...
        for (int i = 0; i < ruleNames.length; i++) {
            try {
                ...
                errln(
                        "RBNFChinesePostProcessor was not suppose to return an exception "
                                + "when being formatted with parameters 0.0 and "
                                + ruleNames[i]);
            }
        }
    }
    ...
    public void TestSetDecimalFormatSymbols() {
        RuleBasedNumberFormat rbnf =
                new RuleBasedNumberFormat(Locale.ENGLISH, RuleBasedNumberFormat.ORDINAL);
    ...
    public void TestContext() {
        class TextContextItem {
            ...
            public TextContextItem(
                    String loc, int fmt, DisplayContext ctxt, double val, String expRes) {
                locale = loc;
                format = fmt;
                context = ctxt;
                value = val;
    ...
    public void TestRounding() {
        ...
        String[][] enTestFullData = {
            ...
            {
                "450359962737049.6",
                "four hundred fifty trillion three hundred fifty-nine billion nine hundred"
                    + " sixty-two million seven hundred thirty-seven thousand forty-nine point six"
            }, // 2^52 / 10
            {
                "450359962737049.7",
                "four hundred fifty trillion three hundred fifty-nine billion nine hundred"
                    + " sixty-two million seven hundred thirty-seven thousand forty-nine point"
                    + " seven"
            }, // 2^52 + 1 / 10
        };
    ...
    public void testLargeNumbers() {
        ...
        String[][] enTestFullData = {
            {
                "-9007199254740991",
                "minus nine quadrillion seven trillion one hundred ninety-nine billion two hundred"
                    + " fifty-four million seven hundred forty thousand nine hundred ninety-one"
            }, // Maximum precision in both a double and a long
            {
                "9007199254740991",
            ...
            }, // Only precisely contained in a long
            {
                "9007199254740992",
                "nine quadrillion seven trillion one hundred ninety-nine billion two hundred"
                    + " fifty-four million seven hundred forty thousand nine hundred ninety-two"
            ...
            {
                "999999999999999999",
                "nine hundred ninety-nine quadrillion nine hundred ninety-nine trillion nine"
                    + " hundred ninety-nine billion nine hundred ninety-nine million nine hundred"
                    + " ninety-nine thousand nine hundred ninety-nine"
            },
            {
                "1000000000000000000", "1,000,000,000,000,000,000"
            }, // The rules don't go to 1 quintillion yet
            {
                "-9223372036854775809", "-9,223,372,036,854,775,809"
            }, // We've gone beyond 64-bit precision
            {
            ...
            {
                "-9223372036854775806", "minus 9,223,372,036,854,775,806"
            }, // Minimum 64-bit precision + 1
            ...
            {
                "9223372036854775808", "9,223,372,036,854,775,808"
            }, // We've gone beyond 64-bit precision. This can only be represented with BigDecimal.
        };
    ...
    public void TestNumberingSystem() {
        RuleBasedNumberFormat rbnf =
                new RuleBasedNumberFormat(ULocale.US, RuleBasedNumberFormat.NUMBERING_SYSTEM);
    ...
    public void TestInfiniteRecursion() {
        ...
        for (String badRule : badRules) {
            try {
                ...
                try {
                    rbnf.format(5);
                    // we don't actually care about the result; we just want to make sure the
                    // function returns
                ...
                // ">>>" generates a parse exception when you try to create the formatter (so we
                // expect that rather
                // than re-throwing and triggering a test failure)
                // (eventually it'd be nice to statically analyze the rules for (at least) the most
                // common
                // causes of infinite recursion, in which case we'd end up down here and need to
                // check
                // the error code.  But for now, we probably won't end up here and don't care if we
                // do)
                if (!badRule.equals("<<<")) {
                    throw e;
                }
     ...
     * ordinals, to use different words as a magnitude unit and when it's the final word. Several
     * languages need grammatical agreement between the final and non-final magnitude unit with the
     * numerical quantity before the unit. This test is the equivalent seen in other languages.
     */
    @Test
    public void testOmissionReplacementWithPluralRules() {
        final String rules =
                "%cardinal:\n"
                    ...
                    + "80: eight[y->>|ieth];\n"
                    + "90: ninet[y->>|ieth];\n"
                    + "100: <%cardinal< [$(cardinal,one{hundred}other{hundreds})$"
                    + " >>|$(cardinal,one{hundredth}other{hundredths})$];\n"
                    + "1000: <%cardinal< [$(cardinal,one{thousand}other{thousands})$"
                    + " >>|$(cardinal,one{thousandth}other{thousandths})$];\n"
                    + "1000000: <%cardinal< [$(cardinal,one{million}other{millions})$"
                    + " >>|$(cardinal,one{millionth}other{millionths})$];\n"
                    + "1000000000: <%cardinal< [$(cardinal,one{billion}other{billions})$"
                    + " >>|$(cardinal,one{billionth}other{billionths})$];\n"
                    + "1000000000000: <%cardinal< [$(cardinal,one{trillion}other{trillions})$"
                    + " >>|$(cardinal,one{trillionth}other{trillionths})$];\n"
