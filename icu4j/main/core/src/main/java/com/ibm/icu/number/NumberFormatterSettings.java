 ...
 * implemented by {@link UnlocalizedNumberFormatter} and {@link LocalizedNumberFormatter}. This
...
public abstract class NumberFormatterSettings<T extends NumberFormatterSettings<?>> {
     ...
     * </ul>
     *
     * <p>All notation styles will be properly localized with locale data, and all notation styles
     * are compatible with units, rounding strategies, and other number formatter settings.
     *
     * <p>Pass this method the return value of a {@link Notation} factory method. For example:
     *
     * <pre>
     ...
     *
     * @param notation The notation strategy to use.
    ...
    /**
     * Specifies the unit (unit of measure, currency, or percent) to associate with rendered
     * numbers.
     *
     * <ul>
     ...
     *
     * <p>Pass this method any instance of {@link MeasureUnit}. For units of measure:
     *
     * <pre>
    ...
    /**
     * Sets a unit to be used in the denominator. For example, to format "3 m/s", pass METER to the
     * unit and SECOND to the perUnit.
     *
     * <p>Pass this method any instance of {@link MeasureUnit}. For example:
     *
     * <pre>
     * NumberFormatter.with().unit(MeasureUnit.METER).perUnit(MeasureUnit.SECOND)
     * </pre>
     *
     * <p>The default is not to display any unit in the denominator.
     *
     * <p>If a per-unit is specified without a primary unit via {@link #unit}, the behavior is
     * undefined.
     *
     * @param perUnit The unit to render in the denominator.
     * @return The fluent chain
     * @see #unit
     * @stable ICU 61
     */
     ...
     * </ul>
     *
     * <p>Pass this method the return value of one of the factory methods on {@link Precision}. For
     * example:
     *
     * <pre>
     ...
     * </pre>
     *
     * <p>In most cases, the default rounding precision is to round to 6 fraction places; i.e.,
     * <code>Precision.maxFraction(6)</code>. The exceptions are if compact notation is being used,
     * then the compact notation rounding precision is used (see {@link Notation#compactShort} for
     * details), or if the unit is a currency, then standard currency rounding is used, which varies
     * from currency to currency (see {@link Precision#currency} for details).
     *
     * @param precision The rounding precision to use.
     * @return The fluent chain.
     * @see Precision
     * @stable ICU 62
     */
    ...
    /**
     * Specifies how to determine the direction to round a number when it has more digits than fit
     * in the desired precision. When formatting 1.235:
     *
     * <ul>
     ...
     *
     * <p>https://unicode-org.github.io/icu/userguide/format_parse/numbers/rounding-modes
     *
     ...
     * </ul>
     *
     * <p>The exact grouping widths will be chosen based on the locale.
     *
     * <p>Pass this method an element from the {@link GroupingStrategy} enum. For example:
     *
     * <pre>
     * NumberFormatter.with().grouping(GroupingStrategy.MIN2)
     * </pre>
     *
     * The default is to perform grouping according to locale data; most locales, but not all
     * locales, enable it by default.
     *
     ...
     * </ul>
     *
     * <p>Pass this method the return value of {@link IntegerWidth#zeroFillTo(int)}. For example:
     *
     * <pre>
     ...
     *
     * @param style The integer width to use.
     * @return The fluent chain.
     * @see IntegerWidth
     * @stable ICU 60
     */
     ...
     * </ul>
     *
     * <p>Pass this method an instance of {@link DecimalFormatSymbols}. For example:
     *
     * <pre>
     * NumberFormatter.with().symbols(DecimalFormatSymbols.getInstance(new ULocale("de_CH")))
     * </pre>
     *
     * <p><strong>Note:</strong> DecimalFormatSymbols automatically chooses the best numbering
     * system based on the locale. In the examples above, the first three are using the Latin
     * numbering system, and the fourth is using the Myanmar numbering system.
     *
     * <p><strong>Note:</strong> The instance of DecimalFormatSymbols will be copied: changes made
     * to the symbols object after passing it into the fluent chain will not be seen.
     *
     * <p><strong>Note:</strong> Calling this method will override the NumberingSystem previously
     * specified in {@link #symbols(NumberingSystem)}.
     *
     * <p>The default is to choose the symbols based on the locale specified in the fluent chain.
     *
     * @param symbols The DecimalFormatSymbols to use.
     * @return The fluent chain.
     ...
     * </ul>
     *
     * <p>Pass this method an instance of {@link NumberingSystem}. For example, to force the locale
     * to always use the Latin alphabet numbering system (ASCII digits):
     *
     * <pre>
     * NumberFormatter.with().symbols(NumberingSystem.LATIN)
     * </pre>
     *
     * <p><strong>Note:</strong> Calling this method will override the DecimalFormatSymbols
     * previously specified in {@link #symbols(DecimalFormatSymbols)}.
     *
     * <p>The default is to choose the best numbering system for the locale.
     *
     * @param ns The NumberingSystem to use.
     * @return The fluent chain.
     * @see NumberingSystem
     * @stable ICU 60
     */
     ...
     * </ul>
     *
     * <p>Pass an element from the {@link UnitWidth} enum to this setter. For example:
     *
     * <pre>
     * NumberFormatter.with().unitWidth(UnitWidth.FULL_NAME)
     * </pre>
     *
     * <p>The default is the SHORT width.
     *
     * @param style The width to use when rendering numbers.
     * @return The fluent chain
     * @see UnitWidth
     * @stable ICU 60
     */
     ...
     * </ul>
     *
     * <p>Pass an element from the {@link SignDisplay} enum to this setter. For example:
     *
     * <pre>
     * NumberFormatter.with().sign(SignDisplay.ALWAYS)
     * </pre>
     *
     * <p>The default is AUTO sign display.
     *
     * @param style The sign display strategy to use when rendering numbers.
     * @return The fluent chain
     * @see SignDisplay
     * @stable ICU 60
     */
    ...
    /**
     * Sets the decimal separator display strategy. This affects integer numbers with no fraction
     * part. Most common values:
     *
     * <ul>
     *   <li>Auto: "1"
     *   <li>Always: "1."
     * </ul>
     *
     * <p>Pass an element from the {@link DecimalSeparatorDisplay} enum to this setter. For example:
     *
     * <pre>
     * NumberFormatter.with().decimal(DecimalSeparatorDisplay.ALWAYS)
     * </pre>
     *
     * <p>The default is AUTO decimal separator display.
     *
     * @param style The decimal separator display strategy to use when rendering numbers.
     * @return The fluent chain
    ...
    /**
     * Sets a scale (multiplier) to be used to scale the number by an arbitrary amount before
     * formatting. Most common values:
     *
     * <ul>
     ...
     * </ul>
     *
     * <p>Pass an element from a {@link Scale} factory method to this setter. For example:
     *
     * <pre>
     * NumberFormatter.with().scale(Scale.powerOfTen(2))
     * </pre>
     *
     * <p>The default is to not apply any multiplier.
     *
     * @param scale An amount to be multiplied against numbers before formatting.
     * @return The fluent chain
     * @see Scale
     * @stable ICU 62
     */
     ...
     * etc.)
     *
     * <p>When a {@code usage} is specified, the output unit will change depending on the {@code
     * Locale} and the unit quantity. For example, formatting length measurements specified in
     * meters:
     *
     * <pre>
     ...
     * </ul>
     *
     * <p>The input unit specified via unit() determines the type of measurement being formatted
     * (e.g. "length" when the unit is "foot"). The usage requested will be looked for only within
     * this category of measurement units.
     *
     * <p>The output unit can be found via FormattedNumber.getOutputUnit().
     *
     * <p>If the usage has multiple parts (e.g. "land-agriculture-grain") and does not match a known
     * usage preference, the last part will be dropped repeatedly until a match is found (e.g.
     * trying "land-agriculture", then "land"). If a match is still not found, usage will fall back
     * to "default".
     *
     * <p>Setting usage to an empty string clears the usage (disables usage-based localized
     * formatting).
     *
     * <p>Setting a usage string but not a correct input unit will result in an
     * U_ILLEGAL_ARGUMENT_ERROR.
     *
     * <p>When using usage, specifying rounding or precision is unnecessary. Specifying a precision
     * in some manner will override the default formatting.
     *
     * @param usage A usage parameter from the units resource.
     * @return The fluent chain
     * @throws IllegalArgumentException in case of Setting a usage string but not a correct input
     *     unit.
     * @stable ICU 68
     */
    ...
    /**
     * Specifies the {@code DisplayOptions}. For example, {@code GrammaticalCase} specifies the
     * desired case for a unit formatter's output (e.g. accusative, dative, genitive).
     *
     * @return The fluent chain.
     * @stable ICU 72
     */
     ...
     *
     * <p>Not all options are capable of being represented in the skeleton string; for example, a
     * DecimalFormatSymbols object. If any such option is encountered, an {@link
     * UnsupportedOperationException} is thrown.
     *
     * <p>The returned skeleton is in normalized form, such that two number formatters with
     * equivalent behavior should produce the same skeleton.
     *
     * <p>For more information on number skeleton strings, see:
     * https://unicode-org.github.io/icu/userguide/format_parse/numbers/skeletons.html
     *
     * @return A number skeleton string with behavior corresponding to this number formatter.
     * @throws UnsupportedOperationException If the number formatter has an option that cannot be
     *     represented in a skeleton string.
     * @stable ICU 62
     */
