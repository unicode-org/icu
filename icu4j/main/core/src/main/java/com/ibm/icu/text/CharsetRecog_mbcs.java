...
/**
 * CharsetRecognizer implementation for Asian - double or multi-byte - charsets. Match is determined
 ...
 *
 * <p>Instances of this class are singletons, one per encoding being recognized. They are created in
...
abstract class CharsetRecog_mbcs extends CharsetRecognizer {
        ...
        detectBlock:
        {
            ...
            if (doubleByteCharCount <= 10 && badCharCount == 0) {
                ...
                if (doubleByteCharCount == 0 && totalCharCount < 10) {
                    ...
                    // non-ASCII single bytes.
                    // We don't have enough data to have any confidence.
                    // Statistical analysis of single byte non-ASCII characters would probably help
                    // here.
                    confidence = 0;
                } else {
     ...
     *
     * <p>This function is not a method of class iteratedChar only because that would require a lot
     * of extra derived classes, which is awkward.
     *
        ...
        boolean nextChar(iteratedChar it, CharsetDetector det) {
            ...
            buildChar:
            {
                ...
                if (firstByte == 0x8e) {
                    ...
                    //   In EUC-TW, total char size is 4 bytes, three bytes contribute to char
                    // value.
