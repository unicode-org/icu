...
/**
 * Trie implementation which stores data in int, 32 bits. 2015-sep-03: Used only in CharsetSelector
 * which could be switched to {@link Trie2_32} as long as that does not load ICU4C selector data.
 *
 * @author synwee
...
public class IntTrie extends Trie {
     ...
     *
     * <p>Unserialize the 32-bit-aligned input stream and use the data for the trie.
     *
    ...
    /**
     * Make a dummy IntTrie. A dummy trie is an empty runtime trie, used when a real data trie
     * cannot be loaded.
     *
     ...
     *
     * @param leadvalue the value of a lead surrogate that contains the folding offset
