 ...
 *
 * <p>These constants are used in functions like UCharacter.hasBinaryProperty(int) to select one of
 ...
 *
 * <p>For details about the properties see <a href="http://www.unicode.org/reports/tr44/">UAX #44:
 * Unicode Character Database</a>.
 *
 * <p>Important: If ICU is built with UCD files from Unicode versions below 3.2, then properties
 * marked with "new" are not or not fully available. Check UCharacter.getUnicodeVersion() to be
 * sure.
 *
 * @author Syn Wee Quek
 * @stable ICU 2.6
...
public interface UProperty {
     ...
     */
    @Deprecated public static final int UNDEFINED = -1;

    /**
     * Binary property Alphabetic.
     *
     * <p>Property for UCharacter.isUAlphabetic(), different from the property in
     * UCharacter.isalpha().
     *
     ...
     *
     * <p>Codepoints (2060..206F, FFF0..FFFB, E0000..E0FFF) + Other_Default_Ignorable_Code_Point +
     * (Cf + Cc + Cs - White_Space)
     *
     * @stable ICU 2.6
     */
     ...
     *
     * <p>Characters that linguistically modify the meaning of another character to which they
     * apply.
     *
     * @stable ICU 2.6
     */
     ...
     *
     * <p>Extend the value or shape of a preceding alphabetic character, e.g. length and iteration
     * marks.
     *
     * @stable ICU 2.6
     */
     ...
     *
     * <p>CompositionExclusions.txt + Singleton Decompositions + Non-Starter Decompositions.
     *
     * @stable ICU 2.6
     */
     ...
     *
     * <p>Dashes used to mark connections between pieces of words, plus the Katakana middle dot.
     *
     * @stable ICU 2.6
     */
     ...
     *
     * <p>Characters that do not use logical order and require special handling in most processing.
     *
     * @stable ICU 2.6
     */
     ...
     *
     * <p>Same as UCharacter.isULowercase(), different from UCharacter.islower().
     *
     ...
     *
     * <p>Code points that are explicitly defined as illegal for the encoding of characters.
     *
     * @stable ICU 2.6
     */
     ...
     *
     * <p>Punctuation characters that generally mark the end of textual units.
     *
     * @stable ICU 2.6
     */
     ...
     *
     * <p>Same as UCharacter.isUUppercase(), different from UCharacter.isUpperCase().
     *
     ...
     *
     * <p>Same as UCharacter.isUWhiteSpace(), different from UCharacter.isSpace() and
     * UCharacter.isWhitespace(). Space characters+TAB+CR+LF-ZWSP-ZWNBSP
     *
     * @stable ICU 2.6
     */
     ...
     *
     * <p>ID_Continue modified to allow closure under normalization forms NFKC and NFKD.
     *
     * @stable ICU 2.6
     */
     ...
     *
     * <p>ID_Start modified to allow closure under normalization forms NFKC and NFKD.
     *
     * @stable ICU 2.6
     */
     ...
     *
     * <p>Either the source of a case mapping or <i>in</i> the target of a case mapping. Not the
     * same as the general category Cased_Letter.
     *
     * @stable ICU 2.6
     */
    ...
    /**
     * Binary property STerm (new in Unicode 4.0.1). Sentence Terminal. Used in UAX #29: Text
    ...
    /**
     * Binary property Variation_Selector (new in Unicode 4.0.1). Indicates all those characters
     * that qualify as Variation Selectors. For details on the behavior of these characters, see
     * StandardizedVariants.html and 15.6 Variation Selectors.
     *
     * @stable ICU 3.0
     */
    ...
    /**
     * Binary property NFD_Inert. ICU-specific property for characters that are inert under NFD,
     * i.e., they do not interact with adjacent characters. Used for example in normalizing
     * transforms in incremental mode to find the boundary of safely normalizable text despite
     * possible text additions.
     *
     * <p>There is one such property per normalization form. These properties are computed as
     * follows - an inert character is: a) unassigned, or ALL of the following: b) of combining
     * class 0. c) not decomposed by this normalization form. AND if NFC or NFKC, d) can never
     * compose with a previous character. e) can never compose with a following character. f) can
     * never change if another character is added. Example: a-breve might satisfy all but f, but if
     * you add an ogonek it changes to a-ogonek + breve
     *
     * <p>See also com.ibm.text.UCD.NFSkippable in the ICU4J repository, and
    ...
    /**
     * Binary property NFKD_Inert. ICU-specific property for characters that are inert under NFKD,
     * i.e., they do not interact with adjacent characters. Used for example in normalizing
     * transforms in incremental mode to find the boundary of safely normalizable text despite
     * possible text additions.
     *
    ...
    /**
     * Binary property NFC_Inert. ICU-specific property for characters that are inert under NFC,
     * i.e., they do not interact with adjacent characters. Used for example in normalizing
     * transforms in incremental mode to find the boundary of safely normalizable text despite
     * possible text additions.
     *
    ...
    /**
     * Binary property NFKC_Inert. ICU-specific property for characters that are inert under NFKC,
     * i.e., they do not interact with adjacent characters. Used for example in normalizing
     * transforms in incremental mode to find the boundary of safely normalizable text despite
     * possible text additions.
     *
    ...
    /**
     * Binary Property Segment_Starter. ICU-specific property for characters that are starters in
     * terms of Unicode normalization and combining character sequences. They have ccc=0 and do not
     * occur in non-initial position of the canonical decomposition of any character (like " in
     * NFD(a-umlaut) and a Jamo T in an NFD(Hangul LVT)). ICU uses this property for segmenting a
     * string for generating a set of canonically equivalent strings, e.g. for canonical closure
     * while processing collation tailoring rules.
     *
     * @stable ICU 3.0
     */
    ...
    /**
     * Binary property Pattern_Syntax (new in Unicode 4.1). See UAX #31 Identifier and Pattern
    ...
    /**
     * Binary property Pattern_White_Space (new in Unicode 4.1). See UAX #31 Identifier and Pattern
     * Syntax (http://www.unicode.org/reports/tr31/)
     *
     * @stable ICU 3.4
     */
    ...
    /**
     * Binary property alnum (a C/POSIX character class). Implemented according to the UTS #18 Annex
     * C Standard Recommendation. See the UCharacter class documentation.
     *
     * @stable ICU 3.4
     */
    ...
    /**
     * Binary property blank (a C/POSIX character class). Implemented according to the UTS #18 Annex
     * C Standard Recommendation. See the UCharacter class documentation.
     *
     * @stable ICU 3.4
     */
    ...
    /**
     * Binary property graph (a C/POSIX character class). Implemented according to the UTS #18 Annex
     * C Standard Recommendation. See the UCharacter class documentation.
     *
     * @stable ICU 3.4
     */
    ...
    /**
     * Binary property print (a C/POSIX character class). Implemented according to the UTS #18 Annex
     * C Standard Recommendation. See the UCharacter class documentation.
     *
     * @stable ICU 3.4
     */
    ...
    /**
     * Binary property xdigit (a C/POSIX character class). Implemented according to the UTS #18
     * Annex C Standard Recommendation. See the UCharacter class documentation.
     *
     * @stable ICU 3.4
     */
    ...
    /**
     * Binary property Emoji_Modifier_Base. See
    ...
    /**
     * Binary property Extended_Pictographic. See
     * http://www.unicode.org/reports/tr51/#Emoji_Properties
     *
     * @stable ICU 62
     */
    ...
    /**
     * Binary property of strings Emoji_Keycap_Sequence. See
    ...
    /**
     * Binary property of strings RGI_Emoji_Flag_Sequence. See
     * https://www.unicode.org/reports/tr51/#Emoji_Sets
     *
     * @stable ICU 70
     */
    ...
    /**
     * Binary property of strings RGI_Emoji_Tag_Sequence. See
     * https://www.unicode.org/reports/tr51/#Emoji_Sets
     *
     * @stable ICU 70
     */
    ...
    /**
     * Binary property of strings RGI_Emoji_ZWJ_Sequence. See
     * https://www.unicode.org/reports/tr51/#Emoji_Sets
     *
     * @stable ICU 70
     */
    ...
    /**
     * Binary property IDS_Unary_Operator. For programmatic determination of Ideographic Description
     * Sequences.
     *
     * @stable ICU 74
     */
     ...
     */
    @Deprecated public static final int BINARY_LIMIT = 76;

    /**
     * Enumerated property Bidi_Class. Same as UCharacter.getDirection(int), returns
     * UCharacterDirection values.
     *
     * @stable ICU 2.4
     */
    ...
    /**
     * Enumerated property Block. Same as UCharacter.UnicodeBlock.of(int), returns
     * UCharacter.UnicodeBlock values.
     *
     * @stable ICU 2.4
     */
    ...
    /**
     * Enumerated property Canonical_Combining_Class. Same as UCharacter.getCombiningClass(int),
    ...
    /**
     * Enumerated property East_Asian_Width. See http://www.unicode.org/reports/tr11/ Returns
     * UCharacter.EastAsianWidth values.
     *
     * @stable ICU 2.4
     */
    ...
    /**
     * Enumerated property General_Category. Same as UCharacter.getType(int), returns
     * UCharacterCategory values.
     *
     * @stable ICU 2.4
     */
     ...
     * UCharacter.HangulSyllableType values.
     *
     * @stable ICU 2.6
     */
    ...
    /**
     * Enumerated property NFD_Quick_Check. Returns numeric values compatible with
    ...
    /**
     * Enumerated property NFKD_Quick_Check. Returns numeric values compatible with
     * Normalizer.QuickCheckResult.
     *
     * @stable ICU 3.0
     */
    ...
    /**
     * Enumerated property NFC_Quick_Check. Returns numeric values compatible with
     * Normalizer.QuickCheckResult.
     *
     * @stable ICU 3.0
     */
    ...
    /**
     * Enumerated property NFKC_Quick_Check. Returns numeric values compatible with
     * Normalizer.QuickCheckResult.
     *
     * @stable ICU 3.0
     */
    ...
    /**
     * Enumerated property Lead_Canonical_Combining_Class. ICU-specific property for the ccc of the
     * first code point of the decomposition, or lccc(c)=ccc(NFD(c)[0]). Useful for checking for
     * canonically ordered text; see Normalizer.FCD and http://www.unicode.org/notes/tn5/#FCD .
    ...
    /**
     * Enumerated property Trail_Canonical_Combining_Class. ICU-specific property for the ccc of the
     * last code point of the decomposition, or lccc(c)=ccc(NFD(c)[last]). Useful for checking for
     * canonically ordered text; see Normalizer.FCD and http://www.unicode.org/notes/tn5/#FCD .
     * Returns 8-bit numeric values like CANONICAL_COMBINING_CLASS.
     *
     * @stable ICU 3.0
    ...
    /**
     * Enumerated property Grapheme_Cluster_Break (new in Unicode 4.1). Used in UAX #29: Text
     * Boundaries (http://www.unicode.org/reports/tr29/) Returns UCharacter.GraphemeClusterBreak
     * values.
     *
     * @stable ICU 3.4
     */
    ...
    /**
     * Enumerated property Sentence_Break (new in Unicode 4.1). Used in UAX #29: Text Boundaries
     * (http://www.unicode.org/reports/tr29/) Returns UCharacter.SentenceBreak values.
     *
     * @stable ICU 3.4
     */
    ...
    /**
     * Enumerated property Word_Break (new in Unicode 4.1). Used in UAX #29: Text Boundaries
     * (http://www.unicode.org/reports/tr29/) Returns UCharacter.WordBreak values.
     *
     * @stable ICU 3.4
     */
    ...
    /**
     * Enumerated property Bidi_Paired_Bracket_Type (new in Unicode 6.3). Used in UAX #9: Unicode
     * Bidirectional Algorithm (http://www.unicode.org/reports/tr9/) Returns
     * UCharacter.BidiPairedBracketType values.
     *
     * @stable ICU 52
     */
    ...
    /**
     * Enumerated property Indic_Positional_Category. New in Unicode 6.0 as provisional property
     * Indic_Matra_Category; renamed and changed to informative in Unicode 8.0. See
    ...
    /**
     * Enumerated property Indic_Syllabic_Category. New in Unicode 6.0 as provisional; informative
     * since Unicode 8.0. See http://www.unicode.org/reports/tr44/#IndicSyllabicCategory.txt
     *
     * @stable ICU 63
     */
    ...
    /**
     * Enumerated property Vertical_Orientation. Used for UAX #50 Unicode Vertical Text Layout
     * (https://www.unicode.org/reports/tr50/). New as a UCD property in Unicode 10.0.
     *
     * @stable ICU 63
     */
    ...
    /**
     * Enumerated property Identifier_Status. Used for UTS #39 General Security Profile for
     * Identifiers (https://www.unicode.org/reports/tr39/#General_Security_Profile).
     *
     * @stable ICU 75
     */
    ...
    /**
     * Enumerated property Indic_Conjunct_Break. Used in the grapheme cluster break algorithm in UAX
     * #29.
     *
     * @stable ICU 76
     */
     ...
     * @deprecated ICU 58 The numeric value may change over time, see ICU ticket #12420.
     */
    @Deprecated public static final int INT_LIMIT = 0x101B;

    /**
     * Bitmask property General_Category_Mask. This is the General_Category property returned as a
     * bit mask. When used in UCharacter.getIntPropertyValue(c), returns bit masks for
     * UCharacterCategory values where exactly one bit is set. When used with
     * UCharacter.getPropertyValueName() and UCharacter.getPropertyValueEnum(), a multi-bit mask is
     * used for sets of categories like "Letters".
     *
     * @stable ICU 2.4
     */
     ...
     * @deprecated ICU 58 The numeric value may change over time, see ICU ticket #12420.
     */
    @Deprecated public static final int MASK_LIMIT = 0x2001;
     ...
     * @deprecated ICU 58 The numeric value may change over time, see ICU ticket #12420.
     */
    @Deprecated public static final int DOUBLE_LIMIT = 0x3001;
     ...
     * @deprecated ICU 49
     */
    @Deprecated public static final int ISO_COMMENT = 0x4003;
    ...
    /**
     * String property Unicode_1_Name. This property is of little practical value. Beginning with
     * ICU 49, ICU APIs return null or an empty string for this property. Corresponds to
     * UCharacter.getName1_0(int).
     *
     * @deprecated ICU 49
     */
    @Deprecated public static final int UNICODE_1_NAME = 0x400B;
    ...
    /**
     * String property Bidi_Paired_Bracket (new in Unicode 6.3). Corresponds to
     * UCharacter.getBidiPairedBracket.
     *
     * @stable ICU 52
     */
     ...
     * @deprecated ICU 58 The numeric value may change over time, see ICU ticket #12420.
     */
    @Deprecated public static final int STRING_LIMIT = 0x400E;

    /**
     * Miscellaneous property Script_Extensions (new in Unicode 6.0). Some characters are commonly
     * used in multiple scripts. For more information, see UAX #24:
     * http://www.unicode.org/reports/tr24/. Corresponds to UScript.hasScript and
    ...
    /**
     * Miscellaneous property Identifier_Type. Used for UTS #39 General Security Profile for
     * Identifiers (https://www.unicode.org/reports/tr39/#General_Security_Profile).
     *
     ...
     * @deprecated ICU 58 The numeric value may change over time, see ICU ticket #12420.
     */
    @Deprecated public static final int OTHER_PROPERTY_LIMIT = 0x7002;

    /**
     * Selector constants for UCharacter.getPropertyName() and UCharacter.getPropertyValueName().
     * These selectors are used to choose which name is returned for a given property or value. All
     * properties and values have a long name. Most have a short name, but some do not. Unicode
     * allows for additional names, beyond the long and short name, which would be indicated by LONG
     * + i, where i=1, 2,...
     *
    ...
    public interface NameChoice {
        /**
         * Selector for the abbreviated name of a property or value. Most properties and values have
         * a short name; those that do not return null.
         *
         * @stable ICU 2.4
         */
        ...
        /**
         * Selector for the long name of a property or value. All properties and values have a long
         * name.
         *
         * @stable ICU 2.4
         */
        ...
        /**
         * The number of predefined property name choices. Individual properties or values may have
         * more than COUNT aliases.
         *
         * @deprecated ICU 58 The numeric value may change over time, see ICU ticket #12420.
         */
        @Deprecated static final int COUNT = 2;
    }
}
