 ...
 *
 * <p>A class representing a collection of resource information pertaining to a given locale. A
 * resource bundle provides a way of accessing locale- specific information in a data file. You
 * create a resource bundle that manages the resources for a given locale and then ask it for
 * individual resources.
 *
 * <p>In ResourceBundle, an object is created and the sub-items are fetched using the getString and
 * getObject methods. In UResourceBundle, each individual element of a resource is a resource by
 * itself.
 *
 * <p>Resource bundles in ICU are currently defined using text files that conform to the following
 * <a href="https://github.com/unicode-org/icu-docs/blob/main/design/bnf_rb.txt">BNF definition</a>.
 * More on resource bundle concepts and syntax can be found in the <a
 * href="https://unicode-org.github.io/icu/userguide/locale/resources">Users Guide</a>.
 *
 * <p>The packaging of ICU *.res files can be of two types ICU4C:
 *
 * <pre>
 *       root.res
 *         |
 ...
 * </pre>
 *
 * Depending on the organization of your resources, the syntax to getBundleInstance will change. To
 * open ICU style organization use:
 *
 * <pre>
 ...
 * allow loading of resources across jar files. You must provide your class loader to load the
 * resources
 *
 * @stable ICU 3.0
 * @author ram
...
public abstract class UResourceBundle extends ResourceBundle {
    ...
    /**
     * {@icu} Creates a resource bundle using the specified base name and locale. ICU_DATA_CLASS is
     * used as the default root.
     *
     * @param baseName string containing the name of the data package. If null the default ICU
    ...
    public static UResourceBundle getBundleInstance(String baseName, String localeName) {
        return getBundleInstance(
                baseName, localeName, ICUResourceBundle.ICU_DATA_CLASS_LOADER, false);
    }
    ...
    public static UResourceBundle getBundleInstance(
            String baseName, String localeName, ClassLoader root) {
     ...
     * @param localeName the locale for which a resource bundle is desired
     * @param root the class object from which to load the resource bundle
     * @param disableFallback Option to disable locale inheritance. If true the fallback chain will
     *     not be built.
     * @throws MissingResourceException if no resource bundle for the specified base name can be
     *     found
     * @return a resource bundle for the given base name and locale
     * @stable ICU 3.0
     */
    protected static UResourceBundle getBundleInstance(
    ...
    /**
     * {@icu} Sole constructor. (For invocation by subclass constructors, typically implicit.) This
     * is public for compatibility with Java, whose compiler will generate public default
     * constructors for an abstract class.
     *
     * @stable ICU 3.0
     */
     ...
     *
     * @param locale specifies the locale for which we want to open the resource. If null the bundle
     *     for default locale is opened.
    ...
    /**
     * {@icu} Creates a UResourceBundle for the default locale and specified base name, from which
     * users can extract resources by using their corresponding keys.
     *
     * @param baseName string containing the name of the data package. If null the default ICU
     *     package name is used.
    ...
    /**
     * {@icu} Creates a UResourceBundle for the specified locale and specified base name, from which
     * users can extract resources by using their corresponding keys.
     *
     * @param baseName string containing the name of the data package. If null the default ICU
     *     package name is used.
    ...
    /**
     * {@icu} Creates a UResourceBundle, from which users can extract resources by using their
     * corresponding keys.
     *
     * @param baseName string containing the name of the data package. If null the default ICU
     *     package name is used.
     ...
     * <br>
     * Note: Please use this API for loading non-ICU resources. Java security does not allow loading
     * of resources across jar files. You must provide your class loader to load the resources
     *
     * @param baseName string containing the name of the data package. If null the default ICU
     *     package name is used.
     * @param locale specifies the locale for which we want to open the resource. If null the bundle
     ...
     */
    public static UResourceBundle getBundleInstance(
            String baseName, ULocale locale, ClassLoader loader) {
        if (baseName == null) {
            baseName = ICUData.ICU_BASE_NAME;
        }
        if (locale == null) {
    ...
    /**
     * {@icu} Returns the RFC 3066 conformant locale id of this resource bundle. This method can be
     * used after a call to getBundleInstance() to determine whether the resource bundle returned
     ...
     * @stable ICU 3.0
     */
    protected static UResourceBundle instantiateBundle(
            String baseName, String localeName, ClassLoader root, boolean disableFallback) {
        ...
        switch (rootType) {
            case ICU:
                return ICUResourceBundle.getBundleInstance(
                        baseName, localeName, root, disableFallback);

            case JAVA:
                return ResourceBundleWrapper.getBundleInstance(
                        baseName, localeName, root, disableFallback);
            ...
            default:
                ...
                try {
                    ...
                    b =
                            ResourceBundleWrapper.getBundleInstance(
                                    baseName, localeName, root, disableFallback);
    ...
    /**
     * {@icu} Returns a binary data from a binary resource, as a byte array with a copy of the bytes
    ...
    /**
     * {@icu} Returns a unsigned integer from a resource. This integer is originally 28 bit and the
     * sign gets propagated.
     *
     * @return an integer value
     * @see #getIntVector
     * @see #getBinary()
    ...
    public UResourceBundle get(String aKey) {
        ...
        if (obj == null) {
            ...
            throw new MissingResourceException(
                    "Can't find resource for bundle " + fullName + ", key " + aKey,
    ...
    /**
     * Returns a resource in a given resource that has a given key, or null if the resource is not
     * found.
     *
    ...
    /**
     * Returns a resource in a given resource that has a given index, or null if the resource is not
     * found.
     *
     ...
     *
     * @return an enumeration containing key strings, which is empty if this is not a bundle or a
     *     table resource
     * @stable ICU 3.8
     */
    @Override
     ...
     *
     * @return a Set of all keys contained in this ResourceBundle and its parent bundles, which is
     *     empty if this is not a bundle or a table resource
     * @internal
     * @deprecated This API is ICU internal only.
     */
    @Override
    ...
    /**
     * Returns a Set of the keys contained <i>only</i> in this ResourceBundle. This does not include
     * further keys from parent bundles.
     *
     * @return a Set of the keys contained only in this ResourceBundle, which is empty if this is
     *     not a bundle or a table resource
     * @internal
     * @deprecated This API is ICU internal only.
     */
    @Override
     ...
     * vector/table types is the number of child resources. <br>
     * <b>Note:</b> Integer array is treated as a scalar type. There are no APIs to access
     * individual members of an integer array. It is always returned as a whole.
     *
    ...
    /**
     * {@icu} Returns the type of a resource. Available types are {@link #INT INT}, {@link #ARRAY
     * ARRAY}, {@link #BINARY BINARY}, {@link #INT_VECTOR INT_VECTOR}, {@link #STRING STRING},
     * {@link #TABLE TABLE}.
     *
    ...
    /**
     * {@icu} Return the version number associated with this UResourceBundle as an VersionInfo
     * object.
     *
    ...
    /**
     * {@icu} Returns the key associated with a given resource. Not all the resources have a key -
     * only those that are members of a table.
     *
    ...
    /**
     * {@icu} Resource type constant for a single 28-bit integer, interpreted as signed or unsigned
     * by the getInt() function.
     *
     * @see #getInt
     * @stable ICU 3.8
     */
    ...
    /**
     * {@icu} Actual worker method for fetching a resource based on the given key. Sub classes must
     * override this method if they support resources with keys.
     *
     ...
     * @param requested the original resource bundle object on which the get method was invoked. The
     *     requested bundle and the bundle on which this method is invoked are the same, except in
     *     the cases where aliases are involved.
     * @return UResourceBundle a resource associated with the key
     * @stable ICU 3.8
     */
    protected UResourceBundle handleGet(
            String aKey, HashMap<String, String> aliasesVisited, UResourceBundle requested) {
        return null;
    }

    /**
     * {@icu} Actual worker method for fetching a resource based on the given index. Sub classes
     * must override this method if they support arrays of resources.
     *
    ...
    /**
     * {@icu} Actual worker method for fetching the array of strings in a resource. Sub classes must
     * override this method if they support arrays of strings.
     *
    ...
    /**
     * {@icu} Actual worker method for fetching the keys of resources contained in the resource. Sub
     * classes must override this method if they support keys and associated resources.
     *
