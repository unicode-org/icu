...
public class RuleBasedBreakIterator extends BreakIterator {
    ...
    class BreakCache {
         ...
         * on the preceding boundary and include both the the preceding and following boundaries in
         * the cache. Additional boundaries, either preceding or following, may be added to the
