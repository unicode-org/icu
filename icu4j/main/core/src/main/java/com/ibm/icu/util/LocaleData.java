...
public final class LocaleData {
    ...
    /**
     * EXType for {@link #getExemplarSet(int, int)}. Corresponds to the 'main' (aka 'standard') CLDR
     * exemplars in <a
     * href="http://www.unicode.org/reports/tr35/tr35-general.html#Character_Elements">
    ...
    /**
     * EXType for {@link #getExemplarSet(int, int)}. Corresponds to the 'auxiliary' CLDR exemplars
     * in <a href="http://www.unicode.org/reports/tr35/tr35-general.html#Character_Elements">
     * http://www.unicode.org/reports/tr35/tr35-general.html#Character_Elements</a>.
     *
     * @stable ICU 3.4
     */
    ...
    /**
     * EXType for {@link #getExemplarSet(int, int)}. Corresponds to the 'index' CLDR exemplars in <a
     * href="http://www.unicode.org/reports/tr35/tr35-general.html#Character_Elements">
     * http://www.unicode.org/reports/tr35/tr35-general.html#Character_Elements</a>.
     *
     * @stable ICU 4.4
    ...
    /**
     * EXType for {@link #getExemplarSet(int, int)}. Corresponds to the 'currencySymbol' CLDR
     * exemplars in <a
     * href="http://www.unicode.org/reports/tr35/tr35-general.html#Character_Elements">
     * http://www.unicode.org/reports/tr35/tr35-general.html#Character_Elements</a>. Note: This type
     * is no longer supported.
     *
     * @deprecated ICU 51
     */
    @Deprecated public static final int ES_CURRENCY = 3;

    /**
     * Corresponds to the 'punctuation' CLDR exemplars in <a
     * href="http://www.unicode.org/reports/tr35/tr35-general.html#Character_Elements">
     * http://www.unicode.org/reports/tr35/tr35-general.html#Character_Elements</a>. EXType for
     * {@link #getExemplarSet(int, int)}.
     *
     * @stable ICU 49
     */
     ...
     */
    @Deprecated public static final int ES_COUNT = 5;
     ...
     * #getExemplarSet(ULocale, int, int)} with the extype == {@link #ES_STANDARD}.
     *
     * @param locale Locale for which the exemplar character set is to be retrieved.
     * @param options Bitmask for options to apply to the exemplar pattern. Specify zero to retrieve
     *     the exemplar set as it is defined in the locale data. Specify UnicodeSet.CASE to retrieve
     *     a case-folded exemplar set. See {@link UnicodeSet#applyPattern(String, int)} for a
     *     complete list of valid options. The IGNORE_SPACE bit is always set, regardless of the
     *     value of 'options'.
    ...
    /**
     * Returns the set of exemplar characters for a locale. Equivalent to calling new
     * LocaleData(locale).{@link #getExemplarSet(int, int)}.
     *
     * @param locale Locale for which the exemplar character set is to be retrieved.
     * @param options Bitmask for options to apply to the exemplar pattern. Specify zero to retrieve
     *     the exemplar set as it is defined in the locale data. Specify UnicodeSet.CASE to retrieve
     ...
     *     complete list of valid options. The IGNORE_SPACE bit is always set, regardless of the
     *     value of 'options'.
     * @param extype The type of exemplar set to be retrieved, ES_STANDARD, ES_INDEX, ES_AUXILIARY,
     *     or ES_PUNCTUATION
     * @return The set of exemplar characters for the given locale. If there is nothing available
     *     for the locale, then null is returned if {@link #getNoSubstitute()} is true, otherwise
     *     the root value is returned (which may be UnicodeSet.EMPTY).
    ...
    public static final LocaleData getInstance(ULocale locale) {
        ...
        try {
            ld.langBundle =
                    (ICUResourceBundle)
                            UResourceBundle.getBundleInstance(ICUData.ICU_LANG_BASE_NAME, locale);
     ...
     *
     * @param setting Value for the no substitute behavior. If true, methods of this locale data
     *     object will return an error when no data is available for that method, given the locale
     ...
     *
     * @return Value for the no substitute behavior. If true, methods of this locale data object
     *     will return an error when no data is available for that method, given the locale ID
     ...
     *
     * @param type The type of delimiter string desired. Currently, the valid choices are
     *     QUOTATION_START, QUOTATION_END, ALT_QUOTATION_START, or ALT_QUOTATION_END.
    ...
    public String getDelimiter(int type) {
        ...
        // Only some of the quotation marks may be here. So we make sure that we do a multilevel
        // fallback.
    ...
    private static UResourceBundle measurementTypeBundleForLocale(
            ULocale locale, String measurementType) {
    ...
    public String getLocaleDisplayPattern() {
        ...
        ICUResourceBundle locDispBundle =
                (ICUResourceBundle) langBundle.get(LOCALE_DISPLAY_PATTERN);
    ...
    public static VersionInfo getCLDRVersion() {
        ...
        if (gCLDRVersion == null) {
            // from ZoneMeta.java
            UResourceBundle supplementalDataBundle =
                    UResourceBundle.getBundleInstance(
                            ICUData.ICU_BASE_NAME,
                            "supplementalData",
                            ICUResourceBundle.ICU_DATA_CLASS_LOADER);
