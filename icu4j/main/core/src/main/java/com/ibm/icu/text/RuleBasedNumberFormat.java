 ...
 *
 * <p>This number formatter is typically used for spelling out numeric values in words (e.g.,
 * 25,3476 as &quot;twenty-five thousand three hundred seventy-six&quot; or &quot;vingt-cinq mille
 * trois cents soixante-seize&quot; or
 * &quot;f&uuml;nfundzwanzigtausenddreihundertsechsundsiebzig&quot;), but can also be used for other
 * complicated formatting tasks, such as formatting a number of seconds as hours, minutes and
 * seconds (e.g., 3,730 as &quot;1:02:10&quot;).
 *
 ...
 * suffix to the end of a numeral (123 is &quot;123rd&quot;); and duration, which shows a duration
 * in seconds as hours, minutes, and seconds (123 is &quot;2:03&quot;).&nbsp; The client can also
 * define more specialized <code>RuleBasedNumberFormat</code>s by supplying programmer-defined rule
 * sets.
 *
 ...
 * 1000: &lt;&lt; thousand[ &gt;&gt;];</pre>
 *
 * <p>Again, the meanings of the brackets and substitution tokens shift because the rule's base
 * value is a higher power of 10, changing the rule's divisor. This rule can actually be used all
 * the way up to 999,999. This allows us to finish out the rules as follows:
 *
 * <pre>
 * 1,000,000: &lt;&lt; million[ &gt;&gt;];
 ...
 * 25,430 with this rule set would work like this:
 *
 ...
 * rule set name must begin with a % sign. Rule sets with names that begin with a single % sign are
 * <em>public:</em> the caller can specify that they be used to format and parse numbers. Rule sets
 * with names that begin with %% are <em>private:</em> they exist only for the use of other rule
 * sets. If a formatter only has one rule set, the name may be omitted.
 *
 ...
 *       </code>), use the default rule.&nbsp; (If the number being formatted was passed in as a
 *       <code>long</code>, the default rule is ignored.)
