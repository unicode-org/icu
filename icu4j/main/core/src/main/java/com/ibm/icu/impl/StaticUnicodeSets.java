 ...
 * Microbenchmarks show this to bring a very sizeable performance boost.
 *
 * <p>IMPORTANT ASSUMPTION FOR NUMBER PARSING: All of the sets contain code points (no strings) and
 * they are all case-folded. If this assumption were ever broken, logic in classes such as
 * SymbolMatcher would need to be updated in order to return well-formed sets upon calls to
 * getLeadCodePoints().
 *
 * @author sffc
 */
public class StaticUnicodeSets {
    public static enum Key {
        ...
        // - STRICT_ALL_SEPARATORS is the union of STRICT_COMMA, STRICT_PERIOD, and
        // OTHER_GRP_SEPARATORS
        COMMA,
        PERIOD,
        STRICT_COMMA,
        STRICT_PERIOD,
     ...
     * @return The requested UnicodeSet. Guaranteed to be frozen and non-null, but may be empty if
     ...
     *
     * <p>Exported as U_COMMON_API for numparse_decimal.cpp
     *
     * @param str The string to check.
    ...
    /**
     * Looks through all Currency-related sets for the given string, returning the first match or
     * null if no match was round.
     */
    ...
    static {
        ...
        ICUResourceBundle rb =
                (ICUResourceBundle)
                        UResourceBundle.getBundleInstance(ICUData.ICU_BASE_NAME, ULocale.ROOT);
