...
/**
 * An abstract base class for specifying settings related to number formatting. This class is
 * implemented by {@link UnlocalizedNumberRangeFormatter} and {@link LocalizedNumberRangeFormatter}.
...
public abstract class NumberRangeFormatterSettings<T extends NumberRangeFormatterSettings<?>> {
    ...
    /**
     * Sets the NumberFormatter instance to use for the numbers in the range. The same formatter is
     * applied to both sides of the range.
     *
     * <p>The NumberFormatter instances must not have a locale applied yet; the locale specified on
     * the NumberRangeFormatter will be used.
     *
     * @param formatter The formatter to use for both numbers in the range.
     ...
     *
     * <p>The NumberFormatter instance must not have a locale applied yet; the locale specified on
     * the NumberRangeFormatter will be used.
     *
     * @param formatterFirst The formatter to use for the first number in the range.
     * @return The fluent chain.
     * @stable ICU 63
     * @see NumberFormatter
     * @see NumberRangeFormatter
     ...
     * the NumberRangeFormatter will be used.
     *
     * @param formatterSecond The formatter to use for the second number in the range.
     * @return The fluent chain.
     * @stable ICU 63
     * @see NumberFormatter
     * @see NumberRangeFormatter
     ...
     *   <li>ALL: "3-5K miles"
     *   <li>UNIT: "3K - 5K miles"
     *   <li>NONE: "3K miles - 5K miles"
     *   <li>AUTO: usually UNIT or NONE, depending on the locale and formatter settings
     * </ul>
     *
     * <p>The default value is AUTO.
     *
     * @param collapse The collapsing strategy to use for this range.
     * @return The fluent chain.
     * @stable ICU 63
     * @see NumberRangeFormatter
     */
    ...
    /**
     * Sets the behavior when the two sides of the range are the same. This could happen if the same
     * two numbers are passed to the formatRange function, or if different numbers are passed to the
     * function but they become the same after rounding rules are applied. Possible values:
     *
     * <ul>
     *   <li>SINGLE_VALUE: "5 miles"
     *   <li>APPROXIMATELY_OR_SINGLE_VALUE: "~5 miles" or "5 miles", depending on whether the number
     *       was the same before rounding was applied
     *   <li>APPROXIMATELY: "~5 miles"
     *   <li>RANGE: "5-5 miles" (with collapse=UNIT)
     * </ul>
     *
     * <p>The default value is APPROXIMATELY.
     *
     * @param identityFallback The strategy to use when formatting two numbers that end up being the
     *     same.
     * @return The fluent chain.
     * @stable ICU 63
     * @see NumberRangeFormatter
