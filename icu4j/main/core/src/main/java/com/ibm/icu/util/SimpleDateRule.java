 ...
 *
 * <p>Simple implementation of DateRule.
 *
...
public class SimpleDateRule implements DateRule {
    ...
    /**
     * Return the first occurrance of the event represented by this rule that is on or after the
     * given start date.
     *
     * @param start Only occurrances on or after this date are returned.
     * @return The date on which this event occurs, or null if it does not occur on or after the
     *     start date.
     * @see #firstBetween
     * @draft ICU 2.8
     */
    ...
    /**
     * Checks whether this event occurs on the given date. This does <em>not</em> take time of day
     * into account; instead it checks whether this event and the given date are on the same day.
     * This is useful for applications such as determining whether a given day is a holiday.
     *
