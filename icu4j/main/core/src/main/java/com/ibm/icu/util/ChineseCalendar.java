...
public class ChineseCalendar extends Calendar {
    ...
    public ChineseCalendar(Locale aLocale) {
        this(
                TimeZone.forLocaleOrDefault(aLocale),
                ULocale.forLocale(aLocale),
                CHINESE_EPOCH_YEAR,
                CHINA_ZONE);
    }
    ...
    protected ChineseCalendar(
            TimeZone zone, ULocale locale, int epochYear, TimeZone zoneAstroCalc) {
        super(zone, locale);
    ...
    /**
     * The start year of the Chinese calendar, the 61st year of the reign of Huang Di. Some sources
     * use the first year of his reign, resulting in EXTENDED_YEAR values 60 years greater and ERA
     * (cycle) values one greater.
     */
