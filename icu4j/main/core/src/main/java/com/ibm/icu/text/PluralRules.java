 ...
 *
 * <p>Rules are constructed from a text description, consisting of a series of keywords and
 * conditions. The {@link #select} method examines each condition in order and returns the keyword
 * for the first condition that matches the number. If none match, {@link #KEYWORD_OTHER} is
 * returned.
 *
 * <p>A PluralRules object is immutable. It contains caches for sample values, but those are
 * synchronized.
 *
 * <p>PluralRules is Serializable so that it can be used in formatters, which are serializable.
 *
 * <p>For more information, details, and tips for writing rules, see the <a
 ...
 * </pre>
 *
 * <p>This defines two rules, for 'one' and 'few'. The condition for 'one' is "n is 1" which means
 * that the number must be equal to 1 for this condition to pass. The condition for 'few' is "n in
 * 2..4" which means that the number must be between 2 and 4 inclusive - and be an integer - for
 * this condition to pass. All other numbers are assigned the keyword "other" by the default rule.
 *
 * <pre>
 * &quot;zero: n is 0; one: n is 1; zero: n mod 100 in 1..19&quot;
 * </pre>
 *
 * <p>This illustrates that the same keyword can be defined multiple times. Each rule is examined in
 * order, and the first keyword whose condition passes is the one returned. Also notes that a
 * modulus is applied to n in the last rule. Thus its condition holds for 119, 219, 319...
 *
 * <pre>
 * &quot;one: n is 1; few: n mod 10 in 2..4 and n mod 100 not in 12..14&quot;
 * </pre>
 *
 * <p>This illustrates conjunction and negation. The condition for 'few' has two parts, both of
 * which must be met: "n mod 10 in 2..4" and "n mod 100 not in 12..14". The first part applies a
 * modulus to n before the test as in the previous example. The second part applies a different
 * modulus and also uses negation, thus it matches all numbers <i>not</i> in 12, 13, 14, 112, 113,
 * 114, 212, 213, 214...
 *
 * <p>Syntax:
 *
 ...
 * </pre>
 *
 * <p>Each <b>not</b> term inverts the meaning; however, there should not be more than one of them.
 *
 * <p>The i, f, t, and v values are defined as follows:
 *
 * <ul>
 *   <li>i to be the integer digits.
 *   <li>f to be the visible decimal digits, as an integer.
 *   <li>t to be the visible decimal digits—without trailing zeros—as an integer.
 *   <li>v to be the number of visible fraction digits.
 *   <li>j is defined to only match integers. That is j is 3 fails if v != 0 (eg for 3.1 or 3.0).
 * </ul>
 *
 * <p>Examples are in the following table:
 *
 ...
 * </table>
 *
 * <p>An "identifier" is a sequence of characters that do not have the Unicode Pattern_Syntax or
 * Pattern_White_Space properties.
 *
 * <p>The difference between 'in' and 'within' is that 'in' only includes integers in the specified
 * range, while 'within' includes all values. Using 'within' with a range_list consisting entirely
 * of values is the same as using 'in' (it's not an error).
 *
 * @stable ICU 3.8
 */
public class PluralRules implements Serializable {
    ...
    public abstract static class Factory {
        ...
        /**
         * Provides access to the predefined <code>PluralRules</code> for a given locale and the
         * plural type.
         *
         ...
         *
         * @param locale The locale for which a <code>PluralRules</code> object is returned.
         * @param type The plural type (e.g., cardinal or ordinal).
         * @return The predefined <code>PluralRules</code> object for this locale. If there's no
         *     predefined rules for this locale, the rules for the closest parent in the locale
         *     hierarchy that has one will be returned. The final fallback always returns the
         *     default rules.
         * @internal CLDR
         * @deprecated This API is ICU internal only.
         */
        ...
        /**
         * Returns the 'functionally equivalent' locale with respect to plural rules. Calling
         * PluralRules.forLocale with the functionally equivalent locale, and with the provided
         * locale, returns rules that behave the same. <br>
         * All locales with the same functionally equivalent locale have plural rules that behave
         * the same. This is not exhaustive; there may be other locales whose plural rules behave
         * the same that do not have the same equivalent locale.
         *
         * @param locale the locale to check
         * @param isAvailable if not null and of length &gt; 0, this will hold 'true' at index 0 if
         *     locale is directly defined (without fallback) as having plural rules
    ...
    /**
     * Common name for the default plural form. This name is returned for values to which no other
     * form in the rule applies. It can additionally be assigned rules of its own.
     *
     * @stable ICU 3.8
     */
    ...
    /**
     * Value returned by {@link #getUniqueKeywordDecimalQuantityValue} when there is no unique value
     * to return.
     *
     * @internal CLDR
     * @deprecated This API is ICU internal only.
     ...
     * @throws ParseException if the description cannot be parsed. The exception index is typically
     *     not set, it will be -1.
     * @stable ICU 3.8
     */
    ...
    public static final PluralRules DEFAULT =
            new PluralRules(new RuleList().addRule(DEFAULT_RULE), StandardPluralRanges.DEFAULT);
    ...
    public static enum Operand {
        ...
        /**
         * Suppressed exponent for scientific notation (exponent needed in scientific notation to
         * approximate i).
         *
         * @internal
         * @deprecated This API is ICU internal only.
        ...
        /**
         * This operand is currently treated as an alias for {@code PLURAL_OPERAND_E}. In the
         * future, it will represent:
         *
         * <p>Suppressed exponent for compact notation (exponent needed in compact notation to
         * approximate i).
         *
         * @internal
         * @deprecated This API is ICU internal only.
         ...
         *
         * <p>Returns the integer value, but will fail if the number has fraction digits. That is,
         * using "j" instead of "i" is like implicitly adding "v is 0".
         *
         * <p>For example, "j is 3" is equivalent to "i is 3 and v is 0": it matches "3" but not
         * "3.1" or "3.0".
         *
         * @internal CLDR
         * @deprecated This API is ICU internal only.
    ...
    public static interface IFixedDecimal {
        /**
         * Returns the value corresponding to the specified operand (n, i, f, t, v, or w). If the
         * operand is 'n', returns a double; otherwise, returns an integer.
         *
         * @internal CLDR
         * @deprecated This API is ICU internal only.
         */
     ...
     */
    @Deprecated
    public static class FixedDecimal extends Number
            implements Comparable<FixedDecimal>, IFixedDecimal {
         ...
         * @param f Corresponds to f in the plural rules grammar. The digits to the right of the
         *     decimal place as an integer. e.g 1.10 = 10
        ...
        /**
         * Return a guess as to the number of decimals that would be displayed. This is only a
         * guess; callers should always supply the decimals explicitly if possible. Currently, it is
         * up to 6 decimals (without trailing zeros). Returns 0 for infinities and nans.
         *
         * @internal CLDR
         * @deprecated This API is ICU internal only.
         */
        ...
        public double getPluralOperand(Operand operand) {
            switch (operand) {
                case n:
                    return (exponent == 0 ? source : source * Math.pow(10, exponent));
                case i:
                    return intValue();
                case f:
                    return decimalDigits;
        ...
        public String toString() {
            String baseString =
                    String.format(Locale.ROOT, "%." + visibleDecimalDigitCount + "f", source);
            if (exponent != 0) {
    ...
    /**
     * A range of DecimalQuantity representing PluralRules samples that includes all values with the
     * same visibleFractionDigitCount.
     *
     * @internal CLDR
     * @deprecated This API is ICU internal only.
     */
    ...
    public static class DecimalQuantitySamplesRange {
        ...
        public DecimalQuantitySamplesRange(DecimalQuantity start, DecimalQuantity end) {
            if (start.getPluralOperand(Operand.v) != end.getPluralOperand(Operand.v)) {
                throw new IllegalArgumentException(
                        "Ranges must have the same number of visible decimals: "
                                + start
                                + "~"
                                + end);
            }
    ...
    /**
     * A list of DecimalQuantity representing PluralRules that includes all values with the same
    ...
    public static class DecimalQuantitySamples {
         ...
         * @deprecated This API is ICU internal only.
         */
        @Deprecated public final SampleType sampleType;

        /**
         * @internal CLDR
         * @deprecated This API is ICU internal only.
         */
        @Deprecated public final Set<DecimalQuantitySamplesRange> samples;
         ...
         * @param samples
         */
        private DecimalQuantitySamples(
                SampleType sampleType, Set<DecimalQuantitySamplesRange> samples, boolean bounded) {
            super();
        ...
        static DecimalQuantitySamples parse(String source) {
            ...
            if (source.startsWith("integer")) {
                ...
                throw new IllegalArgumentException(
                        "Samples must start with 'integer' or 'decimal'");
            }
            ...
            for (String range : COMMA_SEPARATED.split(source, 0)) {
                ...
                if (haveBound) {
                    throw new IllegalArgumentException(
                            "Can only have … at the end of samples: " + range);
                }
            ...
            return new DecimalQuantitySamples(
                    sampleType2, Collections.unmodifiableSet(samples2), bounded2);
        }

        private static void checkDecimal(SampleType sampleType2, DecimalQuantity sample) {
            // TODO(CLDR-15452): Remove the need for the fallback check for exponent notation
            // integers classified
            ...
            if ((sampleType2 == SampleType.INTEGER && sample.getPluralOperand(Operand.v) != 0)
                    || (sampleType2 == SampleType.DECIMAL
                            && sample.getPluralOperand(Operand.v) == 0
         ...
         */
        @Deprecated
        public Collection<DecimalQuantity> addDecimalQuantitySamples(
                Collection<DecimalQuantity> result) {
        ...
        public void addSamples(
                Collection<Double> doubleResult, Collection<DecimalQuantity> dqResult) {
            ...
            for (DecimalQuantitySamplesRange range : samples) {
                ...
                for (DecimalQuantity dq = start.createCopy(); dq.toDouble() <= end.toDouble(); ) {
                    if (isDouble) {
                        ...
                        //    This API is returning doubles, which can't distinguish having
                        // displayed
                        //    zeros to the right of the decimal.
                        //    This results in test failures with values mapping back to a different
                        // keyword.
                        if (!(dblValue == Math.floor(dblValue))
                                && dq.getPluralOperand(Operand.v) > 0) {
        ...
        public String toString() {
            StringBuilder b =
                    new StringBuilder("@")
                            .append(sampleType.toString().toLowerCase(Locale.ENGLISH));
            boolean first = true;
    ...
    static class SimpleTokenizer {
        static final UnicodeSet BREAK_AND_IGNORE =
                new UnicodeSet(0x09, 0x0a, 0x0c, 0x0d, 0x20, 0x20).freeze();
        ...
        for (int i = 0; i < or_together.length; ++i) {
            ...
            for (int j = 0; j < and_together.length; ++j) {
                ...
                if (x < tokens.length) {
                    ...
                    newConstraint =
                            new RangeConstraint(
                                    mod, inRange, operand, integersOnly, lowBound, highBound, vals);
                }
    ...
    private static Rule parseRule(String description) throws ParseException {
        ...
        switch (constraintOrSamples.length) {
            ...
            case 3:
                ...
                if (integerSamples.sampleType != SampleType.INTEGER
                        || decimalSamples.sampleType != SampleType.DECIMAL) {
                    throw new IllegalArgumentException(
                            "Must have @integer then @decimal in " + description);
                }
                break;
            default:
        ...
        if (isOther != (constraintOrSamples[0].length() == 0)) {
            throw new IllegalArgumentException(
                    "The keyword 'other' must have no constraints, just samples.");
        }
    ...
    private static RuleList parseRuleChain(String description) throws ParseException {
        ...
        for (int i = 0; i < rules.length; ++i) {
            ...
            result.hasExplicitBoundingInfo |=
                    rule.integerSamples != null || rule.decimalSamples != null;
            result.addRule(rule);
        }
    ...
    private static class Rule implements Serializable {
        ...
        public Rule and(Constraint c) {
            return new Rule(
                    keyword, new AndConstraint(constraint, c), integerSamples, decimalSamples);
        }

        @SuppressWarnings("unused")
        public Rule or(Constraint c) {
            return new Rule(
                    keyword, new OrConstraint(constraint, c), integerSamples, decimalSamples);
        }
    ...
    private static class RuleList implements Serializable {
        ...
        public DecimalQuantitySamples getDecimalSamples(String keyword, SampleType sampleType) {
            for (Rule rule : rules) {
                if (rule.getKeyword().equals(keyword)) {
                    return sampleType == SampleType.INTEGER
                            ? rule.integerSamples
                            : rule.decimalSamples;
                }
            }
    ...
    @SuppressWarnings("unused")
    private boolean addConditional(
            Set<IFixedDecimal> toAddTo, Set<IFixedDecimal> others, double trial) {
        boolean added;
     ...
     * locale. Same as forLocale(locale, PluralType.CARDINAL).
     *
     * <p>ICU defines plural rules for many locales based on CLDR <i>Language Plural Rules</i>. For
     * these predefined rules, see CLDR page at
     * https://unicode-org.github.io/cldr-staging/charts/latest/supplemental/language_plural_rules.html
     *
     * @param locale The locale for which a <code>PluralRules</code> object is returned.
     * @return The predefined <code>PluralRules</code> object for this locale. If there's no
     *     predefined rules for this locale, the rules for the closest parent in the locale
     *     hierarchy that has one will be returned. The final fallback always returns the default
     *     rules.
     * @stable ICU 3.8
     */
    ...
    /**
     * Provides access to the predefined cardinal-number <code>PluralRules</code> for a given {@link
     * java.util.Locale}. Same as forLocale(locale, PluralType.CARDINAL).
     *
     * <p>ICU defines plural rules for many locales based on CLDR <i>Language Plural Rules</i>. For
     * these predefined rules, see CLDR page at
     * https://unicode-org.github.io/cldr-staging/charts/latest/supplemental/language_plural_rules.html
    ...
    /**
     * Provides access to the predefined <code>PluralRules</code> for a given locale and the plural
     * type.
     *
     * <p>ICU defines plural rules for many locales based on CLDR <i>Language Plural Rules</i>. For
     * these predefined rules, see CLDR page at
    ...
    /**
     * Provides access to the predefined <code>PluralRules</code> for a given {@link
    ...
    /**
     * Given a floating-point number, returns the keyword of the first rule that applies to the
     * number.
     *
    ...
    /**
     * Given a formatted number range, returns the overall plural form of the range. For example,
     * "3-5" returns "other" in English.
     *
     * <p>To get a FormattedNumberRange, see {@link com.ibm.icu.number.NumberRangeFormatter}.
     *
     * <p>This method only works if PluralRules was created with a locale. If it was created from
     * PluralRules.createRules(), or if it was deserialized, this method throws
    ...
    public String select(FormattedNumberRange range) {
        if (standardPluralRanges == null) {
            throw new UnsupportedOperationException(
                    "Plural ranges are unavailable on this instance");
        }
        StandardPlural form1 = StandardPlural.fromString(select(range.getFirstFixedDecimal()));
        StandardPlural form2 = StandardPlural.fromString(select(range.getSecondFixedDecimal()));
    ...
    /**
     * Returns a set of all rule keywords used in this <code>PluralRules</code> object. The rule
     * "other" is always present by default.
     *
    ...
    /**
     * Returns the unique value that this keyword matches, or {@link #NO_UNIQUE_VALUE} if the
     * keyword matches multiple values or is not defined for this PluralRules.
     *
    ...
    /**
     * Returns all the values that trigger this keyword, or null if the number of such values is
     * unlimited.
     *
     * @param keyword the keyword
     * @return the values that trigger this keyword, or null. The returned collection is immutable.
     *     It will be empty if the keyword is not defined.
     * @stable ICU 4.8
     */
    ...
    /**
     * Returns a list of integer values for which select() would return that keyword, or null if the
     * keyword is not defined. The returned collection is unmodifiable. The returned list is not
     * complete, and there might be additional values that would return the keyword.
     *
    ...
    /**
     * Returns a list of values for which select() would return that keyword, or null if the keyword
     * is not defined. The returned collection is unmodifiable. The returned list is not complete,
     * and there might be additional values that would return the keyword. The keyword might be
     * defined, and yet have an empty set of samples, IF there are samples for the other sampleType.
     *
     * @param keyword the keyword to test
     ...
     */
    @Deprecated
    public Collection<DecimalQuantity> getDecimalQuantitySamples(
        ...
        switch (sampleType) {
            case INTEGER:
                for (int i = 0; i < 200; ++i) {
                    if (!addSample(
                            keyword, new DecimalQuantity_DualStorageBCD(i), maxCount, result)) {
                        break;
                    }
                }
                addSample(
                        ...
                        maxCount,
                        result); // hack for Welsh
                break;
            case DECIMAL:
                for (int i = 0; i < 2000; ++i) {
                    DecimalQuantity_DualStorageBCD nextSample =
                            new DecimalQuantity_DualStorageBCD(i);
                ...
                addSample(
                        keyword,
                        DecimalQuantity_DualStorageBCD.fromExponentString("1000000.0"),
                        maxCount,
                        result); // hack for Welsh
                break;
        }
    ...
    private boolean addSample(
            String keyword, DecimalQuantity sample, int maxCount, Set<DecimalQuantity> result) {
    ...
    /**
     * Returns a list of values for which select() would return that keyword, or null if the keyword
     * is not defined or no samples are available. The returned collection is unmodifiable. The
     * returned list is not complete, and there might be additional values that would return the
     * keyword.
     *
     * @param keyword the keyword to test
     * @param sampleType the type of samples requested, INTEGER or DECIMAL
    ...
    /**
     * Returns the 'functionally equivalent' locale with respect to plural rules. Calling
     * PluralRules.forLocale with the functionally equivalent locale, and with the provided locale,
     * returns rules that behave the same. <br>
     * All locales with the same functionally equivalent locale have plural rules that behave the
     * same. This is not exhaustive; there may be other locales whose plural rules behave the same
    ...
    public enum KeywordStatus {
        ...
        INVALID,
        /**
         * The keyword is valid, but unused (it is covered by the explicit values, OR has no values
         * for the given {@link SampleType}).
         *
         * @draft ICU 50
         */
        SUPPRESSED,
        /**
         * The keyword is valid, used, and has a single possible value (before considering explicit
         * values).
         *
         * @draft ICU 50
         */
     ...
     * @param explicits a set of {@code DecimalQuantity}s that are used explicitly (eg [=0],
     *     "[=1]"). May be empty or null.
    ...
    public KeywordStatus getKeywordStatus(
        ...
        for (DecimalQuantity explicit : explicits) {
            ...
            DecimalQuantity_DualStorageBCD valToRemove =
                    new DecimalQuantity_DualStorageBCD(valToRemoveBd);
