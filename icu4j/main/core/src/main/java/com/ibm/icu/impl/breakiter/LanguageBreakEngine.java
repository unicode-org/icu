...
/**
 * The LanguageBreakEngine interface is to be used to implement any language-specific logic for
 * break iteration.
 */
public interface LanguageBreakEngine {
     ...
     *
     * @param text The text to break over. The iterator is left at the end of the run of characters
     *     which the engine has handled.
     * @param startPos The index of the beginning of the range
     * @param endPos The index of the possible end of our range. It is possible, however, that the
     *     range ends earlier
