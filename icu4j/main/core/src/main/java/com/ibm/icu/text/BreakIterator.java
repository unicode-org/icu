...
public abstract class BreakIterator implements Cloneable {
     ...
     * determined the the boundary at the current iteration position.
     *
     ...
     * @return The number of rule status values from rules that determined the the boundary at the
