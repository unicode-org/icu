 ...
 *
 * <p>We use it to create and cache various formatters with various options.
 *
...
public interface FormatterFactory {
     ...
     * @param fixedOptions the options to use for formatting. The keys and values are function
     *     dependent.
