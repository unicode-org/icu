...
public class CalendarCache {
    ...
    /**
     * Produce a uniformly-distributed hash value from an integer key. This is essentially a linear
     * congruential random number generator that uses the key as its seed value.
     */
    ...
    private static final int primes[] = { // 5, 17, 31, 47, // for testing
        61, 127, 509, 1021, 2039, 4093, 8191, 16381, 32749, 65521, 131071, 262139,
    };
