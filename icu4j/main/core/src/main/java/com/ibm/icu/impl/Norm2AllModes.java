...
public final class Norm2AllModes {
    ...
    public abstract static class Normalizer2WithImpl extends Normalizer2 {
        ...
        protected abstract void normalize(
                CharSequence src, Normalizer2Impl.ReorderingBuffer buffer);
        ...
        public StringBuilder normalizeSecondAndAppend(
            ...
            normalizeAndAppend(
                    second,
                    doNormalize,
                    new Normalizer2Impl.ReorderingBuffer(
                            impl, first, first.length() + second.length()));
            return first;
        }
    ...
    public static final class ComposeNormalizer2 extends Normalizer2WithImpl {
        ...
        public Normalizer.QuickCheckResult quickCheck(CharSequence s) {
            int spanLengthAndMaybe =
                    impl.composeQuickCheck(s, 0, s.length(), onlyContiguous, false);
    ...
    public static Normalizer2WithImpl getN2WithImpl(int index) {
        switch (index) {
            case 0:
                return getNFCInstance().decomp; // NFD
            case 1:
                return getNFKCInstance().decomp; // NFKD
            case 2:
                return getNFCInstance().comp; // NFC
            case 3:
                return getNFKCInstance().comp; // NFKC
            default:
                return null;
        }
    }
