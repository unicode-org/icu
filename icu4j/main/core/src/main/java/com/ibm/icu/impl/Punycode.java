...
public final class Punycode {
    ...
    /**
     * @return the numeric value of a basic code point (for use in representing integers) in the
     *     range 0 to BASE-1, or a negative value if cp is invalid.
     */
            ...
            if (i <= firstSupplementaryIndex) {
                ...
                codeUnitIndex =
                        dest.offsetByCodePoints(
                                firstSupplementaryIndex, i - firstSupplementaryIndex);
            }
