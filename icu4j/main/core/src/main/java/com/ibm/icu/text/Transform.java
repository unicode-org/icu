...
/**
 * Provide an interface for Transforms that focuses just on the transformation of the text. APIs
 * that take Transliterator or StringTransform, but only depend on the transformation should use
 * this interface in the API instead.
 *
 * @author markdavis
 * @stable ICU 4.4
 */
