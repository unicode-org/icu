...
public class TestData {
    ...
    public static final ErrorCase[] errorCases = {
        new ErrorCase(
                new char[] {
                    0x0077, 0x0077, 0x0077, 0x002e, /* www. */ 0xC138, 0xACC4, 0xC758, 0xBAA8,
                    0xB4E0, 0xC0AC, 0xB78C, 0xB4E4, 0xC774, 0x070F, /*prohibited*/ 0xD55C, 0xAD6D,
                    0xC5B4, 0xB97C, 0xC774, 0xD574, 0xD55C, 0xB2E4, 0xBA74, 0x002e, 0x0063, 0x006f,
                    0x006d, /* com. */
                },
        ...
        new ErrorCase(
                new char[] {
                    0x0077, 0x0077, 0x0077, 0x002e, /* www. */ 0xC138, 0xACC4, 0xC758, 0xBAA8,
                    0xB4E0, 0xC0AC, 0xB78C, 0xB4E4, 0xC774, 0x0644, 0x064A,
                    0x0647, /*Arabic code points. Cannot mix RTL with LTR*/ 0xD55C, 0xAD6D, 0xC5B4,
                    0xB97C, 0xC774, 0xD574, 0xD55C, 0xB2E4, 0xBA74, 0x002e, 0x0063, 0x006f,
                    0x006d, /* com. */
                },
        ...
        new ErrorCase(
                new char[] {
                    0x0077, 0x0077, 0x0077, 0x002e, /* www. */ 0xC138, 0xACC4, 0xC758, 0xBAA8,
                    0xB4E0, 0xC0AC, 0xB78C, 0xB4E4, 0xC774, 0xD55C, 0xAD6D, 0xC5B4, 0xB97C, 0xC774,
        ...
        new ErrorCase(
                new char[] {
                    0x0077, 0x0077, 0x0077, 0x002e, /* www. */ 0x0030, 0x0644, 0x064A, 0x0647,
                    0x0031, /* Arabic code points squashed between EN codepoints */ 0x002e, 0x0063,
                    0x006f, 0x006d, /* com. */
                },
                "www.xn--01-tvdmo.com",
                new StringPrepParseException("", StringPrepParseException.CHECK_BIDI_ERROR),
        ...
        new ErrorCase(
                new char[] {
                    ...
                    0x206C, 0x0644, 0x064A, 0x0647,
                    0x206D, // Arabic code points squashed between BN codepoints
                    0x002e, 0x0063, 0x006f, 0x006d, // com.
                },
        ...
        new ErrorCase(
                ...
                new StringPrepParseException("", StringPrepParseException.STD3_ASCII_RULES_ERROR),
                true,
                false /* ToUnicode preserves casing for this case */,
                false),
        new ErrorCase(
                new char[] {
                    0x0077, 0x0077, 0x0077, 0x002e, // www.
                    0x0041, 0x0042, 0x0043, 0x0044, 0x0045,
                    0x002D, // HYPHEN at the end of the label
                    0x002e, 0x0063, 0x006f, 0x006d, // com.
                },
                "www.abcde-.com",
                new StringPrepParseException("", StringPrepParseException.STD3_ASCII_RULES_ERROR),
    ...
    public static final class ConformanceTestCase {
        ...
        ConformanceTestCase(
                String comt, String in, String out, String prof, int flg, Exception ex) {
