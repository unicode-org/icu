...
public class DisplayOptionsTest extends CoreTestFmwk {
    ...
    public void TestDisplayOptionsEachElement() {
        DisplayOptions displayOptions =
                DisplayOptions.builder().setGrammaticalCase(GrammaticalCase.ABLATIVE).build();
        assertEquals(
                "Test setting parameters: ",
        ...
        assertEquals(
                "Test setting parameters: ", NounClass.PERSONAL, displayOptions.getNounClass());
        ...
        displayOptions =
                DisplayOptions.builder()
                        .setCapitalization(Capitalization.BEGINNING_OF_SENTENCE)
                        .build();
        assertEquals(
                "Test setting parameters: ",
                Capitalization.BEGINNING_OF_SENTENCE,
                displayOptions.getCapitalization());

        displayOptions = DisplayOptions.builder().setNameStyle(NameStyle.STANDARD_NAMES).build();
        assertEquals(
                "Test setting parameters: ",
                NameStyle.STANDARD_NAMES,
                displayOptions.getNameStyle());

        displayOptions =
                DisplayOptions.builder().setDisplayLength(DisplayLength.LENGTH_FULL).build();
        assertEquals(
                "Test setting parameters: ",
        ...
        displayOptions =
                DisplayOptions.builder()
                        .setSubstituteHandling(SubstituteHandling.NO_SUBSTITUTE)
                        .build();
        assertEquals(
                "Test setting parameters: ",
                SubstituteHandling.NO_SUBSTITUTE,
                displayOptions.getSubstituteHandling());
    }
    ...
    public void TestDisplayOptionsUpdating() {
        ...
        assertEquals(
                ...
                displayOptions.getGrammaticalCase());
        assertEquals(
                "Test updating parameters: ", NounClass.UNDEFINED, displayOptions.getNounClass());
        assertEquals(
                "Test updating parameters: ",
                PluralCategory.UNDEFINED,
                displayOptions.getPluralCategory());
        assertEquals(
                ...
                displayOptions.getCapitalization());
        assertEquals(
                "Test updating parameters: ", NameStyle.UNDEFINED, displayOptions.getNameStyle());
        assertEquals(
                "Test updating parameters: ",
                DisplayLength.UNDEFINED,
                displayOptions.getDisplayLength());
        ...
        assertEquals(
                ...
                displayOptions.getGrammaticalCase());
        assertEquals(
                "Test updating parameters: ", NounClass.PERSONAL, displayOptions.getNounClass());
        assertEquals(
                "Test updating parameters: ",
                PluralCategory.UNDEFINED,
                displayOptions.getPluralCategory());
        ...
        displayOptions =
                displayOptions.copyToBuilder().setPluralCategory(PluralCategory.FEW).build();
        assertEquals(
                "Test updating parameters: ",
                GrammaticalCase.ABLATIVE,
                displayOptions.getGrammaticalCase());
        ...
        displayOptions =
                displayOptions.copyToBuilder().setNameStyle(NameStyle.STANDARD_NAMES).build();
        assertEquals(
                "Test updating parameters: ",
                GrammaticalCase.ABLATIVE,
                displayOptions.getGrammaticalCase());
        ...
        displayOptions =
                displayOptions.copyToBuilder().setDisplayLength(DisplayLength.LENGTH_FULL).build();
        assertEquals(
                "Test updating parameters: ",
                GrammaticalCase.ABLATIVE,
                displayOptions.getGrammaticalCase());
    ...
    public void TestDisplayOptionsGetIdentifier() {
        assertEquals(
                "test get identifier: ", "undefined", GrammaticalCase.UNDEFINED.getIdentifier());
        assertEquals("test get identifier: ", "ablative", GrammaticalCase.ABLATIVE.getIdentifier());
        assertEquals(
                "test get identifier: ", "accusative", GrammaticalCase.ACCUSATIVE.getIdentifier());
        assertEquals(
                "test get identifier: ", "comitative", GrammaticalCase.COMITATIVE.getIdentifier());
        ...
        assertEquals(
                "test get identifier: ", "nominative", GrammaticalCase.NOMINATIVE.getIdentifier());
        ...
        assertEquals(
                "test get identifier: ", "sociative", GrammaticalCase.SOCIATIVE.getIdentifier());
        assertEquals("test get identifier: ", "vocative", GrammaticalCase.VOCATIVE.getIdentifier());

        assertEquals(
                "test get identifier: ", "undefined", PluralCategory.UNDEFINED.getIdentifier());
    ...
    public void TestDisplayOptionsFromIdentifier() {
        ...
        assertEquals(
                "test from identifier: ",
                GrammaticalCase.LOCATIVE_COPULATIVE,
        ...
        assertEquals(
                "test from identifier: ", PluralCategory.ONE, PluralCategory.fromIdentifier("one"));
        assertEquals(
                "test from identifier: ", PluralCategory.TWO, PluralCategory.fromIdentifier("two"));
        assertEquals(
                "test from identifier: ", PluralCategory.FEW, PluralCategory.fromIdentifier("few"));
        assertEquals(
                "test from identifier: ",
                PluralCategory.MANY,
        ...
        assertEquals(
                "test from identifier: ", NounClass.NEUTER, NounClass.fromIdentifier("neuter"));
        assertEquals(
                "test from identifier: ", NounClass.FEMININE, NounClass.fromIdentifier("feminine"));
        assertEquals(
                "test from identifier: ",
                NounClass.MASCULINE,
                NounClass.fromIdentifier("masculine"));
        assertEquals(
                "test from identifier: ", NounClass.ANIMATE, NounClass.fromIdentifier("animate"));
        assertEquals(
                "test from identifier: ",
                NounClass.INANIMATE,
                NounClass.fromIdentifier("inanimate"));
        assertEquals(
                "test from identifier: ", NounClass.PERSONAL, NounClass.fromIdentifier("personal"));
        assertEquals(
                "test from identifier: ", NounClass.COMMON, NounClass.fromIdentifier("common"));
    }
}
