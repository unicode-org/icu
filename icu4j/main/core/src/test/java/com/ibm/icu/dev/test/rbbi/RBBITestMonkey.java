...
/**
 * Monkey tests for RBBI. These tests have independent implementations of the Unicode TR boundary
    ...
    static class RBBILineMonkey extends RBBIMonkeyKind {
        RBBILineMonkey() {
            ...
            partition.add(
                    new NamedSet(
                            "BA_Hyphen",
                            new UnicodeSet("[\\p{Line_Break=Break_After}&[\\u2010]]")));
            partition.add(
                    new NamedSet(
                            "BAmEastAsianmHyphen",
                            new UnicodeSet(
            ...
            partition.add(
                    new NamedSet(
                            ...
                            new UnicodeSet(
                                    "[\\p{Line_Break=Ideographic}&[\\p{Extended_Pictographic}&\\p{gc=Cn}]]")));
            partition.add(
                    new NamedSet(
                            "IDmEastAsianmExtPictUnassigned",
                            new UnicodeSet(
                                    "[\\p{Line_Break=Ideographic}-[\\p{ea=F}\\p{ea=W}\\p{ea=H}]-[\\p{Extended_Pictographic}&\\p{gc=Cn}]]")));
            partition.add(
                    new NamedSet(
                            "IN_EastAsian",
                            new UnicodeSet(
            ...
            partition.add(
                    new NamedSet(
                            ...
                            new UnicodeSet(
                                    "[\\p{Line_Break=Unknown}&[\\p{Extended_Pictographic}&\\p{gc=Cn}]]")));
            partition.add(
                    new NamedSet(
            ...
            rules.add(
                    new RegexRule(
                            "[^ $SP $BA $HY] × $GL",
                            "[^ \\p{Line_Break=Space} \\p{Line_Break=Break_After} \\p{Line_Break=Hyphen}]",
                            Resolution.NO_BREAK,
                            "\\p{Line_Break=Glue}"));
            rules.add(
            ...
            rules.add(
                    new RegexRule(
                            "( $BK | $CR | $LF | $NL | $SP | $ZW | $CB | $GL | $sot ) ( $HY | $Hyphen ) × $AL",
                            "( \\p{Line_Break=Mandatory_Break} | \\p{Line_Break=Carriage_Return} | \\p{Line_Break=Line_Feed} | \\p{Line_Break=Next_Line} | \\p{Line_Break=Space} | \\p{Line_Break=ZWSpace} | \\p{Line_Break=Contingent_Break} | \\p{Line_Break=Glue} | ^ ) ( \\p{Line_Break=Hyphen} | [\\u2010] )",
                            Resolution.NO_BREAK,
                            "[\\p{Line_Break=Ambiguous} \\p{Line_Break=Alphabetic} \\p{Line_Break=Surrogate} \\p{Line_Break=Unknown} [\\p{Line_Break=Complex_Context}-\\p{gc=Mn}-\\p{gc=Mc}]]"));
            rules.add(
            ...
            rules.add(
                    new RegexRule(
                            "$HL ($HY | $NonEastAsianBA) × [^$HL]",
                            "\\p{Line_Break=HL} (\\p{Line_Break=Hyphen} | [\\p{Line_Break=Break_After} & [^[\\p{ea=F}\\p{ea=W}\\p{ea=H}]]])",
                            Resolution.NO_BREAK,
                            "[^\\p{Line_Break=HL}]"));
            rules.add(
                    new RegexRule(
