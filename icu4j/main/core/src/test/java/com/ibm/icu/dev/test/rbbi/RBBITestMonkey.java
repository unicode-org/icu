...
public class RBBITestMonkey extends CoreTestFmwk {
    ...
    static class RBBICharMonkey extends RBBIMonkeyKind {
        RBBICharMonkey() {
            ...
            partition.add(
                    new NamedSet(
                            "Extend_ConjunctExtender",
                            new UnicodeSet(
                                    "[\\p{Grapheme_Cluster_Break=Extend}&[\\p{Indic_Conjunct_Break=Extend}]]")));
            partition.add(
                    new NamedSet(
                            "ExtendmConjunctLinkermConjunctExtender",
                            new UnicodeSet(
                                    "[\\p{Grapheme_Cluster_Break=Extend}-\\p{Indic_Conjunct_Break=Linker}-[\\p{Indic_Conjunct_Break=Extend}]]")));
            ...
            partition.add(
                    new NamedSet(
                            "ConjunctLinkermExtend",
                            new UnicodeSet(
                                    "[\\p{Indic_Conjunct_Break=Linker}-\\p{Grapheme_Cluster_Break=Extend}]")));
            partition.add(
                    new NamedSet(
                            "LinkingConsonant",
                            new UnicodeSet("[\\p{Indic_Conjunct_Break=Consonant}]")));
            partition.add(
                    new NamedSet("ExtPict", new UnicodeSet("[\\p{Extended_Pictographic=True}]")));
            partition.add(
                    new NamedSet(
                            "XXmConjunctLinkermLinkingConsonantmExtPict",
                            new UnicodeSet(
                                    "[\\p{Grapheme_Cluster_Break=Other}-\\p{Indic_Conjunct_Break=Linker}-\\p{Indic_Conjunct_Break=Consonant}-\\p{Extended_Pictographic=True}]")));

            rules.add(new RegexRule("$sot ÷", "^", Resolution.BREAK, ""));
            rules.add(new RegexRule("÷ $eot", "", Resolution.BREAK, "(?!.)"));
            rules.add(
                    new RegexRule(
                            "$CR × $LF",
            ...
            rules.add(
                    new RegexRule(
                            "$ConjunctLinker $ConjunctExtender* × $LinkingConsonant",
            ...
            rules.add(
                    new RegexRule(
                            ...
                            "\\p{Extended_Pictographic=True} \\p{Grapheme_Cluster_Break=Extend}* \\p{Grapheme_Cluster_Break=ZWJ}",
                            Resolution.NO_BREAK,
            ...
            rules.add(
                    new RegexRule(
                            ...
                            Resolution.NO_BREAK,
                            "\\p{Grapheme_Cluster_Break=Regional_Indicator}"));
            rules.add(new RegexRule("$Any ÷ $Any", ".", Resolution.BREAK, "."));
        ...
        RBBIWordMonkey() {
            ...
            partition.add(
                    new NamedSet(
                            "ALetter_ExtPict",
                            new UnicodeSet(
                                    "[\\p{Word_Break=ALetter}&\\p{Extended_Pictographic=True}]")));
            partition.add(
                    new NamedSet(
                            "ALettermExtPict",
                            new UnicodeSet(
            ...
            partition.add(
                    new NamedSet(
                            "ExtPictmALetter",
                            new UnicodeSet(
                                    "[\\p{Extended_Pictographic=True}-\\p{Word_Break=ALetter}]")));
            partition.add(new NamedSet("WSegSpace", new UnicodeSet("[\\p{Word_Break=WSegSpace}]")));
            partition.add(
                    new NamedSet(
                            "XXmExtPict",
                            new UnicodeSet(
                                    "[\\p{Word_Break=Other}-\\p{Extended_Pictographic=True}]")));
    ...
    static class RBBILineMonkey extends RBBIMonkeyKind {
        RBBILineMonkey() {
            ...
            rules.add(new RegexRule("$sot ×", "^", Resolution.NO_BREAK, ""));
            rules.add(new RegexRule("÷ $eot", "", Resolution.BREAK, "(?!.)"));
            rules.add(
                    new RegexRule(
            ...
            rules.add(
                    new RegexRule(
                            "[^ $SP $HY $HH] × $GL",
                            "[^ \\p{Line_Break=Space} \\p{Line_Break=Hyphen} \\p{Line_Break=Unambiguous_Hyphen}]",
                            Resolution.NO_BREAK,
                            "\\p{Line_Break=Glue}"));
            rules.add(
            ...
            rules.add(
                    new RegexRule(
                            ...
                            Resolution.NO_BREAK,
                            "\\p{Line_Break=E_Modifier}"));
            rules.add(new RegexRule("$ALL ÷", ".", Resolution.BREAK, ""));
            rules.add(new RegexRule("÷ $ALL", "", Resolution.BREAK, "."));
            // --- End of generated code. ---
        ...
        RBBISentenceMonkey() {
            ...
            rules.add(
                    new RegexRule(
                            ...
                            Resolution.BREAK,
                            ""));
            rules.add(new RegexRule("$Any × $Any", ".", Resolution.NO_BREAK, "."));
            // --- End of generated code. ---
