...
public class IBMCalendarTest extends CalendarTestFmwk {
     ...
     *
     * <p>NOTE: This test will have to be updated when the isWeekend() etc. API is finalized later.
     *
     * <p>In particular, the test will have to be rewritten to instantiate a Calendar in the given
     * locale (using getInstance()) and call that Calendar's isWeekend() etc. methods.
     */
    @Test
    ...
    /**
     * Run a test of a quasi-Gregorian calendar. This is a calendar that behaves like a Gregorian
     * but has different year/era mappings. The int[] data array should have the format:
     *
     * <p>{ era, year, gregorianYear, month, dayOfMonth, ... }
     */
     ...
     * https://unicode.org/reports/tr35/tr35-dates.html#first-day-overrides And data in <firstDay>
     * of https://github.com/unicode-org/cldr/blob/main/common/supplemental/supplementalData.xml
     *
     * <p>Examples of region for First Day of a week Friday: MV Saturday: AE AF Sunday: US JP
     * Monday: GB
     */
    @Test
    public void TestFirstDayOfWeek() {
        ...
        if (!logKnownIssue(
                "ICU-22924",
                "wbl-Arab returns wrong first day of the week, probably caused by wrong Likely Subtag algo")) {
    ...
    /**
     * Verify that BuddhistCalendar shifts years to Buddhist Era but otherwise behaves like
     * GregorianCalendar.
     */
    @Test
    ...
    public void TestBuddhistCoverage() {
...

        {
            ...
            BuddhistCalendar cal =
                    new BuddhistCalendar(TimeZone.getDefault(), ULocale.getDefault());
            if (cal == null) {
    ...
    /**
     * Verify that TaiwanCalendar shifts years to Minguo Era but otherwise behaves like
     * GregorianCalendar.
     */
    @Test
    ...
    /**
     * Verify that JapaneseCalendar shifts years to Japanese Eras but otherwise behaves like
     * GregorianCalendar.
     */
    @Test
    ...
    /**
     * Test behavior of fieldDifference around leap years. Also test a large field difference to
     * check binary search.
     */
    @Test
    ...
    /**
     * setFirstDayOfWeek and setMinimalDaysInFirstWeek may change the field <=> time mapping, since
     * they affect the interpretation of the WEEK_OF_MONTH or WEEK_OF_YEAR fields.
     */
    @Test
    public void TestWeekShift() {
        Calendar cal =
                new GregorianCalendar(
                        TimeZone.getTimeZone("America/Los_Angeles"), new Locale("en", "US"));
     ...
     * we use to keep the hour constant across DST changes can backfire and change the day.
     */
    @Test
    ...
    public void TestJB1684() {
        ...
        TestData[] tests = {
            ...
            new TestData(
                    ...
                    "2001 08 02 Tue"),
            new TestData(
                    2001, 8, 5, 2001, 7, 6, Calendar.SUNDAY, "2001 07 06 Sun", "2001 08 02 Sun"),
            new TestData(
                    2001, 7, 30, 2001, 8, 1, Calendar.MONDAY, "2001 08 01 Mon", "2001 07 05 Mon"),
            new TestData(
                    2001, 7, 31, 2001, 8, 1, Calendar.TUESDAY, "2001 08 01 Tue", "2001 07 05 Tue"),
            new TestData(
                    2001,
                    7,
                    29, /*8,  5,*/
        ...
        for (int i = 0; i < tests.length; ++i) {
            ...
            if (!ms2.equals(ms)) {
                log(
                        "\nError: GregorianCalendar.DOM gave "
                                + ms
                                + "\n       GregorianCalendar.WOM gave "
                                + ms2);
                error++;
            } else {
                pass++;
            ...
            if (!ms2.equals(ms)) {
                log(
                        "\nError: GregorianCalendar gave      "
                                + ms
                                + "\n       SimpleDateFormat.parse gave "
                                + ms2);
                error++;
            } else {
                pass++;
    ...
    public void TestZoneMeta() {
        ...
        String COUNTRY[][] = {{""}, {"US", "America/Los_Angeles", "PST"}};
    ...
    public void TestCoverage() {
        ...
        if (count == 0) errln("getAvailableULocales return empty list");
        ...
        class StubCalendar extends Calendar {
            ...
            public void run() {
                ...
                if (!df.equals(handleGetDateFormat("", ULocale.getDefault()))) {
                    errln(
                            "Calendar.handleGetDateFormat(String, Locale) should delegate to ( ,ULocale)");
                }
                ...
                DateFormat df1 =
                        handleGetDateFormat("GG yyyy-d:MM", "option=xyz", Locale.getDefault());
                if (!df1.equals(
                        handleGetDateFormat("GG yyyy-d:MM", "option=xyz", ULocale.getDefault()))) {
                    errln(
                            "Calendar.handleGetDateFormat(String, Locale) should delegate to ( ,ULocale)");
                }
                ...
                int leastMsInDay =
                        handleGetLimit(Calendar.MILLISECONDS_IN_DAY, Calendar.LEAST_MAXIMUM);
    ...
    public void TestJB4541() {
        ...
        for (int i = 0; i < calTypes.length; ++i) {
            ...
            logln(
                    "df2 type: "
                            + df2.getClass().getName()
                            + " loc: "
                            + df2.getLocale(ULocale.VALID_LOCALE));
        ...
        for (ULocale locale : TEST_LOCALES) {
            ...
            for (int[] data : TEST_DATA) {
                ...
                if (weekNum != data[1] || weekYear != data[2]) {
                    errln(
                            "Error: Incorrect week of year on January 1st, "
                                    + data[0]
                                    + " for locale "
                                    + locale
                                    + ": Returned [weekNum="
    ...
    private static class CalFields {
        ...
        public String toString() {
            return String.format(
                    "%04d-%02d-%02d %02d:%02d:%02d.%03d", year, month, day, hour, min, sec, ms);
        }
    ...
    public void TestAmbiguousWallTimeAPIs() {
        ...
        assertEquals(
                "Default repeated wall time option",
                cal.getRepeatedWallTimeOption(),
                Calendar.WALLTIME_LAST);
        assertEquals(
                "Default skipped wall time option",
                cal.getSkippedWallTimeOption(),
                Calendar.WALLTIME_LAST);
        ...
        assertEquals(
                "getRepeatedWallTimeOption after mod",
                cal2.getRepeatedWallTimeOption(),
                Calendar.WALLTIME_FIRST);
        assertEquals(
                "getSkippedWallTimeOption after mod",
                cal2.getSkippedWallTimeOption(),
                Calendar.WALLTIME_FIRST);
    ...
    public void TestRepeatedWallTime() {
        final Object[][] TESTDATA = {
            // Time zone            Input wall time                     WALLTIME_LAST in GMT
            //        WALLTIME_FIRST in GMT
            {
                "America/New_York",
                new CalFields(2011, 11, 6, 0, 59, 59),
                new CalFields(2011, 11, 6, 4, 59, 59),
                new CalFields(2011, 11, 6, 4, 59, 59)
            },
            {
                "America/New_York",
                new CalFields(2011, 11, 6, 1, 0, 0),
                new CalFields(2011, 11, 6, 6, 0, 0),
                new CalFields(2011, 11, 6, 5, 0, 0)
            },
            {
                "America/New_York",
                new CalFields(2011, 11, 6, 1, 0, 1),
                new CalFields(2011, 11, 6, 6, 0, 1),
                new CalFields(2011, 11, 6, 5, 0, 1)
            },
            {
                "America/New_York",
                new CalFields(2011, 11, 6, 1, 30, 0),
                new CalFields(2011, 11, 6, 6, 30, 0),
                new CalFields(2011, 11, 6, 5, 30, 0)
            },
            {
                "America/New_York",
                new CalFields(2011, 11, 6, 1, 59, 59),
                new CalFields(2011, 11, 6, 6, 59, 59),
                new CalFields(2011, 11, 6, 5, 59, 59)
            },
            {
                "America/New_York",
                new CalFields(2011, 11, 6, 2, 0, 0),
                new CalFields(2011, 11, 6, 7, 0, 0),
                new CalFields(2011, 11, 6, 7, 0, 0)
            },
            {
                "America/New_York",
                new CalFields(2011, 11, 6, 2, 0, 1),
                new CalFields(2011, 11, 6, 7, 0, 1),
                new CalFields(2011, 11, 6, 7, 0, 1)
            },
            {
                "Australia/Lord_Howe",
                new CalFields(2011, 4, 3, 1, 29, 59),
                new CalFields(2011, 4, 2, 14, 29, 59),
                new CalFields(2011, 4, 2, 14, 29, 59)
            },
            {
                "Australia/Lord_Howe",
                new CalFields(2011, 4, 3, 1, 30, 0),
                new CalFields(2011, 4, 2, 15, 0, 0),
                new CalFields(2011, 4, 2, 14, 30, 0)
            },
            {
                "Australia/Lord_Howe",
                new CalFields(2011, 4, 3, 1, 45, 0),
                new CalFields(2011, 4, 2, 15, 15, 0),
                new CalFields(2011, 4, 2, 14, 45, 0)
            },
            {
                "Australia/Lord_Howe",
                new CalFields(2011, 4, 3, 1, 59, 59),
                new CalFields(2011, 4, 2, 15, 29, 59),
                new CalFields(2011, 4, 2, 14, 59, 59)
            },
            {
                "Australia/Lord_Howe",
                new CalFields(2011, 4, 3, 2, 0, 0),
                new CalFields(2011, 4, 2, 15, 30, 0),
                new CalFields(2011, 4, 2, 15, 30, 0)
            },
            {
                "Australia/Lord_Howe",
                new CalFields(2011, 4, 3, 2, 0, 1),
                new CalFields(2011, 4, 2, 15, 30, 1),
                new CalFields(2011, 4, 2, 15, 30, 1)
            },
        };
    ...
    public void TestSkippedWallTime() {
        final Object[][] TESTDATA = {
            ...
            {
                "America/New_York",
                new CalFields(2011, 3, 13, 1, 59, 59),
                true,
                //  WALLTIME_LAST in GMT                WALLTIME_FIRST in GMT
                // WALLTIME_NEXT_VALID in GMT
                new CalFields(2011, 3, 13, 6, 59, 59),
                new CalFields(2011, 3, 13, 6, 59, 59),
                new CalFields(2011, 3, 13, 6, 59, 59)
            },
            {
                "America/New_York",
                new CalFields(2011, 3, 13, 2, 0, 0),
                false,
                new CalFields(2011, 3, 13, 7, 0, 0),
                new CalFields(2011, 3, 13, 6, 0, 0),
                new CalFields(2011, 3, 13, 7, 0, 0)
            },
            {
                "America/New_York",
                new CalFields(2011, 3, 13, 2, 1, 0),
                false,
                new CalFields(2011, 3, 13, 7, 1, 0),
                new CalFields(2011, 3, 13, 6, 1, 0),
                new CalFields(2011, 3, 13, 7, 0, 0)
            },
            {
                "America/New_York",
                new CalFields(2011, 3, 13, 2, 30, 0),
                false,
                new CalFields(2011, 3, 13, 7, 30, 0),
                new CalFields(2011, 3, 13, 6, 30, 0),
                new CalFields(2011, 3, 13, 7, 0, 0)
            },
            {
                "America/New_York",
                new CalFields(2011, 3, 13, 2, 59, 59),
                false,
                new CalFields(2011, 3, 13, 7, 59, 59),
                new CalFields(2011, 3, 13, 6, 59, 59),
                new CalFields(2011, 3, 13, 7, 0, 0)
            },
            {
                "America/New_York",
                new CalFields(2011, 3, 13, 3, 0, 0),
                true,
                new CalFields(2011, 3, 13, 7, 0, 0),
                new CalFields(2011, 3, 13, 7, 0, 0),
                new CalFields(2011, 3, 13, 7, 0, 0)
            ...
            {
                "Pacific/Apia",
                new CalFields(2011, 12, 29, 23, 59, 59),
                true,
                new CalFields(2011, 12, 30, 9, 59, 59),
                new CalFields(2011, 12, 30, 9, 59, 59),
                new CalFields(2011, 12, 30, 9, 59, 59)
            },
            {
                "Pacific/Apia",
                new CalFields(2011, 12, 30, 0, 0, 0),
                false,
                new CalFields(2011, 12, 30, 10, 0, 0),
                new CalFields(2011, 12, 29, 10, 0, 0),
                new CalFields(2011, 12, 30, 10, 0, 0)
            },
            {
                "Pacific/Apia",
                new CalFields(2011, 12, 30, 12, 0, 0),
                false,
                new CalFields(2011, 12, 30, 22, 0, 0),
                new CalFields(2011, 12, 29, 22, 0, 0),
                new CalFields(2011, 12, 30, 10, 0, 0)
            },
            {
                "Pacific/Apia",
                new CalFields(2011, 12, 30, 23, 59, 59),
                false,
                new CalFields(2011, 12, 31, 9, 59, 59),
                new CalFields(2011, 12, 30, 9, 59, 59),
                new CalFields(2011, 12, 30, 10, 0, 0)
            },
            {
                "Pacific/Apia",
                new CalFields(2011, 12, 31, 0, 0, 0),
                true,
                new CalFields(2011, 12, 30, 10, 0, 0),
                new CalFields(2011, 12, 30, 10, 0, 0),
                new CalFields(2011, 12, 30, 10, 0, 0)
    ...
    public void TestFieldDifference() {
        class TFDItem {
            ...
            public long target;
            public boolean
                    progressive; // true to compute progressive difference for each field, false to
            // reset calendar after each call
            int yDiff;
            int MDiff;
            int dDiff;
            int HDiff;
        ...
        final TFDItem[] tfdItems = {
            //           timezobe      locale        start            target            prog   yDf
            // MDf    dDf     HDf       mDf         sDf
            // For these we compute the progressive difference for each field - not resetting the
            ...
            new TFDItem(
                    ...
                    9,
                    40,
                    0), // 2010-Mar-01 08:10 -> 2010-Jun-28 17:50
            new TFDItem(
                    "US/Pacific",
                    "en_US",
                    1267459800000L,
                    ...
                    1,
                    58,
                    0), // 2010-Mar-01 08:10 -> 2011-Mar-02 10:08
            // For these we compute the total difference for each field - resetting the calendar
            // after each call
            new TFDItem(
                    "GMT",
                    "en_US",
                    ...
                    298248,
                    17894880,
                    1073692800), // 1970-Jan-01 00:00 -> 2004-Jan-10 00:00
            new TFDItem(
                    "GMT",
                    "en_US",
                    0,
                    ...
                    298272,
                    17896320,
                    1073779200), // 1970-Jan-01 00:00 -> 2004-Jan-11 00:00
            new TFDItem(
                    "GMT",
                    "en_US",
                    0,
                    ...
                    596520,
                    35791200,
                    2147472000), // 1970-Jan-01 00:00 -> 2038-Jan-19 00:00
            //          new TFDItem( "GMT",        "en_US",        0,               2147558400000L,
            // false,  68, 816, 24856, 596544, 35792640, 0x7FFFFFFF ), // 1970-Jan-01 00:00 ->
            // 2038-Jan-20 00:00, seconds overflow => exception in ICU4J
            new TFDItem(
                    "GMT",
                    "en_US",
                    0,
                    ...
                    -298248,
                    -17894880,
                    -1073692800), // 1970-Jan-01 00:00 -> 1935-Dec-24 00:00
            new TFDItem(
                    "GMT",
                    "en_US",
                    0,
                    ...
                    -298272,
                    -17896320,
                    -1073779200), // 1970-Jan-01 00:00 -> 1935-Dec-23 00:00
            ...
            new TFDItem(
                    ...
                    43800,
                    2628000,
                    157680000), // CE   5-Dec-31 00:00 -> CE  10-Dec-30 00:00
            new TFDItem(
                    "GMT",
                    "en_US",
                    -61820409600000L,
                    ...
                    -43800,
                    -2628000,
                    -157680000), // CE  10-Dec-30 00:00 -> CE   5-Dec-31 00:00
            new TFDItem(
                    "GMT",
                    "en_US",
                    -62451129600000L,
                    ...
                    43800,
                    2628000,
                    157680000), // BCE 10-Jan-04 00:00 -> BCE  5-Jan-03 00:00
            new TFDItem(
                    "GMT",
                    "en_US",
                    -62293449600000L,
                    ...
                    -43800,
                    -2628000,
                    -157680000), // BCE  5-Jan-03 00:00 -> BCE 10-Jan-04 00:00
            new TFDItem(
                    "GMT",
                    "en_US",
                    -62293449600000L,
                    ...
                    87600,
                    5256000,
                    315360000), // BCE  5-Jan-03 00:00 -> CE   5-Dec-31 00:00
            new TFDItem(
                    "GMT",
                    "en_US",
                    -61978089600000L,
                    ...
                    -87600,
                    -5256000,
                    -315360000), // CE   5-Dec-31 00:00 -> BCE  5-Jan-03 00:00
            new TFDItem(
                    "GMT",
                    "en@calendar=roc",
                    -1672704000000L,
                    ...
                    43800,
                    2628000,
                    157680000), // MG   5-Dec-30 00:00 -> MG  10-Dec-29 00:00
            new TFDItem(
                    "GMT",
                    "en@calendar=roc",
                    -1515024000000L,
                    ...
                    -43800,
                    -2628000,
                    -157680000), // MG  10-Dec-29 00:00 -> MG   5-Dec-30 00:00
            new TFDItem(
                    "GMT",
                    "en@calendar=roc",
                    -2145744000000L,
                    ...
                    43800,
                    2628000,
                    157680000), // BMG 10-Jan-03 00:00 -> BMG  5-Jan-02 00:00
            new TFDItem(
                    "GMT",
                    "en@calendar=roc",
                    -1988064000000L,
                    ...
                    -43800,
                    -2628000,
                    -157680000), // BMG  5-Jan-02 00:00 -> BMG 10-Jan-03 00:00
            new TFDItem(
                    "GMT",
                    "en@calendar=roc",
                    -1988064000000L,
                    ...
                    87600,
                    5256000,
                    315360000), // BMG  5-Jan-02 00:00 -> MG   5-Dec-30 00:00
            new TFDItem(
                    "GMT",
                    "en@calendar=roc",
                    -1672704000000L,
                    ...
                    -87600,
                    -5256000,
                    -315360000), // MG   5-Dec-30 00:00 -> BMG  5-Jan-02 00:00
            new TFDItem(
                    "GMT",
                    "en@calendar=coptic",
                    -53026531200000L,
                    ...
                    43800,
                    2628000,
                    157680000), // Er1  5-Nas-05 00:00 -> Er1 10-Nas-04 00:00
            new TFDItem(
                    "GMT",
                    "en@calendar=coptic",
                    -52868851200000L,
                    ...
                    -43800,
                    -2628000,
                    -157680000), // Er1 10-Nas-04 00:00 -> Er1  5-Nas-05 00:00
            new TFDItem(
                    "GMT",
                    "en@calendar=coptic",
                    -53499571200000L,
                    ...
                    43800,
                    2628000,
                    157680000), // Er0 10-Tou-04 00:00 -> Er0  5-Tou-02 00:00
            new TFDItem(
                    "GMT",
                    "en@calendar=coptic",
                    -53341891200000L,
                    ...
                    -43800,
                    -2628000,
                    -157680000), // Er0  5-Tou-02 00:00 -> Er0 10-Tou-04 00:00
            new TFDItem(
                    "GMT",
                    "en@calendar=coptic",
                    -53341891200000L,
                    ...
                    87600,
                    5256000,
                    315360000), // Er0  5-Tou-02 00:00 -> Er1  5-Nas-05 00:00
            new TFDItem(
                    "GMT",
                    "en@calendar=coptic",
                    -53026531200000L,
                    ...
                    -87600,
                    -5256000,
                    -315360000), // Er1  5-Nas-05 00:00 -> Er0  5-Tou-02 00:00
        };
                ...
                if (yDf != tfdItem.yDiff
                    ...
                    errln(
                            "Fail: for locale \""
                                    ...
                                    + ", target "
                                    + tfdItem.target
                                    + ", expected y-M-d-H-m-s progressive diffs "
                                    + tfdItem.yDiff
                                    + ","
                                    + tfdItem.MDiff
                                    + ","
                ...
                if (yDf != tfdItem.yDiff
                    ...
                    errln(
                            "Fail: for locale \""
                                    ...
                                    + ", target "
                                    + tfdItem.target
                                    + ", expected y-M-d-H-m total diffs "
                                    + tfdItem.yDiff
                                    + ","
                                    + tfdItem.MDiff
                                    + ","
    ...
    public void TestAddRollEra0AndEraBounds() {
        ...
        for (String localeID : localeIDs) {
            ...
            if ((era0YearsGoBackwards && yrAfter > yrBefore)
                    || (!era0YearsGoBackwards && yrAfter < yrBefore)) {
            ...
            if (era0YearsGoBackwards) {
                ...
                if (eraAfter != 0 || yrAfter != 1) {
                    errln(
                            "Fail: era 0 roll 1 year from year 1 does not stay within era or pin to year 1 for "
                                    + localeID
                                    + " (get era "
                                    + eraAfter
                                    + " year "
                ...
                if (!calType.equals("chinese") && (eraAfter != 0 || yrAfter != -1)) {
                    errln(
                            "Fail: era 0 roll -2 years from year 1 does not stay within era or produce year -1 for "
                                    + localeID
                                    + " (get era "
                                    + eraAfter
                                    + " year "
            ...
            ucalTest.clear();
            {
                ...
                if (eraMin != 0 && calType.compareTo("chinese") != 0) {
                    errln(
                            "Fail: getMinimum returns minimum era "
                                    + eraMin
                                    + " (should be 0) for calType "
                                    + calType);
                }
            }
            ...
            if (eraMax > 0) {
                // try similar tests for era 1 (if calendar has it), in which years always go
                // forward
                ...
                if (yrMax >= 32768) {
                    if (eraAfter != 1 || yrAfter != 1) {
                        errln(
                                "Fail: era 1 roll -1 year from year 1 does not stay within era or pin to year 1 for "
                                        + localeID
                                        + " (get era "
                                        + eraAfter
                                        + " year "
                    ...
                    errln(
                            "Fail: era 1 roll -1 year from year 1 does not stay within era or wrap to year "
                                    + yrMax
                                    + " for "
                                    + localeID
                                    + " (get era "
                    ...
                    if (eraAfter != 1 || yrAfter != 1) {
                        errln(
                                "Fail: era 1 roll 1 year from year "
                                        + yrMax
                ...
                if (eraNow > 1) {
                    ...
                    if (yrMax >= 32768) {
                        ...
                        errln(
                                "Fail: era "
                                        + eraNow
                                        + " roll -1 year from year 1 does not stay within era or wrap to year "
                                        + yrMax
                                        + " for "
                                        + localeID
                                        + " (get era "
                        ...
                        ucalTest.roll(
                                Calendar.YEAR, 1); // now roll up which should wrap to beginning
                        yrAfter = ucalTest.get(Calendar.YEAR);
                        eraAfter = ucalTest.get(Calendar.ERA);
                        if (eraAfter != eraNow || yrAfter != 1) {
                            errln(
    ...
    public void TestAddAcrossZoneTransition() {
        ...
        TestData[] data =
                new TestData[] {
                    ...
                    new TestData(
                            "America/Los_Angeles",
                            new CalFields(2014, 3, 8, 1, 59, 59, 999),
                            1,
                            Calendar.WALLTIME_FIRST,
                    ...
                    new TestData(
                            "America/Los_Angeles",
                            new CalFields(2014, 3, 8, 2, 0, 0, 0),
                            1,
                            Calendar.WALLTIME_FIRST,
                    ...
                    new TestData(
                            "America/Los_Angeles",
                            new CalFields(2014, 3, 8, 2, 30, 0, 0),
                            1,
                            Calendar.WALLTIME_FIRST,
                    ...
                    new TestData(
                            "America/Los_Angeles",
                            new CalFields(2014, 3, 8, 3, 0, 0, 0),
                            1,
                            Calendar.WALLTIME_FIRST,
                            new CalFields(2014, 3, 9, 3, 0, 0, 0)),
                    new TestData(
                    ...
                    new TestData(
                            "America/Los_Angeles",
                            new CalFields(2014, 3, 10, 1, 59, 59, 999),
                            -1,
                            Calendar.WALLTIME_FIRST,
                            new CalFields(2014, 3, 9, 1, 59, 59, 999)),
                    new TestData(
                    ...
                    new TestData(
                            "America/Los_Angeles",
                            new CalFields(2014, 3, 10, 2, 0, 0, 0),
                            -1,
                            Calendar.WALLTIME_FIRST,
                            new CalFields(2014, 3, 9, 1, 0, 0, 0)),
                    new TestData(
                    ...
                    new TestData(
                            "America/Los_Angeles",
                            new CalFields(2014, 3, 10, 2, 30, 0, 0),
                            -1,
                            Calendar.WALLTIME_FIRST,
                            new CalFields(2014, 3, 9, 1, 30, 0, 0)),
                    new TestData(
                    ...
                    new TestData(
                            "America/Los_Angeles",
                            new CalFields(2014, 3, 10, 3, 0, 0, 0),
                            -1,
                            Calendar.WALLTIME_FIRST,
                            new CalFields(2014, 3, 9, 3, 0, 0, 0)),
                    new TestData(
                    ...
                    new TestData(
                            "America/Santiago",
                            new CalFields(2013, 4, 27, 0, 0, 0, 0),
                            134,
                            Calendar.WALLTIME_FIRST,
                    ...
                    new TestData(
                            "America/Santiago",
                            new CalFields(2013, 4, 27, 0, 30, 0, 0),
                            134,
                            Calendar.WALLTIME_FIRST,
                    ...
                    new TestData(
                            "Pacific/Apia",
                            new CalFields(2011, 12, 29, 0, 0, 0, 0),
                            1,
                            Calendar.WALLTIME_FIRST,
                    ...
                    new TestData(
                            "Pacific/Apia",
                            new CalFields(2011, 12, 31, 12, 0, 0, 0),
                            -1,
                            Calendar.WALLTIME_FIRST,
                    ...
                    new TestData(
                            "Australia/Lord_Howe",
                            new CalFields(2013, 10, 5, 2, 15, 0, 0),
                            1,
                            Calendar.WALLTIME_FIRST,
        ...
        for (TestData d : data) {
            ...
            if (!d.expected.isEquivalentTo(cal)) {
                ...
                String optDisp =
                        d.skippedWTOpt == Calendar.WALLTIME_FIRST
                                ? "FIRST"
    ...
    public void TestSimpleDateFormatCoverage() {
        ...
        class StubSimpleDateFormat extends SimpleDateFormat {
            ...
            public void run() {
                ...
                int matchIndex =
                        matchString(
                                "Monday March 28, 2016", 0, Calendar.DAY_OF_WEEK, matchData, cal);
                assertEquals(
                        "matchData for Monday",
                        6,
                        matchIndex); // Position of the pointer after the matched string.
                matchIndex =
                        matchString("Monday March 28, 2016 AD", 17, Calendar.YEAR, matchData, cal);
                assertEquals(
                        "matchData for 2016",
                        21,
                        matchIndex); // Position of the pointer after the matched string.
        ...
        StubSimpleDateFormat stub =
                new StubSimpleDateFormat("EEE MMM dd yyyy G HH:mm:ss.SSS", Locale.US);
        stub.run();
    }
    ...
    public void checkConsistency(String locale) {
        ...
        boolean ignoreOrdinaryMonth12Bug =
        ...
        for (int j = 0; j < numOfDaysToTest; j++, test.setTime(test.getTime() - msInADay)) {
            ...
            if (lastDay == 1) {
                ...
                if (cday != lastDay - 1) {
                    ...
                    // 1582 Oct 4
                    if (g.get(Calendar.YEAR) == 1582
                            && (g.get(Calendar.MONTH) + 1) == 10
                            && g.get(Calendar.DAY_OF_MONTH) == 4) {
                        lastDay = 5;
                    } else {
                        errln(
                                "Day is not one less from previous date for Gregorian(e="
                                        + g.get(Calendar.ERA)
                                        + " "
                                        + g.get(Calendar.YEAR)
                                        + "/"
            ...
            if (!test.equals(result)) {
                ...
                errln(
                        "Round trip conversion produces different time from "
                                + test
                                + " to  "
                                + result
                                + " delta: "
                                + (result.getTime() - test.getTime())
                                + " Gregorian(e="
                                + g.get(Calendar.ERA)
                                + " "
                                + g.get(Calendar.YEAR)
