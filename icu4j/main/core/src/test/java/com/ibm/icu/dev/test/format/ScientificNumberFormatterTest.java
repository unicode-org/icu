...
public class ScientificNumberFormatterTest extends CoreTestFmwk {
    ...
    public void TestBasic() {
        ScientificNumberFormatter markup =
                ScientificNumberFormatter.getMarkupInstance(ULocale.ENGLISH, "<sup>", "</sup>");
        ScientificNumberFormatter superscript =
                ScientificNumberFormatter.getSuperscriptInstance(ULocale.ENGLISH);
        assertEquals(
                "toMarkupExponentDigits", "1.23456×10<sup>-78</sup>", markup.format(1.23456e-78));
        assertEquals(
                "toSuperscriptExponentDigits", "1.23456×10⁻⁷⁸", superscript.format(1.23456e-78));
    }

    @Test
    public void TestFarsi() {
        ScientificNumberFormatter fmt =
                ScientificNumberFormatter.getMarkupInstance(new ULocale("fa"), "<sup>", "</sup>");
    ...
    public void TestPlusSignInExponentMarkup() {
        ...
        ScientificNumberFormatter fmt =
                ScientificNumberFormatter.getMarkupInstance(decfmt, "<sup>", "</sup>");
