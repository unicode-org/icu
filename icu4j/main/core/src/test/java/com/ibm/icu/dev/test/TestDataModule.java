...
public interface TestDataModule {
    ...
    /**
     * Get additional data related to the module, e.g. DESCRIPTION, global settings. Might be null.
     */
    public DataMap getInfo();

    /**
     * Returns the TestData corresponding to name, or null if name not found in this module. Throw
    ...
    public static class Factory {
        ...
        static final TestDataModule get(String baseName, String localeName)
                throws DataModuleFormatError {
    ...
    public static interface TestData {
        ...
        /**
         * Get additional data related to the test data, e.g. DESCRIPTION, global settings. Might be
         * null.
         */
        public DataMap getInfo();
    ...
    /**
     * Map-like interface for accessing key-value pairs by key. If the value is not found by given
     * key, return null. The behavior is analogous the get() method of the Map interface.
     *
     * @author Raymond Yang
     */
