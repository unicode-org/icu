...
public class TemporalMonthCodeTest extends CoreTestFmwk {
    ...
    public void TestGregorianCalendarSetTemporalMonthCode() {
        ...
        for (Object[] cas : cases) {
            ...
            assertEquals(
                    "ordinalMonth",
                    gc1.get(Calendar.ORDINAL_MONTH),
                    gc2.get(Calendar.ORDINAL_MONTH));
        }
    }

    @Test
    public void TestChineseCalendarSetTemporalMonthCode() {
        Calendar cc1 = Calendar.getInstance(ULocale.ROOT.setKeywordValue("calendar", "chinese"));
        ...
        for (Object[] cas : cases) {
            ...
            assertEquals("is_leap_month", cLeapMonth ? 1 : 0, cc1.get(Calendar.IS_LEAP_MONTH));
            assertEquals("getTemporalMonthCode()", cMonthCode, cc1.getTemporalMonthCode());
    ...
    public void TestHebrewCalendarSetTemporalMonthCode() {
        Calendar hc1 = Calendar.getInstance(ULocale.ROOT.setKeywordValue("calendar", "hebrew"));
        ...
        for (Object[] cas : cases) {
            ...
            assertEquals("getTemporalMonthCode()", hMonthCode, hc1.getTemporalMonthCode());
    ...
    public void TestCopticCalendarSetTemporalMonthCode() {
        Calendar cc1 = Calendar.getInstance(ULocale.ROOT.setKeywordValue("calendar", "coptic"));
        Calendar cc2 = cc1.clone();
        GregorianCalendar gc1 = new GregorianCalendar();
        Object[][] cases = {
    ...
    public void TestEthiopicCalendarSetTemporalMonthCode() {
        Calendar ec1 = Calendar.getInstance(ULocale.ROOT.setKeywordValue("calendar", "ethiopic"));
        ...
        for (Object[] cas : cases) {
            ...
            assertEquals("getTemporalMonthCode()", eMonthCode, ec1.getTemporalMonthCode());
            assertEquals("by set() and setTemporalMonthCode()", ec1, ec2);
