...
public class IslamicTest extends CalendarTestFmwk {
    ...
    public void Test7427() {
        ...
        if (cal.get(IslamicCalendar.MONTH) != IslamicCalendar.MUHARRAM
            ...
            errln(
                    "Error incrementing month at the end of a leap year.  Expected Month:0 Year:1432 - Got Month:"
                            + cal.get(IslamicCalendar.MONTH)
                            + " Year:"
    ...
    public void TestCoverage() {
...

        {
            ...
            String[] calendarLocales = {
                "ar_AE", "ar_BH", "ar_DZ", "ar_EG", "ar_JO", "ar_KW", "ar_OM", "ar_QA", "ar_SA",
                "ar_SY", "ar_YE", "ms_MY"
            };
        ...
        for (int startMonth = 0; startMonth < 12; startMonth++) {
            for (int startDay = 1; startDay < 31; startDay++) {
                try {
                    ...
                    if (startDay != 30) {
                        errln(
                                "unexpected exception that wasn't for trying to set a date to '30'. errmsg - "
    ...
    public void TestIslamicUmAlQura() {
        ...
        int day = 0,
                ...
                year = 0,
                initDay = 27,
                initMonth = IslamicCalendar.RAJAB,
                initYear = 1434;
        ...
        try {
            ...
            is_cal.setTime(date);
            SimpleDateFormat formatterIslamic =
                    (SimpleDateFormat) is_cal.getDateTimeFormat(0, 0, umalquraLoc);
            ...
            String expectedFormatResult =
                    "\u0661\u0663\u0669\u0665-\u0631\u0628\u064A\u0639 \u0627\u0644\u0622\u062E\u0631-\u0662\u0664";
            if (!str.equals(expectedFormatResult)) errln("unexpected formatted result: " + str);
    ...
    public void TestIslamicTabularDates() {
        ...
        if ((is_month != is_month2) || (is_year != is_year2))
            errln(
                    "unexpected difference between islamic and tbla month "
                            + is_month
                            + " : "
                            + is_month2
                            + " and/or year "
