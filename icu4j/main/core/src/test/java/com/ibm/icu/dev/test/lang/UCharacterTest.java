...
public final class UCharacterTest extends CoreTestFmwk {
    ...
    public void TestGetNumericValue() {
        ...
        int[] valid_values = {
            ...
            0x2188, 0x4E07, 0x4EBF, 0x4EDF, 0x5104, 0x5146, 0x5343, 0x842C, 0x9621, 0x1011B,
            0x1011C, 0x1011D, 0x1011E, 0x1011F, 0x10120, 0x10121, 0x10122, 0x10123, 0x10124,
            0x10125, 0x10126, 0x10127, 0x10128, 0x10129, 0x1012A, 0x1012B, 0x1012C, 0x1012D,
            0x1012E, 0x1012F, 0x10130, 0x10131, 0x10132, 0x10133, 0x10145, 0x10146, 0x10147,
            0x1014C, 0x1014D, 0x1014E, 0x10153, 0x10154, 0x10155, 0x10156, 0x1016B, 0x1016C,
        ...
        int[] results = {
            ...
            100000000, 1000, 100000000, 1000000, 1000, 10000, 1000, 300, 400, 500, 600, 700, 800,
            900, 1000, 2000, 3000, 4000, 5000, 6000, 7000, 8000, 9000, 10000, 20000, 30000, 40000,
            50000, 60000, 70000, 80000, 90000, 500, 5000, 50000, 500, 1000, 5000, 500, 1000, 10000,
            50000, 300, 500, 500, 500, 500, 500, 1000, 5000, 900, 1000
        };
    ...
    public void TestIDStatus() {
        ...
        assertEquals(
                ...
                getIDStatus(0x1B03A));
        assertEquals(
                "ID_Status(Katakana small ko)=Allowed",
                IdentifierStatus.ALLOWED,
                getIDStatus(0x1B155));
    ...
    public void TestIDType() {
        ...
        assertEquals(
                ...
                getIDTypes(0x1B03A));
        assertEquals(
                "ID_Type(Katakana small ko)",
                EnumSet.of(IdentifierType.RECOMMENDED),
                getIDTypes(0x1B155));
        assertEquals(
                "ID_Type(U+2EE5D)", EnumSet.of(IdentifierType.RECOMMENDED), getIDTypes(0x2EE5D));
        assertEquals(
                "ID_Type(U+10FFFF)",
        ...
        assertEquals(
                ...
                getIDTypes(0x0700));
        assertEquals(
                "ID_Type(LATIN SMALL LETTER EZH)=",
