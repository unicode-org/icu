...
/**
 * ****************************************************************************** Copyright (C)
 * 2001-2007, International Business Machines Corporation and * others. All Rights Reserved. *
 * ******************************************************************************
 */
 ...
 *
 * <p>A convenience extension of TestFmwk for use by data module-driven tests.
 *
 * <p>Tests can implement this if they make extensive use of information in a TestDataModule.
 *
 * <p>Subclasses can allow for test methods that don't use data from the module by overriding
 * validateMethod to return true for these methods. Tests are also free to instantiate their own
 * modules and run from them, though care should be taken not to interfere with the methods in this
 * class.
 *
 * <p>See CollationTest for an example.
 */
public class ModuleTest {
    ...
    /**
     * TestFmwk calls this before trying to run a suite of tests. The test suite if valid if a
     * module whose name is the name of this class + "Data" can be opened. Subclasses can override
    ...
    public static List<TestDataPair> getTestData(String moduleLocation, String moduleName)
            throws Exception {
