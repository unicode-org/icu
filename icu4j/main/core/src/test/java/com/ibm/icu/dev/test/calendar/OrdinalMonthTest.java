...
public class OrdinalMonthTest extends CoreTestFmwk {
    ...
    private void VerifyMonth(
            ...
            Calendar cc,
            int expectedMonth,
            int expectedOrdinalMonth,
            boolean expectedLeapMonth,
            String expectedMonthCode) {
        assertEquals(message + " get(MONTH)", expectedMonth, cc.get(Calendar.MONTH));
        assertEquals(
                message + " get(ORDINAL_MONTH)",
                expectedOrdinalMonth,
                cc.get(Calendar.ORDINAL_MONTH));
        assertEquals(
                message + " get(IS_LEAP_MONTH)",
                expectedLeapMonth ? 1 : 0,
                cc.get(Calendar.IS_LEAP_MONTH));
        assertEquals(
                message + " getTemporalMonthCode()", expectedMonthCode, cc.getTemporalMonthCode());
    }
    ...
    public void TestMostCalendarsSet() {
        ...
        for (String calendar : calendars) {
            ...
            assertEquals(
                    "M06 cc2==cc1 set month by Calendar.MONTH and Calendar.ORDINAL_MONTH",
                    cc1,
                    cc2);
            assertEquals(
                    "M06 cc2==cc3 set month by Calendar.MONTH and setTemporalMonthCode", cc2, cc3);
            ...
            assertEquals(
                    "M07 cc1==cc3 set month by Calendar.MONTH and Calendar.ORDINAL_MONTH",
                    cc1,
                    cc3);
            assertEquals(
                    "M07 cc2==cc3 set month by Calendar.MONTH and setTemporalMonthCode", cc2, cc3);
            ...
            assertEquals(
                    "M08 cc1==cc2 set month by Calendar.MONTH and setTemporalMonthCode", cc1, cc2);
            assertEquals(
                    "M08 cc2==cc3 set month by Calendar.MONTH and Calendar.ORDINAL_MONTH",
                    cc2,
                    cc3);
            ...
            if (calendar == "coptic"
                ...
                assertEquals(
                        ...
                        12,
                        cc1.get(Calendar.MONTH));
                assertEquals(
                        "get(Calendar.ORDINAL_MONTH) after setTemporalMonthCode(\"M13\")",
                        12,
                        cc1.get(Calendar.ORDINAL_MONTH));
            } else {
            ...
            String[] invalidMonthCodes = {
                "M00", "M14", "M01L", "M02L", "M03L", "M04L", "M05L", "M06L", "M07L", "M08L",
                "M09L", "M10L", "M11L", "M12L"
            };
    ...
    private void RunTestChineseCalendarSet(String calendar, int notLeapYear, int leapMarchYear) {
        ...
        assertEquals(
                ""
                        + leapMarchYear
                        + " M03L cc2==cc1 set month by Calendar.MONTH and Calendar.ORDINAL_MONTH",
                cc1,
                cc2);
        assertEquals(
                ""
                        + leapMarchYear
                        + " M03L cc2==cc3 set month by Calendar.ORDINAL_MONTH and setTemporalMonthCode",
                cc2,
                cc3);
        ...
        assertEquals(
                ""
                        + notLeapYear
                        + " M06 cc1==cc2 set month by Calendar.ORDINAL_MONTH and setTemporalMonthCode",
                cc1,
                cc2);
        assertEquals(
                ""
                        + notLeapYear
                        + " M06 cc2==cc3 set month by Calendar.MONTH and setTemporalMonthCode",
                cc2,
                cc3);
        ...
        assertEquals(
                ""
                        + leapMarchYear
                        + " M04 cc2==cc1 set month by setTemporalMonthCode and Calendar.MONTH",
                cc1,
                cc2);
        assertEquals(
                ""
                        + leapMarchYear
                        + " M04 cc2==cc3 set month by Calendar.MONTH and Calendar.ORDINAL_MONTH",
                cc2,
                cc3);
    ...
    public void TestHebrewCalendarSet() {
        ...
        cc3.set(Calendar.DATE, 1);
        assertEquals(
                "5782 M05L cc2==cc1 set month by Calendar.MONTH and Calendar.ORDINAL_MONTH",
                cc1,
                cc2);
        assertEquals(
                "5782 M05L cc2==cc3 set month by Calendar.MONTH and setTemporalMonthCode",
                cc2,
                cc3);
        ...
        assertEquals(
                "5782 M05 cc2==cc3 set month by Calendar.ORDINAL_MONTH and setTemporalMonthCode",
                cc1,
                cc2);
        assertEquals(
                "5782 M05 cc2==cc3 set month by Calendar.MONTH and setTemporalMonthCode", cc2, cc3);
        ...
        assertEquals(
                "5781 M06 cc1==cc2 set month by Calendar.MONTH and setTemporalMonthCode", cc1, cc2);
        assertEquals(
                "5781 M06 cc2==cc3 set month by Calendar.MONTH and Calendar.ORDINAL_MONTH",
                cc2,
                cc3);
        ...
        cc3.set(Calendar.EXTENDED_YEAR, leapYear);
        assertEquals(
                "5782 M06 cc1==cc2 set month by Calendar.MONTH and setTemporalMonthCode", cc1, cc2);
        assertEquals(
                "5782 M06 cc2==cc3 set month by Calendar.MONTH and Calendar.ORDINAL_MONTH",
                cc2,
                cc3);
        assertEquals(
                "5782 M06 cc2==cc3 set month by Calendar.MONTH and setTemporalMonthCode", cc2, cc3);
        ...
        assertEquals(
                "5782 M07 cc1==cc2 set month by Calendar.ORDINAL_MONTH and setTemporalMonthCode",
                cc1,
                cc2);
        assertEquals(
                "5782 M07 cc2==cc3 set month by Calendar.MONTH and setTemporalMonthCode", cc2, cc3);
        ...
        for (String calendar : calendars) {
            ...
            for (Object[] cas : cases) {
                if (calendar.equals((String) cas[0])) {
                    ...
                    assertEquals(
                            "getMinimum(Calendar.ORDINAL_MONTH)",
                            min,
                            cc1.getMinimum(Calendar.ORDINAL_MONTH));
                    assertEquals(
                            "getMaximum(Calendar.ORDINAL_MONTH)",
                            max,
                            cc1.getMaximum(Calendar.ORDINAL_MONTH));
                    assertEquals(
                            "getMinimum(Calendar.ORDINAL_MONTH)",
                            greatestMin,
                            cc1.getGreatestMinimum(Calendar.ORDINAL_MONTH));
                    assertEquals(
                            "getMinimum(Calendar.ORDINAL_MONTH)",
                            leastMax,
                            cc1.getLeastMaximum(Calendar.ORDINAL_MONTH));
                    found = true;
                    break;
                }
            }
    ...
    public void TestActaulLimits() {
        ...
        for (Object[] cas : cases) {
            ...
            cc1.set(Calendar.DATE, 1);
            assertEquals(
                    "getActualMinimum(Calendar.ORDINAL_MONTH)",
                    actualMinOrdinalMonth,
                    cc1.getActualMinimum(Calendar.ORDINAL_MONTH));
            assertEquals(
                    "getActualMaximum(Calendar.ORDINAL_MONTH)",
                    actualMaxOrdinalMonth,
                    cc1.getActualMaximum(Calendar.ORDINAL_MONTH));
        }
    }
}
