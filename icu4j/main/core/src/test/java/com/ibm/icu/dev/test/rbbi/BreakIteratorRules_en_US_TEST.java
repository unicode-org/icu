...
/**
 * This resource bundle is included for testing and demonstration purposes only. It applies the
 * dictionary-based algorithm to English text that has had all the spaces removed. Once we have good
 * test cases for Thai, we will replace this with good resource data (and a good dictionary file)
 * for Thai
 */
        ...
        return new Object[][] {
            ...
            // specified as dictionary characters
            {
                ...
                "$_ignore_=[[:Mn:][:Me:][:Cf:]];"
                        ...
                        // the period, the number sign, and all currency symbols except the cents
                        // sign
                        + "$pre_num=[[[:Sc:]-[\u00a2]]\\#\\.];"
            ...
            // specified as dictionary characters
            {
                ...
                "$_ignore_=[[:Mn:][:Me:][:Cf:]];"
                        ...
                        // the basic core of a word can be either a "number" as defined above, a
                        // single
                        ...
                        // a word core and a word suffix (the syntax of <word-core> and
                        // <word-suffix>
