 ...
 *
 * <p>Leap months in this century: Wed May 23 2001 = 4638-04*-01, Year 18, Cycle 78 Sun Mar 21 2004
 * = 4641-02*-01, Year 21, Cycle 78 Thu Aug 24 2006 = 4643-07*-01, Year 23, Cycle 78 Tue Jun 23 2009
 * = 4646-05*-01, Year 26, Cycle 78 Mon May 21 2012 = 4649-04*-01, Year 29, Cycle 78 Fri Oct 24 2014
 * = 4651-09*-01, Year 31, Cycle 78 Sun Jul 23 2017 = 4654-06*-01, Year 34, Cycle 78 Sat May 23 2020
 * = 4657-04*-01, Year 37, Cycle 78 Wed Mar 22 2023 = 4660-02*-01, Year 40, Cycle 78 Fri Jul 25 2025
 * = 4662-06*-01, Year 42, Cycle 78 Fri Jun 23 2028 = 4665-05*-01, Year 45, Cycle 78 Tue Apr 22 2031
 * = 4668-03*-01, Year 48, Cycle 78 Thu Dec 22 2033 = 4670-11*-01, Year 50, Cycle 78 Wed Jul 23 2036
 * = 4673-06*-01, Year 53, Cycle 78 Wed Jun 22 2039 = 4676-05*-01, Year 56, Cycle 78 Sat Mar 22 2042
 * = 4679-02*-01, Year 59, Cycle 78 Tue Aug 23 2044 = 4681-07*-01, Year 01, Cycle 79 Sun Jun 23 2047
 * = 4684-05*-01, Year 04, Cycle 79 Thu Apr 21 2050 = 4687-03*-01, Year 07, Cycle 79 Mon Sep 23 2052
 * = 4689-08*-01, Year 09, Cycle 79 Sat Jul 24 2055 = 4692-06*-01, Year 12, Cycle 79 Wed May 22 2058
 * = 4695-04*-01, Year 15, Cycle 79 Wed Apr 20 2061 = 4698-03*-01, Year 18, Cycle 79 Fri Aug 24 2063
 * = 4700-07*-01, Year 20, Cycle 79 Wed Jun 23 2066 = 4703-05*-01, Year 23, Cycle 79 Tue May 21 2069
 * = 4706-04*-01, Year 26, Cycle 79 Thu Sep 24 2071 = 4708-08*-01, Year 28, Cycle 79 Tue Jul 24 2074
 * = 4711-06*-01, Year 31, Cycle 79 Sat May 22 2077 = 4714-04*-01, Year 34, Cycle 79 Sat Apr 20 2080
 * = 4717-03*-01, Year 37, Cycle 79 Mon Aug 24 2082 = 4719-07*-01, Year 39, Cycle 79 Fri Jun 22 2085
 * = 4722-05*-01, Year 42, Cycle 79 Fri May 21 2088 = 4725-04*-01, Year 45, Cycle 79 Sun Sep 24 2090
 * = 4727-08*-01, Year 47, Cycle 79 Thu Jul 23 2093 = 4730-06*-01, Year 50, Cycle 79 Tue May 22 2096
 * = 4733-04*-01, Year 53, Cycle 79 Sun Mar 22 2099 = 4736-02*-01, Year 56, Cycle 79
 */
...
public class ChineseTest extends CalendarTestFmwk {
    ...
    /**
     * Test formatting. Q: Why is this in Calendar tests instead of Format tests? Note: This test
     * assumes that Chinese calendar formatted dates can be parsed unambiguously to recover the
     * original Date that was formatted. This is not currently true since Chinese calendar formatted
     * dates do not include an era. To address this will require formatting/parsing of fields from
     * some other associated calendar, as per ICU ticket #9043. This test should be timebombed until
     * that ticket is addressed.
     */
    @Test
    public void TestFormat() {
        ChineseCalendar cal = new ChineseCalendar();
        DateFormat fmt =
                DateFormat.getDateTimeInstance(cal, DateFormat.DEFAULT, DateFormat.DEFAULT);
    ...
    /**
     * Test the behavior of ChineseCalendar.add(). The only real nastiness with roll is the MONTH
     * field around leap months.
     */
    @Test
    public void TestAdd() {
        int[][] tests =
    ...
    /**
     * Test the behavior of ChineseCalendar.roll(). The only real nastiness with roll is the MONTH
     * field around leap months.
     */
    @Test
    ...
    public void TestCoverage() {
...

        {
            ...
            if (cal.get(Calendar.YEAR) != 23
                    || cal.get(Calendar.MONTH) != Calendar.JULY
                    || cal.get(Calendar.IS_LEAP_MONTH) != 1
                    || cal.get(Calendar.DATE) != 2
                    || cal.get(Calendar.MILLISECONDS_IN_DAY) != 0) {
                errln(
                        "ChineseCalendar was initialized incorrectly with year,month,isLeapMonth,date");
            }
        }

        {
            // new ChineseCalendar(int year, int month, int isLeapMonth, int date, int hour, int
            // minute, int second)
            ChineseCalendar cal = new ChineseCalendar(23, Calendar.JULY, 1, 2, 12, 34, 56);
            if (cal == null) {
                errln(
                        "could not create ChineseCalendar with year,month,isLeapMonth,date,hour,minute,second");
            }
            // Make sure the given values are properly set
            if (cal.get(Calendar.YEAR) != 23
                    || cal.get(Calendar.MONTH) != Calendar.JULY
                ...
                errln(
                        "ChineseCalendar was initialized incorrectly with year,month,isLeapMonth,date,hour,minute,second");
            }
        }
    ...
    public void Test6510() {
        ...
        simpleDateFormat =
                new com.ibm.icu.text.SimpleDateFormat("MM/dd/yyyy G 'at' HH:mm:ss vvvv", Locale.US);
        ...
        // coverage
        assertEquals(
                "equivalent ChineseCalendar() constructors",
                chineseCalendar,
        ...
        if (chineseCalendar.getTimeInMillis() != chineseCalendar2.getTimeInMillis()) {
            ...
            errln(
                    "**PROBLEM Grego [MM/dd/y(G) HH:mm:ss] "
                            + simpleDateFormat.format(gregorianCalendar));
