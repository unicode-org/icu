...
public final class StringTokenizerTest extends CoreTestFmwk {
    ...
    public void TestConstructors() {
        ...
        String delimiter = " \t\n\r\f";
        String expected[] = {
            "this", "is", "a", "string", "testing", "StringTokenizer", "constructors!"
        };
        ...
        if (!(stdelimiterset1.nextElement().equals(str)))
            errln(
                    "Constructor with a UnicodeSet to ignoreWhiteSpace is "
        ...
        for (int i = 0; i < expected1.length; i++) {
            if (!(stdelimiterreturn.nextElement().equals(expected1[i])
                ...
                errln(
                        "Constructor with default delimiter and delimiter tokens gives wrong results");
            }
        }
    ...
    public void TestSupplementary() {
        ...
        delimiter = "\ud800";
        String expected1[] = {"bmp string ", " with a unmatched surrogate character"};
    ...
    public void TestNextNonDelimiterToken() {
        ...
        String expected[] = {",", "1", "2", "3", "AHHHHH!", "5.5", "6", "7", ",", "8\n"};
        String delimiter = " ";
        ...
        try {
            ...
            errln(
                    "StringTokenizer constructed with null source should throw a nullpointerexception");
        } catch (Exception e) {
    ...
    public void TestNextDelimiterToken() {
        ...
        if (!tokenizer.hasMoreElements()) {
            errln(
                    "String with only delimiters should have tokens when delimiter is treated as tokens");
        }
        if (!tokenizer.nextElement().equals(", ,")) {
            errln(
                    "String with only delimiters should return itself when delimiter is treated as tokens");
        }
    ...
    public void TestCountTokens() {
        ...
        for (int i = 0; i < expectedreturn.length; i++) {
            if (!streturn.nextElement().equals(expectedreturn[i])
                ...
                errln(
                        "CountTokens with default delimiter and delimiter tokens gives wrong results");
            }
        }
    }
    ...
    public void TestNextNewDelimiters() {
        ...
        for (int i = 0; i < size; i++) {
            for (int j = 0; j < delimiter.length; j++) {
                ...
                if (st.countTokens() != expected[j].length - i) {
                    errln("countTokens() after nextToken() with delimiters error" + i + " " + j);
                }
            }
        }
        ...
        String expected1[] = {
            "abc", "def1ghi", "jkl3mno", "pqr", "stu1vwx",
            "yza3bcd", "efg", "hij1klm", "nop3qrs", "tuv"
        };
        for (int i = 0; i < expected1.length; i++) {
            if (!st.nextToken(delimiter1[i % delimiter1.length]).equals(expected1[i])) {
        ...
        for (int i = 1; i < 250; i++) {
            ...
            while (tzb.hasMoreTokens()) {
                ...
                if (tok.equals(Integer.toString(j)) == false) {
                    errln("Wrong token string.  Expected \"" + j + "\", got \"" + tok + "\".");
                    break;
                }
            }
            if (j != i) {
    ...
    public void TestMatches() {
        ...
        if (us.matches(null, offset, limit, true) != UnicodeSet.U_PARTIAL_MATCH) {
            errln(
                    "UnicodeSet.matches is supposed to return "
                            + UnicodeSet.U_PARTIAL_MATCH
                            + " but got "
                            + us.matches(null, offset, limit, true));
        }
        ...
        if (us.matches(null, offset, limit, false) != UnicodeSet.U_MATCH) {
            errln(
                    "UnicodeSet.matches is supposed to return "
                            + UnicodeSet.U_MATCH
                            + " but got "
                            + us.matches(null, offset, limit, false));
        }
    ...
    public void TestIndexOf() {
        ...
        UnicodeSet us = new UnicodeSet();
        int[] invalid = {
            UnicodeSet.MIN_VALUE - 1,
            UnicodeSet.MIN_VALUE - 2,
            UnicodeSet.MAX_VALUE + 1,
            UnicodeSet.MAX_VALUE + 2
        };
        int[] valid = {
        ...
        for (int i = 0; i < invalid.length; i++) {
            try {
                ...
                errln(
                        "UnicodeSet.indexOf is supposed to return an exception "
                                + "for a value of "
                                + invalid[i]);
            } catch (Exception e) {
            }
        ...
        for (int i = 0; i < valid.length; i++) {
            try {
                ...
                errln(
                        "UnicodeSet.indexOf is not supposed to return an exception "
                                + "for a value of "
                                + valid[i]);
            }
        }
    ...
    public void TestCharAt() {
        ...
        for (int i = 0; i < invalid.length; i++) {
            if (us.charAt(invalid[i]) != -1) {
                errln(
                        "UnicodeSet.charAt(int index) was supposed to return -1 "
                                + "for an invalid input of "
                                + invalid[i]);
            }
        }
    }
    ...
    public void TestAdd_int_int() {
        ...
        for (int i = 0; i < invalid.length; i++) {
            try {
                ...
                errln(
                        "UnicodeSet.add(int start, int end) was supposed to give "
        ...
        if (!(us.add(UnicodeSet.MIN_VALUE + 1, UnicodeSet.MIN_VALUE).equals(us)))
            errln(
                    "UnicodeSet.add(int start, int end) was supposed to return "
                            + "the same object because start of value "
                            + (UnicodeSet.MIN_VALUE + 1)
                            + " is greater than end of value "
                            + UnicodeSet.MIN_VALUE);
    ...
    public void TestAdd_int() {
        ...
        for (int i = 0; i < invalid.length; i++) {
            try {
                us.add(invalid[i]);
                errln(
                        "UnicodeSet.add(int c) was supposed to give "
                                + "an exception for an start invalid input of "
                                + invalid[i]);
            } catch (Exception e) {
            }
    ...
    public void TestGetSingleCP() {
        ...
        try {
            ...
            errln(
                    "UnicodeSet.getSingleCP is not supposed to give an exception for "
                            + "an empty string.");
        }
        ...
        try {
            ...
            errln(
                    "UnicodeSet.getSingleCP is supposed to give an exception for "
                            + "a null string.");
        } catch (Exception e) {
        }
    ...
    public void TestRemoveAllString() {
        ...
        try {
            ...
            errln(
                    "UnicodeSet.removeAllString() was not supposed to given an "
    ...
    public void TestRetain_int_int() {
        ...
        for (int i = 0; i < invalid.length; i++) {
            try {
                ...
                errln(
                        "UnicodeSet.retain(int start, int end) was supposed to give "
                                + "an exception for an start invalid input of "
                                + invalid[i]);
            } catch (Exception e) {
            }
        ...
        try {
            ...
            errln(
                    "UnicodeSet.retain(int start, int end) was not supposed to give "
                            + "an exception.");
        }
    ...
    public void TestRetain_String() {
        ...
        if (!(us.retain("dummy").equals(us))) {
            errln(
                    "UnicodeSet.retain(String s) was supposed to return the "
    ...
    public void TestRemove() {
        ...
        for (int i = 0; i < invalid.length; i++) {
            try {
                ...
                errln(
                        "UnicodeSet.remove(int start, int end) was supposed to give "
                                + "an exception for an start invalid input of "
                                + invalid[i]);
            } catch (Exception e) {
            }
        ...
        try {
            ...
            errln(
                    "UnicodeSet.remove(int start, int end) was not supposed to give "
                            + "an exception.");
        }
    ...
    public void TestComplement_int_int() {
        ...
        for (int i = 0; i < invalid.length; i++) {
            try {
                ...
                errln(
                        "UnicodeSet.complement(int start, int end) was supposed to give "
                                + "an exception for an start invalid input of "
                                + invalid[i]);
            } catch (Exception e) {
            }
        ...
        try {
            ...
            errln(
                    "UnicodeSet.complement(int start, int end) was not supposed to give "
                            + "an exception.");
        }
    ...
    public void TestComplement_String() {
        ...
        try {
            ...
            errln(
                    "UnicodeSet.complement(String s) was not supposed to give "
    ...
    public void TestContains_int() {
        ...
        for (int i = 0; i < invalid.length; i++) {
            try {
                ...
                errln(
                        "UnicodeSet.contains(int c) was supposed to give "
                                + "an exception for an start invalid input of "
                                + invalid[i]);
            } catch (Exception e) {
            }
    ...
    public void TestContains_int_int() {
        ...
        for (int i = 0; i < invalid.length; i++) {
            try {
                ...
                errln(
                        "UnicodeSet.contains(int start, int end) was supposed to give "
                                + "an exception for an start invalid input of "
                                + invalid[i]);
            } catch (Exception e) {
            }
    ...
    public void TestGetRegexEquivalent() {
        ...
        if (!(res.equals("[]")))
            errln("UnicodeSet.getRegexEquivalent is supposed to return '[]' " + "but got " + res);
    }
    ...
    public void TestContainsNone() {
        ...
        for (int i = 0; i < invalid.length; i++) {
            try {
                ...
                errln(
                        "UnicodeSet.containsNoneint start, int end) was supposed to give "
                                + "an exception for an start invalid input of "
                                + invalid[i]);
            } catch (Exception e) {
            }
        ...
        for (int i = 0; i < invalid.length; i++) {
            try {
                ...
                errln(
                        "UnicodeSet.containsNone(int start, int end) was supposed to give "
                                + "an exception for an end invalid input of "
                                + invalid[i]);
            } catch (Exception e) {
            }
        ...
        try {
            ...
            errln(
                    "UnicodeSet.containsNone(int start, int end) was not supposed to give "
                            + "an exception.");
        }
    }
}
