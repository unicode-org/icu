...
public class BreakIteratorTest extends CoreTestFmwk {
    ...
    public void TestBug4153072() {
        ...
        for (int index = -1; index < begin + 1; ++index) {
            try {
                ...
                if (index < begin)
                    errln(
                            "Didn't get exception with offset = "
                                    + index
                                    + " and begin index = "
                                    + begin);
            } catch (IndexOutOfBoundsException e) {
                if (index >= begin)
                    errln("Got exception with offset = " + index + " and begin index = " + begin);
            }
        }
    }
    ...
    public void TestGetAvailableLocales() {
        ...
        if (locList.length == 0) errln("getAvailableLocales() returned an empty list!");
    ...
    public void TestEndBehavior() {
        ...
        if (wb.first() != 0) errln("Didn't get break at beginning of string.");
        if (wb.next() != 3) errln("Didn't get break before period in \"boo.\"");
        if (wb.current() != 4 && wb.next() != 4) errln("Didn't get break at end of string.");
    }
    ...
    public void TestFilteredJapanese() {
        ...
        BreakIterator brk =
                FilteredBreakIteratorBuilder.getInstance(loc)
    ...
    public void TestFilteredBreakIteratorBuilder() {
        ...
        String text =
                "In the meantime Mr. Weston arrived with his small ship, which he had now recovered. Capt. Gorges, who informed the Sgt. here that one purpose of his going east was to meet with Mr. Weston, took this opportunity to call him to account for some abuses he had to lay to his charge."; // (William Bradford, public domain. http://catalog.hathitrust.org/Record/008651224 ) - edited.
        String ABBR_MR = "Mr.";
...

        {
            ...
            filteredBI =
                    BreakIterator.getSentenceInstance(
                            ULocale.forLanguageTag("en-US-u-ss-standard"));
...

        {
            ...
            filteredBI =
                    BreakIterator.getSentenceInstance(ULocale.forLanguageTag("af-u-ss-standard"));
...

        {
            ...
            filteredBI =
                    BreakIterator.getSentenceInstance(ULocale.forLanguageTag("ja-u-ss-standard"));
        ...
        }
        {
            ...
            filteredBI =
                    BreakIterator.getSentenceInstance(ULocale.forLanguageTag("tfg-u-ss-standard"));
