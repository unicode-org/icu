...
/**
 * Copyright (C) 2007-2016, International Business Machines Corporation and Others. All Rights
 * Reserved. *
 */
...
public class DebugUtilitiesData extends Object {
    public static final String ICU4C_VERSION = "79.0.1";
    ...
    public static final int[][] VALUES = {
        /* UDebugEnumType, 0 */
        {
            0, /* UDebugEnumType */ 1, /* UCalendarDateFields */ 2, /* UCalendarMonths */
            3, /* UDateFormatStyle */ 4, /* UAcceptResult */ 5, /* UColAttributeValue */
        },
        /* UCalendarDateFields, 1 */
        {
        ...
        /* UAcceptResult, 4 */
        {
            0, /* FAILED */ 1, /* VALID */ 2, /* FALLBACK */
        },
        /* UColAttributeValue, 5 */
        {
            0, /* PRIMARY */ 1, /* SECONDARY */ 2, /* TERTIARY */ 3, /* QUATERNARY */
            4, /* IDENTICAL */ 5, /* OFF */ 6, /* ON */ 7, /* SHIFTED */ 8, /* NON_IGNORABLE */
            9, /* LOWER_FIRST */ 10, /* UPPER_FIRST */
        },
    };
}
