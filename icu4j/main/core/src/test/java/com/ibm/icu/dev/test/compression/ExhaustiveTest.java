...
public class ExhaustiveTest extends CoreTestFmwk {
    ...
    private void myTest(char[] chars, int len) {
        ...
        myByteCount =
                myCompressor.compress(
                        chars, 0, len, unicharsRead, myCompressed, 0, myCompressedSize);
    ...
    private boolean logDiffs(char[] s1, int s1len, char[] s2, int s2len) {
        ...
        if (s1len != s2len) {
            logln("====================");
            logln("Length doesn't match: expected " + s1len + ", got " + s2len);
            logln("Expected:");
            printChars(s1, s1len);
            logln("Got:");
            printChars(s2, s2len);
    ...
    // Compression modes
    // ==========================
    private static final int SINGLEBYTEMODE = 0;
    private static final int UNICODEMODE = 1;

    // ==========================
    // Single-byte mode tags
    // ==========================
    private static final int SDEFINEX = 0x0B;
    // private final static int SRESERVED                  = 0x0C;             // this is a reserved
    // value
    private static final int SQUOTEU = 0x0E;
    private static final int SSWITCHU = 0x0F;

    private static final int SQUOTE0 = 0x01;
    private static final int SQUOTE1 = 0x02;
    private static final int SQUOTE2 = 0x03;
    private static final int SQUOTE3 = 0x04;
    private static final int SQUOTE4 = 0x05;
    private static final int SQUOTE5 = 0x06;
    private static final int SQUOTE6 = 0x07;
    private static final int SQUOTE7 = 0x08;

    private static final int SSWITCH0 = 0x10;
    private static final int SSWITCH1 = 0x11;
    private static final int SSWITCH2 = 0x12;
    private static final int SSWITCH3 = 0x13;
    private static final int SSWITCH4 = 0x14;
    private static final int SSWITCH5 = 0x15;
    private static final int SSWITCH6 = 0x16;
    private static final int SSWITCH7 = 0x17;

    private static final int SDEFINE0 = 0x18;
    private static final int SDEFINE1 = 0x19;
    private static final int SDEFINE2 = 0x1A;
    private static final int SDEFINE3 = 0x1B;
    private static final int SDEFINE4 = 0x1C;
    private static final int SDEFINE5 = 0x1D;
    private static final int SDEFINE6 = 0x1E;
    private static final int SDEFINE7 = 0x1F;

    // ==========================
    // Unicode mode tags
    // ==========================
    private static final int USWITCH0 = 0xE0;
    private static final int USWITCH1 = 0xE1;
    private static final int USWITCH2 = 0xE2;
    private static final int USWITCH3 = 0xE3;
    private static final int USWITCH4 = 0xE4;
    private static final int USWITCH5 = 0xE5;
    private static final int USWITCH6 = 0xE6;
    private static final int USWITCH7 = 0xE7;

    private static final int UDEFINE0 = 0xE8;
    private static final int UDEFINE1 = 0xE9;
    private static final int UDEFINE2 = 0xEA;
    private static final int UDEFINE3 = 0xEB;
    private static final int UDEFINE4 = 0xEC;
    private static final int UDEFINE5 = 0xED;
    private static final int UDEFINE6 = 0xEE;
    private static final int UDEFINE7 = 0xEF;

    private static final int UQUOTEU = 0xF0;
    private static final int UDEFINEX = 0xF1;

    // private final static int URESERVED                      = 0xF2;         // this is a reserved
    // value
