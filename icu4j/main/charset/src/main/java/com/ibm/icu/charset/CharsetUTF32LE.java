...
/**
 * The purpose of this class is to set isBigEndian to false and isEndianSpecified to true in the
 * super class, and to allow the Charset framework to open the variant UTF-32 converter without
 * extra setup work.
 */
