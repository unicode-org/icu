...
public class RbnfTest extends TestFmwk {
    ...
    public void TestFrenchSpellout() {
        ...
        String[][] testData = {
                ...
                { "5,000", "cinq mille" },
                { "7,634", "sept mille six cent trente-quatre" },
                { "11,000", "onze mille" },
                { "15,000", "quinze mille" },
                { "15,943", "quinze mille neuf cent quarante-trois" },
                { "21,000", "vingt-et-un mille" },
                { "24,190", "vingt-quatre mille cent quatre-vingt-dix" },
                { "80,000", "quatre-vingt mille" },
                { "100,000", "cent mille" },
                { "123,454", "cent vingt-trois mille quatre cent cinquante-quatre" },
                { "200,000", "deux cent mille" },
                { "653,000", "six cent cinquante-trois mille" },
                ...
                { "23,437,219", "vingt-trois millions quatre cent trente-sept mille deux cent dix-neuf" },
                ...
                { "371,089,890", "trois cent soixante-et-onze millions quatre-vingt-neuf mille huit cent quatre-vingt-dix" },
                { "541,980,700", "cinq cent quarante-et-un millions neuf cent quatre-vingt mille sept cents" },
                { "1,000,000,000", "un milliard" },
                { "2,023,437,280", "deux milliards vingt-trois millions quatre cent trente-sept mille deux cent quatre-vingts" },
