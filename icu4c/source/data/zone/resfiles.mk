...
ZONE_SYNTHETIC_ALIAS = az_AZ.txt en_RH.txt ha_GH.txt ha_NE.txt\
...
ZONE_SOURCE = af.txt agq.txt ak.txt am.txt\
 ...
 en_GB.txt en_GU.txt en_HK.txt en_IN.txt en_NZ.txt\
 ...
 haw.txt he.txt he_IL.txt hi.txt hr.txt\
 hu.txt hy.txt id.txt id_ID.txt ig.txt\
 ii.txt is.txt it.txt ja.txt ja_JP.txt\
 ...
 naq.txt nb.txt nb_NO.txt nd.txt ne.txt\
 nl.txt nmg.txt nn.txt nn_NO.txt nus.txt\
 ...
 sr_Latn_BA.txt sr_Latn_RS.txt sv.txt sw.txt swc.txt\
