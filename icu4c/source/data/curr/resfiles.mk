...
CURR_SOURCE = af.txt ak.txt am.txt ar.txt\
 ...
 fil_PH.txt fo.txt fr.txt fr_CA.txt fr_LU.txt\
 ...
 ms_BN.txt mt.txt naq.txt nb.txt nd.txt\
 ne.txt ne_IN.txt nl.txt nn.txt nyn.txt\
 ...
 zh_Hans.txt zh_Hans_CN.txt zh_Hans_HK.txt zh_Hans_SG.txt zh_Hant.txt\
