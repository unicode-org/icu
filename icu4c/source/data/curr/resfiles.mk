...
CURR_SOURCE = af.txt af_NA.txt agq.txt ak.txt\
 ...
 en_ZM.txt eo.txt es.txt es_AR.txt es_BO.txt\
 ...
 ms_Latn_BN.txt mt.txt mua.txt my.txt naq.txt\
 nb.txt nd.txt ne.txt ne_IN.txt nl.txt\
 nl_AW.txt nl_CW.txt nl_SX.txt nmg.txt nn.txt\
 ...
 so_DJ.txt so_ET.txt so_KE.txt sq.txt sr.txt\
 sr_Cyrl.txt sr_Cyrl_BA.txt sr_Latn.txt sv.txt sw.txt\
