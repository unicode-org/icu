...
GENRB_SYNTHETIC_ALIAS = az_AZ.txt bs_BA.txt en_NH.txt en_RH.txt\
 ...
 mo.txt ms_BN.txt ms_MY.txt ms_SG.txt no.txt\
 no_NO.txt no_NO_NY.txt pa_IN.txt pa_PK.txt sh.txt\
 sh_BA.txt sh_CS.txt sh_YU.txt shi_MA.txt sr_BA.txt\
 sr_CS.txt sr_Cyrl_CS.txt sr_Cyrl_YU.txt sr_Latn_CS.txt sr_Latn_YU.txt\
