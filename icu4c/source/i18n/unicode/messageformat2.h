...
namespace message2 {
    ...
    private:
        ...
        [[nodiscard]] InternalValue evalExpression(const Environment&, const data_model::Expression&, MessageContext&, UErrorCode&) const;
        [[nodiscard]] FunctionOptions resolveOptions(const Environment& env, const OptionMap&, MessageContext&, UErrorCode&) const;
        [[nodiscard]] InternalValue evalOperand(const Environment&, const data_model::Operand&, MessageContext&, UErrorCode&) const;
        ...
        FunctionFactory* lookupFunctionFactory(const FunctionName&, UErrorCode&) const;
