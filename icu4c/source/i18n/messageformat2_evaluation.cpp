...
UBool FunctionOptions::getFunctionOption(const std::u16string_view key, Formattable& option) const {
    if (options == nullptr) {
...
UnicodeString FunctionOptions::getStringFunctionOption(const std::u16string_view key) const {
    Formattable option;
