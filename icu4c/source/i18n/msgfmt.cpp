...
int32_t MessageFormat::skipLeadingSpaces(UnicodeString& style) {
    int32_t i = 0;
...
Format* MessageFormat::createAppropriateFormat(UnicodeString& type, UnicodeString& style,
    ...
    case 0: // number
        ...
        default: // pattern or skeleton
            first_non_space = skipLeadingSpaces(style);
            if (style.compare(first_non_space, 2, u"::", 0, 2) == 0) {
                // Skeleton
                UnicodeString skeleton = style.tempSubString(first_non_space + 2);
