...
class TestCase : public UMemory {
    ...
    /* const */ UMFBidiIsolationStrategy bidiIsolationStrategy;
    ...
    UMFBidiIsolationStrategy getBidiIsolationStrategy() const {
    ...
    class Builder : public UObject {
        ...
        Builder& setBidiIsolationStrategy(UMFBidiIsolationStrategy s) {
        ...
        uint32_t offset;
        bool ignoreError;
        UMFBidiIsolationStrategy bidiIsolationStrategy;
