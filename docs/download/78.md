...
**Note: The [ICU 78.3 maintenance update](#icu-783-maintenance-release) (see below) was released on 2026-03-17.**

* Download: [releases/tag/release-78.3](https://github.com/unicode-org/icu/releases/tag/release-78.3)
...
Beginning with CLDR 49 / ICU 79 (2026-oct) or later,
CLDR and ICU are planning to make changes in
...
### ICU 78.3 maintenance release

Release date: 2026-03-17

ICU 78.3 mostly updates to [CLDR 48.2](https://cldr.unicode.org/downloads/cldr-48#482-changes).
ICU 78.3 also includes a small bug fix (on top of ICU 78.2 and 78.1),
as well as a minor update for time zone data (tzdata) version 2026a (2026-mar)
[ICU-23330](https://unicode-org.atlassian.net/browse/ICU-23330).
  * [List of tickets fixed in ICU 78.3](https://unicode-org.atlassian.net/issues/?jql=project%20%3D%20ICU%20AND%20status%20%3D%20Done%20AND%20resolution%20in%20%28Fixed%2C%20%22Fixed%20by%20Other%20Ticket%22%29%20AND%20fixVersion%20%3D%2078.3%20ORDER%20BY%20component%20ASC%2C%20created%20DESC)

Changes in ICU 78.3:

* C++ [ICU-23319](https://unicode-org.atlassian.net/browse/ICU-23319) “utfiterator.h causes level 1 MSVC warning C4715”
  * Explicit handling of invalid `enum UTFIllFormedBehavior` values.
* [List of all tickets fixed in ICU 78.3](https://unicode-org.atlassian.net/projects/ICU/versions/10641/tab/release-report-all-issues)

### ICU 78.2 maintenance release

Release date: 2026-01-08 ([blog](https://blog.unicode.org/2026/01/unicode-icu-782-and-cldr-481-released.html))
...
* [API changes since ICU4C 77 (Markdown)](https://github.com/unicode-org/icu/blob/maint/maint-78/icu4c/APIChangeReport.md) /
  ...
  * Additional Unicode helper APIs
    ...
    * ([unicode/utf.h](https://unicode-org.github.io/icu-docs/apidoc/released/icu4c/utf_8h.html),
      [unicode/utf8.h](https://unicode-org.github.io/icu-docs/apidoc/released/icu4c/utf8_8h.html)):
      U_IS_CODE_POINT(cp), U_IS_SCALAR_VALUE(cp), U8_LENGTH_FROM_LEAD_BYTE\[_UNSAFE\]
    * ([icu::UnicodeString](https://unicode-org.github.io/icu-docs/apidoc/released/icu4c/classicu_1_1UnicodeString.html)):
    ...
    * (new [unicode/utfiterator.h](https://unicode-org.github.io/icu-docs/apidoc/released/icu4c/utfiterator_8h.html)):
      “Range” classes AllCodePoints & AllScalarValues
    * (new [unicode/utfstring.h](https://unicode-org.github.io/icu-docs/apidoc/released/icu4c/utfstring_8h.html)):
...
* [API Changes since ICU4J 77](https://htmlpreview.github.io/?https://github.com/unicode-org/icu/blob/maint/maint-78/icu4j/APIChangeReport.html)
  * New Segmenter API which is easier and safer to use than BreakIterator.
    ...
    See [package com.ibm.icu.segmenter](https://unicode-org.github.io/icu-docs/apidoc/released/icu4j/com/ibm/icu/segmenter/package-summary.html),
    [interface Segmenter](https://unicode-org.github.io/icu-docs/apidoc/released/icu4j/com/ibm/icu/segmenter/Segmenter.html)
  ...
  * Additional Unicode helper functions
    ([class UCharacter](https://unicode-org.github.io/icu-docs/apidoc/released/icu4j/com/ibm/icu/lang/UCharacter.html)):
...
* 78.3: <https://github.com/unicode-org/icu/releases/tag/release-78.3>
...
* 78.3:
    * <https://github.com/unicode-org/cldr/releases/tag/release-48-2>
    * <https://github.com/unicode-org/cldr-staging/releases/tag/release-48-2>
* 78.2:
...
### Maven
* <https://mvnrepository.com/artifact/com.ibm.icu/icu4j/78.3>
