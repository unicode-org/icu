...
UCA Tailoring: & C < č <<< Č < ć <<< Ć CUKIĆ RADOJICA
ČUKIĆ SLOBODAN
CUKIĆ SVETOZAR
ČUKIĆ ZORAN
CURIĆ MILOŠ
...
*   For Chinese, use script code `Han`**`i`**, *not* `Han`**`s`** or
    `Han`**`t`**.
...
Several other syntactical elements are needed in more specific situations. These
