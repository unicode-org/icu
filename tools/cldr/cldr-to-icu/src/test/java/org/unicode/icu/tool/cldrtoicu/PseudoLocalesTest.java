...
public class PseudoLocalesTest {
    ...
    public void testExpansion() {
        ...
        CldrPath included = ldmlPath("localeDisplayNames/languages/language[@type=\"xx\"]");
        CldrPath excluded =
                ldmlPath("localeDisplayNames/localeDisplayPattern/localePattern[@alt=\"testing\"]");
        CldrPath pattern = ldmlPath("dates/timeZoneNames/hourFormat[@alt=\"testing\"]");
        CldrPath narrow =
                ldmlPath("dates/fields/field[@type=\"sun-narrow\"]/relative[@type=\"0\"]");
        CldrPath inherited = ldmlPath("dates/timeZoneNames/zone[@type=\"Etc/UTC\"]/short/standard");
        ...
        FakeDataSupplier src =
                new FakeDataSupplier()
                        ...
                        // Root is the eventual parent of everything but its value should not
                        // appear, even
    ...
    public void testExemplars() {
        ...
        assertValuesUnordered(
                pseudo.getDataForLocale("ar_XB", UNRESOLVED),
                value(
                        exemplarsPath,
                        "[a b c d e f g h i j k l m n o p q r s t u v w x y z \\u061C \\u202E \\u202C]"));
        assertValuesUnordered(
                pseudo.getDataForLocale("en_XA", UNRESOLVED),
                value(
                        exemplarsPath,
