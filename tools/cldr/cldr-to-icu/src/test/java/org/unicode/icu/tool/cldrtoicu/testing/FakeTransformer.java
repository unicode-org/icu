...
public final class FakeTransformer extends PathValueTransformer {
    ...
    @Override
    public ImmutableList<Result> transform(CldrValue value, DynamicVars ignored) {
        return resultMap.getOrDefault(value, ImmutableList.of());
    }

    @Override
    public ImmutableList<Result> getFallbackResultsFor(RbPath key, DynamicVars ignored) {
