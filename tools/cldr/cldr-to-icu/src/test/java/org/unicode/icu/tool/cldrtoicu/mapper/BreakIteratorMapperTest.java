...
public class BreakIteratorMapperTest {
    ...
    public void testSingleSuppression() {
        ...
        assertThat(icuData)
                .hasValuesFor(
                        "/exceptions/SentenceBreak:array",
                        RbValue.of("L.P."),
                        RbValue.of("Alt."),
                        RbValue.of("Approx."));
    }
    ...
    public void testSpecials_dictionary() {
        CldrData specials =
                cldrData(dictionary("foo", "<foo deps>"), dictionary("bar", "<bar deps>"));
    ...
    public void testSpecials_boundaries() {
        ...
        assertThat(icuData)
                .hasValuesFor(
                        "/boundaries/sentence_altName:process(dependency)", "<sentence deps>");
    }
