...
public class TransformsMapperTest {
    ...
    private static final ImmutableList<String> HEADER_LINES =
            ImmutableList.of("First header line", "Second header line");
    ...
    public void testDefaultContent() {
        ...
        assertThat(icuData)
                .hasValuesFor(
                        "/RuleBasedTransliteratorIDs/Digit-Tone/alias", "NumericPinyin-Pinyin");
        assertThat(icuData)
                .hasValuesFor(
                        "/RuleBasedTransliteratorIDs/Tone-Digit/alias", "Pinyin-NumericPinyin");
    ...
    public void testForward() {
        ...
        CldrData cldrData =
                cldrData(
                        oneWay("foo", "bar", FORWARD, null, INTERNAL, "first second third", ++idx));
    ...
    public void testBackward() {
        ...
        assertThat(icuData)
                .hasValuesFor("RuleBasedTransliteratorIDs/three/alias", "bar-foo/variant");
        ...
        assertThat(icuData)
                .hasValuesFor(
                        prefix.extendBy("resource:process(transliterator)"), "foo_bar_variant.txt");
