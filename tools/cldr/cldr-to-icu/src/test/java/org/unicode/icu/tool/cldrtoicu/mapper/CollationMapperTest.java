...
public class CollationMapperTest {
    ...
    public void testCommentAndWhitespaceStripping() {
        ...
        CollationMapper.process(icuData, cldrData, Optional.empty(), CLDR_VERSION);
        assertThat(icuData)
                .hasValuesFor("/collations/foo/Sequence", "Here is a value", "And another value");
    }
        ...
        CldrData specials =
                cldrData(
                        CldrValue.parseValue(
                                "//ldml/special/icu:UCARules[@icu:uca_rules=\"special rule\"]", ""),
                        CldrValue.parseValue(
                                "//ldml/special/icu:depends[@icu:dependency=\"special deps\"]",
                                ""));
