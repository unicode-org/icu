...
public class CleanOutputDirectoryTaskTest {
    ...
    private static final ImmutableList<String> HEADER =
            ImmutableList.of("Header#1", "Header#2", WAS_GENERATED_LABEL);
    ...
    public void testWasFileAutoGenerated_lenientMatching() throws IOException {
        ...
        assertWasAutogenerated("//    Header#1", "//Header#2").isTrue();
        // Extra lines
        assertWasAutogenerated("// Header#1", "// Header#2", "// More comment", "Not a comment")
                .isTrue();
    ...
    public void testWasFileAutoGenerated_withLabel() throws IOException {
        ...
        assertWasAutogenerated(
                        "// This", "// Is", "// A", "// Longer", "// Header", WAS_GENERATED_LINE)
                .isTrue();
        assertWasAutogenerated("// Where the label is", WAS_GENERATED_LINE, "// Does not matter")
                .isTrue();
    ...
    public void testWasFileAutoGenerated_matchingEndsAfterComments() throws IOException {
        ...
        assertWasAutogenerated(
                        "// Header#1", "// Header#Changed", "Not a comment", WAS_GENERATED_LINE)
                .isFalse();
    }
