...
public class SupplementalDataTest {
    ...
    public void testMaximize() {
        SupplementalData fakeData =
                fakeSupplementalData(
    ...
    public void testReplaceDeprecatedTags_regression() {
        ...
        for (String id : TEST_LOCALE_IDS) {
            ...
            assertWithMessage("id=%s", id)
                    .that(
                            regressionData
                                    .maximize(regressionData.replaceDeprecatedTags(id))
                                    .orElse(null))
    ...
    private static final ImmutableSet<String> TEST_LOCALE_IDS =
            ImmutableSet.of(
                    "af",
                    "af_NA",
                    "af_ZA",
    ...
    private static CldrValue likelySubtag(String from, String to) {
        return supplementalData("likelySubtags/likelySubtag[@from=\"%s\"][@to=\"%s\"]", from, to);
    }

    private static CldrValue languageAlias(String type, String replacement) {
        return supplementalData(
                "metadata/alias/languageAlias[@type=\"%s\"][@replacement=\"%s\"]",
                type, replacement);
    }
    ...
    private static CldrValue territoryAlias(String type, String replacement) {
        return supplementalData(
                "metadata/alias/territoryAlias[@type=\"%s\"][@replacement=\"%s\"]",
                type, replacement);
    }
