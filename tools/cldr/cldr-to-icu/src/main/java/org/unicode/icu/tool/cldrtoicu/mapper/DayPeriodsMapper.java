...
/**
 * A mapper to collect day-period data from {@link CldrDataType#SUPPLEMENTAL SUPPLEMENTAL} data via
 * the paths:
 *
 * <pre>{@code
...
public final class DayPeriodsMapper {
    ...
    static {
        ...
        processor
                .addAction("//supplementalData/dayPeriodRuleSet", (m, p) -> m.new Ruleset(p))
