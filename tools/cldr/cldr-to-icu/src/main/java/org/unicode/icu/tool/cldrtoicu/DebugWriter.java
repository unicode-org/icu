...
/**
 * Utility to allow any "mapper" class to trivially support a main method and useful logging
 * behaviour to help avoid the need for ad-hoc logging via {@code System.out}.
 *
 ...
 * }</pre>
 *
 * <p>Note however that running this still requires that the {@code CLDR_DIR} system property is
 * set.
 */
public final class DebugWriter {
    ...
    /**
     * Writes the IcuData generated by the given function using the default {@code CLDR_DIR} system
     * property.
     *
     * <p>This is a helper method to make it easy for each mapper to have its own main method for
     * debugging, and it should not be used directly by {@code LdmlConverter}.
     */
    ...
    public static void writeMultipleForDebugging(
            String[] args, Function<CldrDataSupplier, Collection<IcuData>> fn) throws IOException {
