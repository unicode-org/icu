...
class Cldr2IcuCliOptions {
    ...
    private static final String ICU_DIR_DESC =
            "Path top level ICU directory"
    ...
    private static final String CLDR_DIR_DESC =
            "This is the path to the to root of standard CLDR sources,"
    ...
    private static final String CLDR_DATA_DIR_DESC =
            "The top-level directory for the CLDR production data"
    ...
    private static final String OUT_DIR_DEFAULT = "${icuDir}/icu4c/source/data";
    String outDir;

    private static final String GEN_C_CODE_DIR = "genCCodeDir";
    private static final String GEN_C_CODE_DIR_DESC =
            "The output directory into which to write generated C/C++ code."
    ...
    private static final String GEN_JAVA_CODE_DIR_DESC =
            "The output directory into which to write generated Java code."
    ...
    private static final String DONT_GEN_CODE_DESC =
            "Set this to prevent the generation of ICU source files";
    private static final String DONT_GEN_CODE_DEFAULT = "false";
    boolean dontGenCode;

    private static final String SPECIALS_DIR = "specialsDir";
    private static final String SPECIALS_DIR_DESC =
    ...
    private static final String ICU_VERSION_DESC =
    ...
    private static final String ICU_DATA_VERSION_DESC =
    ...
    private static final String CLDR_VERSION_DESC =
            "An override for the CLDR version string (`icuver.txt` and others)."
    ...
    private static final String MIN_DRAFT_STATUS_DESC =
            "The minimum draft status for CLDR data to be used in the conversion."
    ...
    private static final String LOCALE_ID_FILTER_DESC =
            "A regular expression to match the locale IDs to be generated"
    ...
    private static final String INCLUDE_PSEUDO_LOCALES_DESC =
    ...
    private static final String EMIT_REPORT_DESC =
            "Whether to emit a debug report containing some possibly"
    ...
    private static final String OUTPUT_TYPES_DESC =
            "List of output \"types\" to be generated (e.g. `rbnf,plurals,locales`);"
                    ...
                    // It would be nice to initialize this from OutputType, but to do that we need
                    // to read an XML file,
                    // so we need to know what the cldrDir folder is. But we only know that AFTER we
    ...
    private static final String OUTPUT_TYPES_LIST_DESC =
            "Show the complete list of knonw output types and exit.";
    private static final String OUTPUT_TYPES_LIST_DEFAULT = "false";

    private static final String FORCE_DELETE = "forceDelete";
    private static final String FORCE_DELETE_DESC =
            "Specify to force the 'clean' task to delete files it cannot"
    ...
    private static final String XML_CONFIG_DESC =
            "Override to force the 'clean' task to delete files it cannot"
                    + " determine to be auto-generated by this tool. This is useful if the file header changes since"
                    + " the heading is what's used to recognize auto-generated files.";
    ...
    private static final String PARALLEL_DESC =
            "Run the generation in parallel (multithreaded), to make it faster.";
    ...
    private static final Options options =
            new Options()
                    .addOption(Option.builder().longOpt(HELP).desc(HELP_DESC).build())
                    .addOption(
                            Option.builder()
                                    .longOpt(ICU_DIR)
                                    .hasArg()
                    ...
                    .addOption(
                            Option.builder()
                                    ...
                                    .desc(
                                            descWithDefault(
                                                    CLDR_DATA_DIR_DESC, CLDR_DATA_DIR_DEFAULT))
                                    .build())
                    .addOption(
                            Option.builder()
                                    .longOpt(OUT_DIR)
                    ...
                    .addOption(
                            Option.builder()
                                    ...
                                    .desc(
                                            descWithDefault(
                                                    GEN_C_CODE_DIR_DESC, GEN_C_CODE_DIR_DEFAULT))
                                    .build())
                    .addOption(
                            Option.builder()
                                    ...
                                    .desc(
                                            descWithDefault(
                                                    GEN_JAVA_CODE_DIR_DESC,
                                                    GEN_JAVA_CODE_DIR_DEFAULT))
                                    .build())
                    .addOption(
                            Option.builder()
                                    ...
                                    .desc(
                                            descWithDefault(
                                                    DONT_GEN_CODE_DESC, DONT_GEN_CODE_DEFAULT))
                                    .build())
                    .addOption(
                            Option.builder()
                    ...
                    .addOption(
                            Option.builder()
                                    ...
                                    .desc(
                                            descWithDefault(
                                                    OUTPUT_TYPES_LIST_DESC,
                                                    OUTPUT_TYPES_LIST_DEFAULT))
                                    .build())
                    .addOption(
                            Option.builder()
                                    .longOpt(ICU_VERSION)
                    ...
                    .addOption(
                            Option.builder()
                                    ...
                                    .desc(
                                            descWithDefault(
                                                    ICU_DATA_VERSION_DESC,
                                                    ICU_DATA_VERSION_DEFAULT))
                                    .build())
                    .addOption(
                            Option.builder()
                    ...
                    .addOption(
                            Option.builder()
                                    ...
                                    .desc(
                                            descWithDefault(
                                                    MIN_DRAFT_STATUS_DESC,
                                                    MIN_DRAFT_STATUS_DEFAULT))
                                    .build())
                    .addOption(
                            Option.builder()
                                    ...
                                    .desc(
                                            descWithDefault(
                                                    LOCALE_ID_FILTER_DESC,
                                                    LOCALE_ID_FILTER_DEFAULT))
                                    .build())
                    .addOption(
                            Option.builder()
                                    ...
                                    .desc(
                                            descWithDefault(
                                                    ...
                                                    INCLUDE_PSEUDO_LOCALES_DEFAULT))
                                    .build())
                    .addOption(
                            Option.builder()
                                    .longOpt(EMIT_REPORT)
    ...
    void processArgs(String[] args) {
        ...
        genJavaCodeDir =
                cli.getOptionValue(GEN_JAVA_CODE_DIR, expandFolders(GEN_JAVA_CODE_DIR_DEFAULT));
    ...
    private void showUsageAndExit() {
        ...
        formatter.printHelp(
                ...
                /*footer*/ "\nExample: "
                        + thisClassName
                        + " --outDir /tmp/debug --localeIdFilter=fr");
        System.exit(-1);
    }
    ...
    String expandFolders(String str) {
        return str.replace("${icuDir}", icuDir)
    ...
    // Check that the environment variables point to the proper `icu` / `cldr` / `cldr-staging`
    // folders
    private void validateEnvironment() {
        ...
        String icuMessage =
                "Set the ICU_DIR environment variable to the top level ICU directory (containing `.git`, `icu4c`, `icu4j`, `tools` directories)";
        String cldrMessage =
                "Set the CLDR_DIR environment variable to the top level CLDR directory (containing `common` and `tools` directories)";
        String cldrDataMessage =
                "Set the CLDR_DATA_DIR environment variable to the top level CLDR production data directory (typically the `production` directory in the staging repository)\n"
                        + "Usually generated locally or obtained from: https://github.com/unicode-org/cldr-staging/tree/main/production";
        if (icuDir == null) {
        ...
        if (!new File(icuDir).isDirectory()
            ...
            System.err.println(
                    "The `" + icuDir + "` directory does not look like a valid icu root.");
            System.err.println(icuMessage);
            System.exit(1);
        }
        if (!new File(cldrDir).isDirectory()
            ...
            System.err.println(
                    "The `" + cldrDir + "` directory does not look like a valid cldr root.");
            System.err.println(cldrMessage);
            System.exit(1);
        }
        if (!new File(cldrDataDir).isDirectory()
            ...
            System.err.println(
                    "The `"
                            + cldrDataDir
                            + "` directory does not look like a valid cldr-staging/ root.");
            System.err.println(cldrDataMessage);
            System.exit(1);
        }
