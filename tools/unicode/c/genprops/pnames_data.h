...
static const Value VALUES_bc[23] = {
    ...
    Value(U_EUROPEAN_SEPARATOR, "ES European_Separator"),
    Value(U_EUROPEAN_TERMINATOR, "ET European_Terminator"),
    Value(U_ARABIC_NUMBER, "AN Arabic_Number"),
    Value(U_COMMON_SEPARATOR, "CS Common_Separator"),
    Value(U_PARAGRAPH_SEPARATOR, "B Paragraph_Separator"),
    Value(U_SEGMENT_SEPARATOR, "S Segment_Separator"),
    Value(U_WHITE_SPACE, "WS White_Space"),
    ...
    Value(U_ARABIC_LETTER, "AL Arabic_Letter"),
    ...
    Value(U_NONSPACING_MARK, "NSM Nonspacing_Mark"),
...
static const Value VALUES_blk[354] = {
    ...
    Value(UBLOCK_GREEK_AND_COPTIC, "Greek Greek_And_Coptic"),
    ...
    Value(UBLOCK_COMBINING_DIACRITICAL_MARKS_FOR_SYMBOLS, "Diacriticals_For_Symbols Combining_Diacritical_Marks_For_Symbols Combining_Marks_For_Symbols"),
    ...
    Value(UBLOCK_MUSICAL_SYMBOLS_SUPPLEMENT, "Music_Sup Musical_Symbols_Supplement"),
    Value(UBLOCK_SEAL, "Seal Seal"),
};
...
static const Value VALUES_gc[30] = {
    Value(U_UNASSIGNED, "Cn Unassigned"),
    ...
    Value(U_SPACING_MARK, "Mc Spacing_Mark"),
    Value(U_DECIMAL_NUMBER, "Nd Decimal_Number digit"),
    ...
    Value(U_CONTROL, "Cc Control cntrl"),
    Value(U_FORMAT, "Cf Format"),
    Value(U_PRIVATE_USE, "Co Private_Use"),
    Value(U_SURROGATE, "Cs Surrogate"),
    Value(U_DASH_PUNCTUATION, "Pd Dash_Punctuation"),
    Value(U_OPEN_PUNCTUATION, "Ps Open_Punctuation"),
    Value(U_CLOSE_PUNCTUATION, "Pe Close_Punctuation"),
...
static const Value VALUES_jg[116] = {
    ...
    Value(U_JG_CROWN_AIN, "Crown_Ain Crown_Ain"),
    Value(U_JG_CROWN_BEH, "Crown_Beh Crown_Beh"),
    Value(U_JG_CROWN_FEH, "Crown_Feh Crown_Feh"),
    Value(U_JG_CROWN_HAH, "Crown_Hah Crown_Hah"),
    Value(U_JG_CROWN_HEH, "Crown_Heh Crown_Heh"),
    Value(U_JG_CROWN_KAF, "Crown_Kaf Crown_Kaf"),
    Value(U_JG_CROWN_MEEM, "Crown_Meem Crown_Meem"),
    Value(U_JG_CROWN_SAD, "Crown_Sad Crown_Sad"),
    Value(U_JG_CROWN_SEEN, "Crown_Seen Crown_Seen"),
    Value(U_JG_CROWN_TAH, "Crown_Tah Crown_Tah"),
};
...
static const Value VALUES_sc[215] = {
    ...
    Value(USCRIPT_OLD_TURKIC, "Orkh Old_Turkic"),
    ...
    Value(USCRIPT_TAI_THAM, "Lana Tai_Tham"),
    ...
    Value(USCRIPT_MEETEI_MAYEK, "Mtei Meetei_Mayek"),
    ...
    Value(USCRIPT_MENDE_KIKAKUI, "Mend Mende_Kikakui"),
    ...
    Value(USCRIPT_JURCHEN, "Jurc Jurchen"),
...
static const Value VALUES_InPC[16] = {
    Value(U_INPC_NOT_APPLICABLE, "NA Not_Applicable"),
...
static const Property PROPERTIES[121] = {
    ...
    Property(UCHAR_JOINING_GROUP, "jg Joining_Group", VALUES_jg, 116),
